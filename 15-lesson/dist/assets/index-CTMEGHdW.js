...
const sr = new Wv(),
  or = new Yv(),
  Tu = new qv();
Tu.setPath('./three.js-course-zeroToMastery/15-lesson/dist/textures/cubeMap/');
const FM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_sun.jpg'
  ),
  BM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_mercury.jpg'
  ),
  kM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_venus_surface.jpg'
  ),
  VM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_earth_daymap.jpg'
  ),
  zM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_mars.jpg'
  ),
  HM = or.load(
    './three.js-course-zeroToMastery/15-lesson/dist/textures/2k_moon.jpg'
  ),
