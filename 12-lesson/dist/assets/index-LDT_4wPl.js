...
class Dt {
  ...
  scale(t, e) {
    return this.premultiply(Js.makeScale(t, e)), this;
  }
  rotate(t) {
    return this.premultiply(Js.makeRotation(-t)), this;
  }
  translate(t, e) {
    return this.premultiply(Js.makeTranslation(t, e)), this;
  }
  makeTranslation(t, e) {
    return (
      t.isVector2
...
const Sl = new Dt().set(
  ...
  lr = {
    ...
    [Fs]: {
      ...
      toReference: (n) => n.applyMatrix3(Cl),
      fromReference: (n) => n.applyMatrix3(Sl),
    },
    [Aa]: {
      transfer: Qt,
      primaries: Ps,
      luminanceCoefficients: [0.2289, 0.6917, 0.0793],
      toReference: (n) => n.convertSRGBToLinear().applyMatrix3(Cl),
      fromReference: (n) => n.applyMatrix3(Sl).convertLinearToSRGB(),
    },
  },
  Id = new Set([Yn, Fs]),
  Xt = {
    ...
    if (r !== null) {
      ...
      if (Array.isArray(r)) {
        ...
        for (let o = 0, a = r.length; o < a; o++)
          r[o].isDataTexture ? s.push(to(r[o].image)) : s.push(to(r[o]));
      } else s = to(r);
      i.url = s;
    }
...
class D {
  ...
  projectOnPlane(t) {
    return eo.copy(this).projectOnVector(t), this.sub(eo);
  }
  reflect(t) {
    return this.sub(eo.copy(t).multiplyScalar(2 * this.dot(t)));
  }
  angleTo(t) {
    const e = Math.sqrt(this.lengthSq() * t.lengthSq());
    if (e === 0) return Math.PI / 2;
...
class Dr {
  ...
  intersectsTriangle(t) {
    ...
    this.getCenter(cr),
      Kr.subVectors(this.max, cr),
      wi.subVectors(t.a, cr),
      Mi.subVectors(t.b, cr),
      Ei.subVectors(t.c, cr),
      Rn.subVectors(Mi, wi),
      Ln.subVectors(Ei, Mi),
      $n.subVectors(wi, Ei);
    let e = [
    ...
    return !no(e, wi, Mi, Ei, Kr) ||
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !no(e, wi, Mi, Ei, Kr))
      ? !1
      : ($r.crossVectors(Rn, Ln),
        (e = [$r.x, $r.y, $r.z]),
        no(e, wi, Mi, Ei, Kr));
  }
  clampPoint(t, e) {
  ...
  union(t) {
    return t.isEmpty()
      ...
      : (this.center.equals(t.center) === !0
          ...
          : (io.subVectors(t.center, this.center).setLength(t.radius),
            this.expandByPoint(hr.copy(t.center).add(io)),
            this.expandByPoint(hr.copy(t.center).sub(io))),
        this);
  }
  equals(t) {
...
class lh {
  ...
  distanceSqToSegment(t, e, i, r) {
    ro.copy(t).add(e).multiplyScalar(0.5),
      Zr.copy(e).sub(t).normalize(),
      Dn.copy(this.origin).sub(ro);
    ...
    return (
      ...
      r && r.copy(ro).addScaledVector(Zr, p),
      m
    );
  }
  intersectSphere(t, e) {
  ...
  intersectTriangle(t, e, i, r, s) {
    so.subVectors(e, t), Jr.subVectors(i, t), oo.crossVectors(so, Jr);
    let o = this.direction.dot(oo),
      a;
    if (o > 0) {
      if (r) return null;
      a = 1;
    ...
    const l = a * this.direction.dot(Jr.crossVectors(Dn, Jr));
    if (l < 0) return null;
    const c = a * this.direction.dot(so.cross(Dn));
...
class Sn {
  ...
  setFromQuaternion(t, e, i) {
    return (
      Al.makeRotationFromQuaternion(t), this.setFromRotationMatrix(Al, e, i)
    );
  }
  ...
  reorder(t) {
    return Pl.setFromEuler(this), this.setFromQuaternion(Pl, t);
  }
  equals(t) {
    return (
      t._x === this._x &&
...
class Ne extends mi {
  ...
  translateOnAxis(t, e) {
    return (
      Rl.copy(t).applyQuaternion(this.quaternion),
      this.position.add(Rl.multiplyScalar(e)),
      this
    );
  }
  translateX(t) {
  ...
  lookAt(t, e, i) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? fn.lookAt(ur, ts, this.up)
        : fn.lookAt(ts, ur, this.up),
      this.quaternion.setFromRotationMatrix(fn),
      r &&
        (fn.extractRotation(r.matrixWorld),
        Si.setFromRotationMatrix(fn),
...
class sn {
  ...
  static getBarycoord(t, e, i, r, s) {
    Je.subVectors(r, e), mn.subVectors(i, e), lo.subVectors(t, e);
    const o = Je.dot(Je),
      a = Je.dot(mn),
      l = Je.dot(lo),
      c = mn.dot(mn),
  ...
  closestPointToPoint(t, e) {
    const i = this.a,
      ...
      s = this.c;
    let o, a;
    Ti.subVectors(r, i), Ai.subVectors(s, i), co.subVectors(t, i);
    const l = Ti.dot(co),
      c = Ai.dot(co);
    ...
    const p = l * d - h * c;
    if (p <= 0 && l >= 0 && h <= 0)
      return (o = l / (l - h)), e.copy(i).addScaledVector(Ti, o);
    uo.subVectors(t, s);
    const m = Ti.dot(uo),
      v = Ai.dot(uo);
    ...
    const b = m * c - l * v;
    if (b <= 0 && c >= 0 && v <= 0)
      return (a = c / (c - v)), e.copy(i).addScaledVector(Ai, a);
    const f = h * v - m * d;
    if (f <= 0 && d - h >= 0 && m - v >= 0)
      return (
        Nl.subVectors(s, r),
        (a = (d - h) / (d - h + (m - v))),
        e.copy(r).addScaledVector(Nl, a)
      );
    const u = 1 / (f + b + p);
    return (
      (o = b * u),
      (a = p * u),
      e.copy(i).addScaledVector(Ti, o).addScaledVector(Ai, a)
    );
  }
  equals(t) {
...
class Yt {
  ...
  setHSL(t, e, i, r = Xt.workingColorSpace) {
    if (((t = Pd(t, 1)), (e = Ce(e, 0, 1)), (i = Ce(i, 0, 1)), e === 0))
  ...
  lerpHSL(t, e) {
    this.getHSL(Un), t.getHSL(es);
    const i = Zs(Un.h, es.h, e),
      r = Zs(Un.s, es.s, e),
      s = Zs(Un.l, es.l, e);
...
class Bs extends mi {
  constructor() {
    super(),
      ...
      (this.stencilFail = xi),
      (this.stencilZFail = xi),
      (this.stencilZPass = xi),
      (this.stencilWrite = !1),
  ...
  toJSON(t) {
    ...
    (i.uuid = this.uuid),
      ...
      this.blending !== zi && (i.blending = this.blending),
      this.side !== Xn && (i.side = this.side),
      this.vertexColors === !0 && (i.vertexColors = !0),
      this.opacity < 1 && (i.opacity = this.opacity),
      this.transparent === !0 && (i.transparent = !0),
      this.blendSrc !== No && (i.blendSrc = this.blendSrc),
      this.blendDst !== Oo && (i.blendDst = this.blendDst),
      ...
      this.stencilFail !== xi && (i.stencilFail = this.stencilFail),
      this.stencilZFail !== xi && (i.stencilZFail = this.stencilZFail),
      this.stencilZPass !== xi && (i.stencilZPass = this.stencilZPass),
      ...
      if ((Ve.setFromBufferAttribute(t), e))
        for (let s = 0, o = e.length; s < o; s++) {
          ...
          dr.setFromBufferAttribute(a),
            this.morphTargetsRelative
              ? (xe.addVectors(Ve.min, dr.min),
                Ve.expandByPoint(xe),
                xe.addVectors(Ve.max, dr.max),
                Ve.expandByPoint(xe))
              : (Ve.expandByPoint(dr.min), Ve.expandByPoint(dr.max));
        }
      Ve.getCenter(i);
      let r = 0;
        ...
        for (let s = 0, o = e.length; s < o; s++) {
          ...
          for (let c = 0, h = a.count; c < h; c++)
            xe.fromBufferAttribute(a, c),
              l && (Pi.fromBufferAttribute(t, c), xe.add(Pi)),
              (r = Math.max(r, i.distanceToSquared(xe)));
        }
...
class De extends Ne {
    ...
    if (s && a) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        ...
        h !== 0 &&
          ...
          o ? rs.addScaledVector(mo, h) : rs.addScaledVector(mo.sub(e), h));
      }
      e.add(rs);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    r !== void 0 &&
      ...
      !(
        is.containsPoint(Jn.origin) === !1 &&
        (Jn.intersectSphere(is, Fl) === null ||
          Jn.origin.distanceToSquared(Fl) > (t.far - t.near) ** 2)
      ) &&
        (Ol.copy(s).invert(),
        Jn.copy(t.ray).applyMatrix4(Ol),
...
function hs(n, t, e, i, r, s, o, a, l, c) {
  n.getVertexPosition(a, Ri),
    n.getVertexPosition(l, Li),
    n.getVertexPosition(c, Di);
  const h = Yd(n, t, e, i, Ri, Li, Di, ls);
  if (h) {
    r &&
      (ss.fromBufferAttribute(r, a),
      os.fromBufferAttribute(r, l),
      as.fromBufferAttribute(r, c),
      (h.uv = sn.getInterpolation(ls, Ri, Li, Di, ss, os, as, new St()))),
      s &&
        (ss.fromBufferAttribute(s, a),
        os.fromBufferAttribute(s, l),
        as.fromBufferAttribute(s, c),
        (h.uv1 = sn.getInterpolation(ls, Ri, Li, Di, ss, os, as, new St()))),
      o &&
        (Bl.fromBufferAttribute(o, a),
        kl.fromBufferAttribute(o, l),
        Vl.fromBufferAttribute(o, c),
        (h.normal = sn.getInterpolation(ls, Ri, Li, Di, Bl, kl, Vl, new D())),
        h.normal.dot(i.direction) > 0 && h.normal.multiplyScalar(-1));
    const d = { a, b: l, c, normal: new D(), materialIndex: 0 };
    sn.getNormal(Ri, Li, Di, d.normal), (h.face = d);
  }
  return h;
}
class Qi extends hn {
...
class ze extends fh {
  ...
  setFocalLength(t) {
    ...
    (this.fov = da * 2 * Math.atan(e)), this.updateProjectionMatrix();
  }
  getFocalLength() {
  ...
  getEffectiveFOV() {
    return da * 2 * Math.atan(Math.tan(Ms * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(t, e) {
    return this.getViewBounds(t, zl, Hl), e.subVectors(Hl, zl);
  }
...
class Qd extends Ne {
  constructor(t, e, i) {
    ...
    const r = new ze(Ii, Ui, t, e);
    (r.layers = this.layers), this.add(r);
    const s = new ze(Ii, Ui, t, e);
    (s.layers = this.layers), this.add(s);
    const o = new ze(Ii, Ui, t, e);
    (o.layers = this.layers), this.add(o);
    const a = new ze(Ii, Ui, t, e);
    (a.layers = this.layers), this.add(a);
    const l = new ze(Ii, Ui, t, e);
    (l.layers = this.layers), this.add(l);
    const c = new ze(Ii, Ui, t, e);
...
class kn {
  ...
  setFromCoplanarPoints(t, e, i) {
    const r = _o.subVectors(i, e).cross(ep.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const i = e || np.getNormalMatrix(t),
      r = this.coplanarPoint(_o).applyMatrix4(t),
...
class La {
  ...
  setFromProjectionMatrix(t, e = wn) {
    ...
    else if (e === Rs) i[5].setComponents(a, d, b, w).normalize();
    else
      throw new Error(
...
#endif`,
  Mf = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
function km(n, t, e, i, r, s, o) {
      ...
      ? (h === void 0 &&
          ((h = new De(
            ...
            new jn({
              ...
              uniforms: $i(rn.backgroundCube.uniforms),
        ...
        (c === void 0 &&
          ((c = new De(
            ...
            new jn({
              ...
              uniforms: $i(rn.background.uniforms),
  ...
  function u(S, w) {
    S.getRGB(ds, ph(n)), i.buffers.color.setClear(ds.r, ds.g, ds.b, w, o);
  }
  return {
...
function Wm(n) {
  let t = new WeakMap();
  function e(o, a) {
    return a === Fo ? (o.mapping = ji) : a === Bo && (o.mapping = qi), o;
  }
  function i(o) {
    if (o && o.isTexture) {
      const a = o.mapping;
...
const ki = 4,
  Gl = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  si = 20,
  vo = new Xm(),
  Wl = new Yt();
let go = null,
...
class jl {
  ...
  fromScene(t, e = 0, i = 0.1, r = 100) {
    (go = this._renderer.getRenderTarget()),
      (xo = this._renderer.getActiveCubeFace()),
      (bo = this._renderer.getActiveMipmapLevel()),
  ...
  _cleanup(t) {
    this._renderer.setRenderTarget(go, xo, bo),
      (this._renderer.xr.enabled = wo),
      (t.scissorTest = !1),
      ps(t, 0, 0, t.width, t.height);
  }
  _fromTexture(t, e) {
    t.mapping === ji || t.mapping === qi
      ? this._setSize(
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = ql(t, e, i));
  ...
  _sceneToCubeUV(t, e, i, r) {
    const a = new ze(90, 1, e, i),
      ...
      d = h.autoClear,
      p = h.toneMapping;
    h.getClearColor(Wl), (h.toneMapping = Gn), (h.autoClear = !1);
    const m = new Ra({
  ...
  _textureToCubeUV(t, e) {
    const i = this._renderer,
      r = t.mapping === ji || t.mapping === qi;
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = Kl()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value =
          t.isRenderTargetTexture === !1 ? -1 : 1))
      : this._equirectMaterial === null && (this._equirectMaterial = Yl());
    const s = r ? this._cubemapMaterial : this._equirectMaterial,
      o = new De(this._lodPlanes[0], s),
      a = s.uniforms;
    a.envMap.value = t;
    const l = this._cubeSize;
    ps(e, 0, 0, 3 * l, 2 * l), i.setRenderTarget(e), i.render(o, vo);
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, i, r, s, o, a) {
    ...
    const E = this._sizeLods[r],
      N = 3 * E * (r > w - ki ? r - w + ki : 0),
      T = 4 * (this._cubeSize - E);
    ps(e, N, T, 3 * E, 2 * E), l.setRenderTarget(e), l.render(d, vo);
  }
}
function jm(n) {
  const t = [],
    ...
    i = [];
  let r = n;
  const s = n - ki + 1 + Gl.length;
  for (let o = 0; o < s; o++) {
    const a = Math.pow(2, r);
    e.push(a);
    let l = 1 / a;
    o > n - ki ? (l = Gl[o - n + ki - 1]) : o === 0 && (l = 0), i.push(l);
    const c = 1 / (a - 2),
      h = -c,
      d = 1 + c,
...
function Km(n) {
  ...
  return {
    ...
    get: function (i) {
      ...
      return (
        r === null &&
          br('THREE.WebGLRenderer: ' + i + ' extension not supported.'),
        r
      );
    },
  };
...
class vh extends Te {
  constructor(t, e, i, r, s, o, a, l, c, h = Hi) {
    if (h !== Hi && h !== Ki)
      throw new Error(
...
function tr(n, t, e) {
  ...
  const r = t * e;
  let s = Zl[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (Zl[r] = s)), t !== 0)) {
    i.toArray(s, 0);
...
function s_(n, t) {
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    ec.set(i), n.uniformMatrix2fv(this.addr, !1, ec), ge(e, i);
  }
}
function o_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    tc.set(i), n.uniformMatrix3fv(this.addr, !1, tc), ge(e, i);
  }
}
function a_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    Ql.set(i), n.uniformMatrix4fv(this.addr, !1, Ql), ge(e, i);
  }
}
function l_(n, t) {
  const e = this.cache;
...
function O_(n, t, e) {
  ...
  for (let o = 0; o !== r; ++o) e.setTexture2D(t[o] || gh, s[o]);
}
function F_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = ks(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture3D(t[o] || bh, s[o]);
}
function B_(n, t, e) {
  const i = this.cache,
    r = t.length,
...
function k_(n, t, e) {
  const i = this.cache,
    ...
    s = ks(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture2DArray(t[o] || xh, s[o]);
}
function V_(n) {
  switch (n) {
    case 5126:
...
function W_(n, t, e) {
  ...
  for (Mo.lastIndex = 0; ; ) {
    ...
    if ((l && (a = a | 0), c === void 0 || (c === '[' && o + 2 === r))) {
      nc(e, c === void 0 ? new z_(a, n, t) : new H_(a, n, t));
      break;
    } else {
      let d = e.map[a];
      d === void 0 && ((d = new G_(a)), nc(e, d)), (e = d);
    }
  }
}
class Es {
...
const fs = new D();
function Z_() {
  Xt.getLuminanceCoefficients(fs);
...
`)),
      (u = [
        ...
        e.toneMapping !== Gn ? $_('toneMapping', e.toneMapping) : '',
...
` +
      ...
      (u =
        [
          ...
          e.glslVersion === El ? '' : '#define gl_FragColor pc_fragColor',
...
` +
  ...
  const w = S + f + o,
    E = S + u + a,
    N = ic(r, r.VERTEX_SHADER, w),
    T = ic(r, r.FRAGMENT_SHADER, E);
  r.attachShader(b, N),
    r.attachShader(b, T),
...
` +
    ...
    r.deleteShader(N), r.deleteShader(T), (U = new Es(r, b)), (M = tv(r, b));
  }
  let U;
...
function mv(n, t, e, i, r, s, o) {
  ...
  function f(M, x, P, V, B) {
    ...
    const be = {
      ...
      emissiveMap: Ct,
      normalMapObjectSpace: gt && M.normalMapType === wd,
      normalMapTangentSpace: gt && M.normalMapType === bd,
      metalnessMap: Pt,
      roughnessMap: y,
      anisotropy: _,
      anisotropyMap: rt,
      ...
      gradientMap: X,
      opaque:
        M.transparent === !1 && M.blending === zi && M.alphaToCoverage === !1,
      alphaMap: q,
      alphaTest: nt,
      alphaHash: bt,
      combine: M.combine,
      ...
      lightMapUv: qt && b(M.lightMap.channel),
  ...
  function N(M, x) {
    ...
    return P === void 0 && ((P = new uv(n, x, M, s)), h.push(P)), P;
  }
  function T(M) {
    if (--M.usedTimes === 0) {
      const x = h.indexOf(M);
...
function hc() {
  ...
  function c(d, p) {
    e.length > 1 && e.sort(d || vv),
      i.length > 1 && i.sort(p || cc),
      r.length > 1 && r.sort(p || cc);
  }
  function h() {
    ...
    get: function (t) {
      ...
      switch (t.type) {
        case 'DirectionalLight':
          e = { direction: new D(), color: new Yt() };
          break;
        case 'SpotLight':
          e = {
            position: new D(),
          ...
          break;
        case 'PointLight':
          e = { position: new D(), color: new Yt(), distance: 0, decay: 0 };
          break;
        case 'HemisphereLight':
          e = { direction: new D(), skyColor: new Yt(), groundColor: new Yt() };
          break;
        case 'RectAreaLight':
          e = {
            color: new Yt(),
...
function Rv(n) {
  ...
  const re = {
    [ri]: n.FUNC_ADD,
    [Bu]: n.FUNC_SUBTRACT,
    [ku]: n.FUNC_REVERSE_SUBTRACT,
  };
  (re[Vu] = n.MIN), (re[zu] = n.MAX);
  const A = {
    [Hu]: n.ZERO,
    [Gu]: n.ONE,
    [Wu]: n.SRC_COLOR,
    [No]: n.SRC_ALPHA,
    [$u]: n.SRC_ALPHA_SATURATE,
    [Yu]: n.DST_COLOR,
    [ju]: n.DST_ALPHA,
    [Xu]: n.ONE_MINUS_SRC_COLOR,
    [Oo]: n.ONE_MINUS_SRC_ALPHA,
    [Ku]: n.ONE_MINUS_DST_COLOR,
    [qu]: n.ONE_MINUS_DST_ALPHA,
    [Zu]: n.CONSTANT_COLOR,
    [Ju]: n.ONE_MINUS_CONSTANT_COLOR,
    [Qu]: n.CONSTANT_ALPHA,
...
function Dv(n, t, e, i, r, s, o) {
  ...
  function v(y, _) {
    return m ? new OffscreenCanvas(y, _) : Er('canvas');
  }
  function b(y, _, k) {
    let Y = 1;
    const Z = Pt(y);
  ...
  function S(y, _, k, Y, Z = !1) {
    ...
    if (
      ...
      const xt = Z ? Ts : Xt.getTransfer(Y);
  ...
  const z = { [wr]: n.REPEAT, [oi]: n.CLAMP_TO_EDGE, [ko]: n.MIRRORED_REPEAT },
    ot = {
      [qe]: n.NEAREST,
      [vd]: n.NEAREST_MIPMAP_NEAREST,
      [qr]: n.NEAREST_MIPMAP_LINEAR,
      [Qe]: n.LINEAR,
      [$s]: n.LINEAR_MIPMAP_NEAREST,
      ...
      if (_.isDepthTexture)
                ...
                if (Ut) {
                  if (R)
                    if (_.layerUpdates.size > 0) {
                      const nt = dc(ut.width, ut.height, _.format, _.type);
        ...
        if (Ut) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const X = dc(Q.width, Q.height, _.format, _.type);
...
function Iv(n, t) {
  function e(i, r = Vn) {
    ...
    if (i === Ea) return n.UNSIGNED_SHORT_4_4_4_4;
    if (i === ya) return n.UNSIGNED_SHORT_5_5_5_1;
    if (i === $c) return n.UNSIGNED_INT_5_9_9_9_REV;
    if (i === Yc) return n.BYTE;
    if (i === Kc) return n.SHORT;
    if (i === Mr) return n.UNSIGNED_SHORT;
    if (i === Ma) return n.INT;
    if (i === ci) return n.UNSIGNED_INT;
    if (i === bn) return n.FLOAT;
    if (i === Rr) return n.HALF_FLOAT;
    if (i === Zc) return n.ALPHA;
    if (i === Jc) return n.RGB;
    if (i === tn) return n.RGBA;
    if (i === Qc) return n.LUMINANCE;
    if (i === th) return n.LUMINANCE_ALPHA;
    if (i === Hi) return n.DEPTH_COMPONENT;
    if (i === Ki) return n.DEPTH_STENCIL;
    if (i === eh) return n.RED;
    if (i === Sa) return n.RED_INTEGER;
    if (i === nh) return n.RG;
    if (i === Ca) return n.RG_INTEGER;
    if (i === Ta) return n.RGBA_INTEGER;
    ...
    if (i === Vo || i === zo || i === Ho || i === Go)
      if (((s = t.get('WEBGL_compressed_texture_pvrtc')), s !== null)) {
        if (i === Vo) return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (i === zo) return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (i === Ho) return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (i === Go) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (i === Wo || i === Xo || i === jo)
    ...
    if (i === ws || i === aa || i === la)
      if (((s = t.get('EXT_texture_compression_bptc')), s !== null)) {
        ...
        if (i === aa) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (i === la) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (i === ih || i === ca || i === ha || i === ua)
      if (((s = t.get('EXT_texture_compression_rgtc')), s !== null)) {
        if (i === ws) return s.COMPRESSED_RED_RGTC1_EXT;
        if (i === ca) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (i === ha) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (i === ua) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
    return i === Yi ? n.UNSIGNED_INT_24_8 : n[i] !== void 0 ? n[i] : null;
  }
  return { convert: e };
}
class Uv extends ze {
...
class Bv {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new De(new Ir(20, 20), i);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(t, e) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (W) {
        let J = w[W];
        return (
          J === void 0 && ((J = new Eo()), (w[W] = J)), J.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (W) {
        let J = w[W];
        return J === void 0 && ((J = new Eo()), (w[W] = J)), J.getGripSpace();
      }),
      (this.getHand = function (W) {
        let J = w[W];
        return J === void 0 && ((J = new Eo()), (w[W] = J)), J.getHandSpace();
      });
    function B(W) {
    ...
    function ht(W, J, ft) {
      ft === null
        ...
        W.isPerspectiveCamera &&
          ((W.fov = da * 2 * Math.atan(1 / W.projectionMatrix.elements[5])),
          (W.zoom = 1));
    }
...
function zv(n, t) {
  ...
  function i(f, u) {
    u.color.getRGB(f.fogColor.value, ph(n)),
      u.isFog
...
class Gv {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in e &&
          e.setAttribute('data-engine', `three.js r${wa}`),
    ...
    function R() {
      (qt = new Km(A)),
        ...
        (Ft = new Qm(A, $t, Pt)),
        (Rt = new Gm(Ct)),
        (K = new mv(w, y, _, qt, $t, Ut, Rt)),
        (xt = new zv(w, Ct)),
        (rt = new gv()),
        (ct = new yv(qt)),
        (at = new km(w, y, _, gt, Z, p, l)),
        (Q = new Pv(w, Z, $t)),
        (ne = new Hv(A, he, $t, gt)),
        (yt = new zm(A, qt, he)),
        (ut = new Zm(A, qt, he)),
    ...
    (this.xr = tt),
      ...
      (this.forceContextLoss = function () {
        const g = qt.get('WEBGL_lose_context');
        g && g.loseContext();
      }),
      ...
      (this.dispose = function () {
        e.removeEventListener('webglcontextlost', X, !1),
          ...
          tt.removeEventListener('sessionend', hl),
          Kn.stop();
      });
    function X(g) {
      g.preventDefault(),
    ...
    this.renderBufferDirect = function (g, L, O, F, I, et) {
      ...
      if (I.isBatchedMesh)
        if (I._multiDrawInstances !== null)
        ...
        else if (qt.get('WEBGL_multi_draw'))
          Gt.renderMultiDraw(
            I._multiDrawStarts,
            I._multiDrawCounts,
            I._multiDrawCount
          ...
          const vt = I._multiDrawStarts,
            ...
            gi = Ct.get(F).currentProgram.getUniforms();
          for (let Be = 0; Be < Wt; Be++)
            gi.setValue(A, '_gl_DrawID', Be), Gt.render(vt[Be] / Ke, we[Be]);
        }
    ...
    (this.compile = function (g, L, O = null) {
      ...
      (this.compileAsync = function (g, L, O = null) {
        ...
        return new Promise((I) => {
          ...
          qt.get('KHR_parallel_shader_compile') !== null
            ? et()
            : setTimeout(et, 10);
        });
      });
    ...
    Kn.setAnimationLoop(un),
      ...
      tt.addEventListener('sessionend', hl),
      (this.render = function (g, L) {
        ...
        if (
          ...
          et !== null && js(et, L, -1 / 0, w.sortObjects);
        }
        js(g, L, 0, w.sortObjects),
          b.finish(),
        ...
        if ((f.setupLights(), L.isArrayCamera)) {
          ...
          for (let st = 0, dt = et.length; st < dt; st++) {
            const pt = et[st];
            ul(b, g, pt, pt.viewport);
          }
        } else I.length > 0 && dl(F, I, g, L), Nt && at.render(g), ul(b, g, L);
        C !== null &&
    ...
    function js(g, L, O, F) {
      ...
      const et = g.children;
      for (let st = 0, dt = et.length; st < dt; st++) js(et[st], L, O, F);
    }
    function ul(g, L, O, F) {
      const I = g.opaque,
        et = g.transmissive,
    ...
    function dl(g, L, O, F) {
      ...
      f.state.transmissionRenderTarget[F.id] === void 0 &&
        (f.state.transmissionRenderTarget[F.id] = new hi(1, 1, {
          generateMipmaps: !0,
          type:
            qt.has('EXT_color_buffer_half_float') ||
            qt.has('EXT_color_buffer_float')
              ? Rr
              : yn,
          minFilter: ai,
          samples: 4,
      ...
      if (
        ...
        qt.has('WEBGL_multisampled_render_to_texture') === !1)
      ) {
        let Et = !1;
    ...
    function Xr(g, L, O) {
      ...
      for (let I = 0, et = g.length; I < et; I++) {
        const st = g[I],
          ...
          Et = st.group;
        dt.layers.test(O.layers) && pl(dt, L, O, pt, wt, Et);
      }
    }
    function pl(g, L, O, F, I, et) {
    ...
    function Ru(g, L, O, F, I) {
      ...
      const de = Ke.getUniforms(),
        Pn = vt.uniforms;
      if (
        (gt.useProgram(Ke.program) && ((gi = !0), (Be = !0), (qs = !0)),
        F.id !== U && ((U = F.id), (Be = !0)),
        gi || M !== g)
      ) {
      ...
      if (
        ...
        Be &&
          ...
          Es.upload(A, fl(vt), Pn, Pt)),
        F.isShaderMaterial &&
          F.uniformsNeedUpdate === !0 &&
          (Es.upload(A, fl(vt), Pn, Pt), (F.uniformsNeedUpdate = !1)),
        ...
        for (let Ks = 0, Iu = We.length; Ks < Iu; Ks++) {
          const _l = We[Ks];
          ne.update(_l, Ke), ne.bind(_l, Ke);
        }
      }
      return Ke;
    }
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (g, L, O) {
        ...
        (F.__hasExternalTextures = !0),
          ...
          F.__autoAllocateDepthBuffer ||
            (qt.has('WEBGL_multisampled_render_to_texture') === !0 &&
              (console.warn(
      ...
      (this.copyTextureToTexture3D = function (
        ...
        const we = A.getParameter(A.UNPACK_ROW_LENGTH),
          ...
          gi = A.getParameter(A.UNPACK_SKIP_ROWS),
        ...
        A.pixelStorei(A.UNPACK_ROW_LENGTH, oe.width),
          ...
          A.pixelStorei(A.UNPACK_SKIP_ROWS, gi),
  ...
  set outputColorSpace(t) {
    ...
    (e.drawingBufferColorSpace = t === Aa ? 'display-p3' : 'srgb'),
      (e.unpackColorSpace =
        Xt.workingColorSpace === Fs ? 'display-p3' : 'srgb');
  }
}
class Wv extends Ne {
  constructor() {
...
class qv extends Oa {
  ...
  load(t, e, i, r) {
    ...
    const a = Er('img');
    function l() {
      h(), pc.add(t, this), e && e(this), s.manager.itemEnd(t);
    }
    function c(d) {
...
class Kv {
  ...
  updateMatrices(t) {
    ...
    fc.setFromMatrixPosition(t.matrixWorld),
      e.position.copy(fc),
      mc.setFromMatrixPosition(t.target.matrixWorld),
      e.lookAt(mc),
      e.updateMatrixWorld(),
...
class $v extends Kv {
  ...
  updateMatrices(t, e = 0) {
    ...
    s !== i.far && ((i.far = s), i.updateProjectionMatrix()),
      ...
      i.position.copy(pr),
      So.copy(i.position),
      So.add(this._cubeDirections[e]),
      i.up.copy(this._cubeUps[e]),
      i.lookAt(So),
      i.updateMatrixWorld(),
      r.makeTranslation(-pr.x, -pr.y, -pr.z),
      _c.multiplyMatrices(i.projectionMatrix, i.matrixWorldInverse),
...
class eg extends Qv {
  constructor(t, e = null) {
    super(t, e),
      ...
      (this._spherical = new vc()),
      (this._sphericalDelta = new vc()),
      (this._scale = 1),
  ...
  update(t = null) {
        ...
        (this.screenSpacePanning
          ...
          : (ms.origin.copy(this.object.position),
            ...
            Math.abs(this.object.up.dot(ms.direction)) < tg
              ? this.object.lookAt(this.target)
              : (xc.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                ms.intersectPlane(xc, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > Co ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Co ||
      this._lastTargetPosition.distanceToSquared(this.target) > Co
        ? (this.dispatchEvent(gc),
...
function zg(n, t) {
  const e = Vg(n, t);
  return (t += e.length), e === '' ? null : { evaluable: new Mg(e), cursor: t };
}
function Hg(n, t) {
  const e = n.substr(t, 1);
...
function Wg(n, t, e) {
  ...
  return i
    ? ((e += i.length), (e += yr(t, e).length), { cursor: e, operator: i })
    : null;
}
function Xg(n, t) {
  return (e, i) => {
    ...
    for (;;) {
      ...
      const a = n(e, i);
      if (!a) return null;
      (i = a.cursor), (s = new yg(o.operator, s, a.evaluable));
    }
...
const jg = [
  ...
  ['^'],
  ['|'],
].reduce((n, t) => Xg(n, t), Sh);
function Ch(n, t) {
  return (t += yr(n, t).length), jg(n, t);
}
function qg(n) {
  const t = Ch(n, 0);
  return !t || t.cursor + yr(n, t.cursor).length !== n.length
    ? null
    : t.evaluable;
}
function Cn(n) {
...
function Kg(n, t) {
  return Jt(n.step) ? Math.max(bc(t), 2) : bc(n.step);
}
function Ph(n) {
  var t;
...
function Lh(n, t) {
  return Jt(n.step) ? null : new wg(n.step, t);
}
function Dh(n) {
...
function Ih(n, t) {
  var e, i, r;
  return {
    formatter: (e = n.format) !== null && e !== void 0 ? e : Oe(Kg(n, t)),
    keyScale: (i = n.keyScale) !== null && i !== void 0 ? i : Ph(n),
    pointerScale: (r = n.pointerScale) !== null && r !== void 0 ? r : Rh(n, t),
  };
}
function Uh(n) {
  return {
...
function Ha(n) {
  return {
    ...
    textProps: It.fromObject(Ih(n.params, n.initialValue)),
  };
}
class _i {
  constructor(t) {
...
const ma = { optional: wc(!0), required: wc(!1) };
function ie(n, t) {
  const e = t(ma),
...
class Vh {
  constructor(t, e) {
    (this.props = e.props),
      ...
      (this.view = new kh(t, { props: e.props, viewProps: this.viewProps })),
...
const Mc = kt(''),
  Ec = { veryfirst: 'vfst', first: 'fst', last: 'lst', verylast: 'vlst' };
class Hs {
  constructor(t) {
    (this.parent_ = null),
      (this.blade = t.blade),
    ...
    this.blade.value('positions').emitter.on('change', () => {
      d0().forEach((i) => {
        e.classList.remove(Mc(void 0, Ec[i]));
      }),
        this.blade.get('positions').forEach((i) => {
          e.classList.add(Mc(void 0, Ec[i]));
        });
    }),
  ...
  constructor(t, e) {
    ...
    super(
      Object.assign(Object.assign({}, e), {
        view: new kh(t, { props: e.props, viewProps: i }),
        viewProps: i,
      })
    ),
...
class zh extends pi {
  ...
  exportState() {
    return Ge(() => yc(super.exportState()), {
      binding: {
...
function g0(n, t) {
  const e = [...v0(n), t];
  return (
    e.length > n.length ? e.splice(0, e.length - n.length) : Hh(e, n.length), e
  );
}
class x0 {
  constructor(t) {
...
class C0 {
  constructor(t, e) {
    (this.emitter = new fe()),
      ...
      (this.view = new S0(t, { props: this.props, viewProps: this.viewProps })),
...
const T0 = Pe({
  ...
  api(n) {
    return n.controller instanceof Sc ? new E0(n.controller) : null;
  },
});
function A0(n, t) {
...
class I0 {
  ...
  onRackValueChange_(t) {
    const e = t.bladeController,
      ...
      r = Nh(e.value) ? e.value.binding : null;
    this.emitter_.emit(
      'change',
...
class F0 {
  ...
  onChildValueChange_(t) {
    const e = N0(this.find(li), t.sender);
...
class Ya {
  ...
  onRackAdd_(t) {
    t.root && Oh(this.element, t.bladeController.view.element, t.index);
  }
  onRackRemove_(t) {
...
class k0 {
  constructor(t, e) {
    ...
    (this.className_ = kt(
      ...
      (this.element = t.createElement('div')),
      this.element.classList.add(this.className_(), Xh()),
      e.viewProps.bindClassModifiers(this.element),
...
const V0 = Pe({
    ...
    api(n) {
      return n.controller instanceof va ? new Wh(n.controller, n.pool) : null;
    },
  }),
  z0 = kt('');
function Tc(n, t) {
...
class An extends It {
  ...
  bindClassModifiers(t) {
    En(this.globalDisabled_, Tc(t, 'disabled')),
      ln(this, 'hidden', Tc(t, 'hidden'));
  }
  bindDisabled(t) {
...
class ga extends qa {
  constructor(t, e) {
    ...
    super(
      ...
      (this.ic_ = new W0(t, { props: e.itemProps, viewProps: An.create() })),
...
class q0 {
  ...
  keepSelection_() {
    if (this.items_.length === 0) {
      (this.selectedIndex.rawValue = Pc), (this.empty.rawValue = !0);
      return;
    }
...
class Y0 {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      this.element.classList.add(_r(), Xh()),
      e.viewProps.bindClassModifiers(this.element),
...
class Rc extends qa {
  ...
  onRackAdd_(t) {
    if (!t.root) return;
    const e = t.bladeController;
    Oh(this.view.itemsElement, e.itemController.view.element, t.index),
...
const jh = Pe({
  ...
  controller(n) {
    const t = new Rc(n.document, { blade: n.blade, viewProps: n.viewProps });
    return (
  ...
  api(n) {
    return n.controller instanceof Rc
      ? new X0(n.controller, n.pool)
      : n.controller instanceof ga
...
class Q0 {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      En(e.shows, er(this.element, Lc(void 0, 'v')));
  }
}
class qh {
  constructor(t, e) {
  ...
  onMouseDown_(t) {
    ...
    i.addEventListener('mousemove', this.onDocumentMouseMove_),
      ...
      this.emitter.emit('down', {
        altKey: t.altKey,
        data: this.computePosition_(Po(t, this.elem_)),
        sender: this,
        shiftKey: t.shiftKey,
      });
  }
...
class Vr {
  ...
  onInputKeyDown_(t) {
    const e = Ie(this.props.get('keyScale'), Ar(t));
    e !== 0 &&
  ...
  onInputKeyUp_(t) {
    Ie(this.props.get('keyScale'), Ar(t)) !== 0 &&
...
class ox {
  constructor(t, e) {
    (this.onChange_ = this.onChange_.bind(this)),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Ro('t')),
      e.viewProps.bindTabIndex(i),
      this.element.appendChild(i),
      (this.trackElement = i);
    const r = t.createElement('div');
    r.classList.add(Ro('k')),
...
class lx {
  constructor(t, e) {
    (this.element = t.createElement('div')), this.element.classList.add(Lo());
    const i = t.createElement('div');
    i.classList.add(Lo('s')),
      (this.sliderView_ = e.sliderView),
      i.appendChild(this.sliderView_.element),
      this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(Lo('t')),
...
const wx = {
  ...
  hsv: { hsl: bx, hsv: (n, t, e) => [n, t, e], rgb: tu },
...
function nu(n, t, e) {
  const i = Uc(n, t.mode, t.type, 'int'),
    r = wx[t.mode][e.mode](...i);
  return Uc(r, e.mode, 'int', e.type);
}
class Vt {
  static black() {
  ...
  constructor(t, e) {
    (this.type = 'int'), (this.mode = e), (this.comps_ = eu(t, e, this.type));
  }
  getComponents(t) {
    return Gs(
      nu(
...
function Qa(n) {
  return ie(n, (t) => ({
    color: t.optional.object({
      ...
      type: t.optional.custom(yx),
    }),
    expanded: t.optional.boolean,
    picker: t.optional.custom(Qh),
...
class tl {
  constructor(t, e) {
    (this.type = 'float'), (this.mode = e), (this.comps_ = eu(t, e, this.type));
  }
  getComponents(t) {
    return Gs(
      nu(
...
const Sx = { int: (n, t) => new Vt(n, t), float: (n, t) => new tl(n, t) };
function el(n, t, e) {
  return Sx[e](n, t);
}
function Cx(n) {
...
function Ax(n) {
  ...
  return new Vt(
    [
      Math.round(jt(t[0], 0, 1, 0, e[0])),
      Math.round(jt(t[1], 0, 1, 0, e[1])),
      Math.round(jt(t[2], 0, 1, 0, e[2])),
      t[3],
    ],
    n.mode
  );
...
function au(n) {
  ...
  if (!t) return null;
  const e = [ru(t[1]), Ye(t[2], 100), Ye(t[3], 100)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) ? null : e;
}
function Ux(n) {
  const t = au(n);
...
function lu(n) {
  ...
  if (!t) return null;
  const e = [ru(t[1]), Ye(t[2], 100), Ye(t[3], 100), Ye(t[4], 1)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) || isNaN(e[3]) ? null : e;
}
function Nx(n) {
  const t = lu(n);
...
function hu(n) {
  ...
  if (t)
    return [
      ...
      parseInt(t[2] + t[2], 16),
      parseInt(t[3] + t[3], 16),
      jt(parseInt(t[4] + t[4], 16), 0, 255, 0, 1),
    ];
  const e = n.match(
...
const Vx = [
  { parser: cu, result: { alpha: !1, mode: 'rgb', notation: 'hex' } },
  { parser: hu, result: { alpha: !0, mode: 'rgb', notation: 'hex' } },
  { parser: su, result: { alpha: !1, mode: 'rgb', notation: 'func' } },
  { parser: ou, result: { alpha: !0, mode: 'rgb', notation: 'func' } },
  { parser: au, result: { alpha: !1, mode: 'hsl', notation: 'func' } },
  { parser: lu, result: { alpha: !0, mode: 'hsl', notation: 'func' } },
  { parser: uu, result: { alpha: !1, mode: 'rgb', notation: 'object' } },
  { parser: du, result: { alpha: !0, mode: 'rgb', notation: 'object' } },
];
function zx(n) {
  return Vx.reduce(
...
function nl(n, t = '#') {
  const e = cn(n.getComponents('rgb')).map(pu).join('');
  return `${t}${e}`;
}
function il(n, t = '#') {
  const e = n.getComponents('rgb'),
    i = [e[0], e[1], e[2], e[3] * 255].map(pu).join('');
  return `${t}${i}`;
}
function fu(n) {
  const t = Oe(0),
...
class Jx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Oi('m')),
      (this.modeElem_ = Zx(t)),
      this.modeElem_.classList.add(Oi('ms')),
      i.appendChild(this.modeSelectElement),
      e.viewProps.bindDisabled(this.modeElem_);
    const r = t.createElement('div');
    r.classList.add(Oi('mm')),
      r.appendChild(zs(t, 'dropdown')),
      i.appendChild(r),
      this.element.appendChild(i);
    const s = t.createElement('div');
    s.classList.add(Oi('w')),
      this.element.appendChild(s),
      (this.inputsElem_ = s),
    ...
    return (
      rr({
        ...
        backward(s, o) {
          ...
          c[i] = o;
          const h = el(Gs(cn(c), c[3]), a, t.colorType);
          return Ae(h, 'int');
        },
      }),
      r
...
function ib(n, t) {
  ...
  return (
    rr({
      ...
      backward: (i, r) =>
        new Vt(Gs(cn(r.getComponents(i.mode)), i.getComponents()[3]), i.mode),
    }),
    [e]
  );
}
...
class ob {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      e.viewProps.bindTabIndex(this.element);
    const i = t.createElement('div');
    i.classList.add(Do('c')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(Do('m')),
      this.element.appendChild(r),
      (this.markerElem_ = r),
      this.update_();
  }
  update_() {
    ...
    this.markerElem_.style.backgroundColor = fu(new Vt([e, 100, 100], 'hsv'));
...
class ab {
  ...
  handlePointerEvent_(t, e) {
    if (!t.point) return;
    const i = jt(_e(t.point.x, 0, t.bounds.width), 0, t.bounds.width, 0, 360),
      r = this.value.rawValue,
      [, s, o, a] = r.getComponents('hsv');
...
class cb {
  ...
  handlePointerEvent_(t, e) {
    if (!t.point) return;
    const i = jt(t.point.x, 0, t.bounds.width, 0, 100),
      r = jt(t.point.y, 0, t.bounds.height, 100, 0),
...
class ub {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Uo('sw')),
      this.element.appendChild(i),
      (this.swatchElem_ = i);
    const r = t.createElement('button');
    r.classList.add(Uo('b')),
      e.viewProps.bindDisabled(r),
      this.element.appendChild(r),
      (this.buttonElement = r),
      this.update_();
...
const Tb = Pe({
  ...
  accept: (n, t) => {
    ...
    return e
      ? {
          initialValue: n,
          params: Object.assign(Object.assign({}, e), { supportsAlpha: yb(t) }),
        }
      : null;
  },
  binding: {
  ...
  controller: (n) => {
    ...
    return new rl(n.document, {
      ...
      formatter: Sb(n.params.supportsAlpha),
      parser: Hr('int'),
      pickerLayout:
      ...
      return i
        ? {
            ...
            params: Object.assign(Object.assign({}, i), {
              colorType: (e = iu(t)) !== null && e !== void 0 ? e : 'int',
            }),
          }
        : null;
    },
...
const Bb = Pe({
  ...
  accept: (n, t) => {
    ...
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Uh(i)), {
        options: i.optional.custom(kr),
        readonly: i.optional.constant(!1),
      })
    );
  ...
  controller: (n) => {
    ...
    const r = Ih(n.params, t.rawValue),
      s = e && Is(e, Ur);
    return s
      ? new Ns(
          n.document,
...
class kb {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      En(e.expanded, er(this.element, Fi(void 0, 'expanded')));
    const i = t.createElement('div');
    i.classList.add(Fi('h')), this.element.appendChild(i);
    const r = t.createElement('button');
    r.classList.add(Fi('b')),
      r.appendChild(zs(t, 'p2dpad')),
      e.viewProps.bindDisabled(r),
      i.appendChild(r),
      (this.buttonElement = r);
    const s = t.createElement('div');
    if (
      (s.classList.add(Fi('t')),
      i.appendChild(s),
      (this.textElement = s),
      e.pickerLayout === 'inline')
    ) {
      const o = t.createElement('div');
      o.classList.add(Fi('p')),
        this.element.appendChild(o),
        (this.pickerElement = o);
    } else this.pickerElement = null;
  }
...
function Bc(n, t, e) {
  return [Ie(t[0], Tn(n)), Ie(t[1], Ar(n)) * (e ? 1 : -1)];
}
class zb {
  constructor(t, e) {
  ...
  handlePointerEvent_(t, e) {
    ...
    const i = this.props.get('max'),
      r = jt(t.point.x, 0, t.bounds.width, -i, +i),
      s = jt(
...
function jb(n, t) {
  var e, i;
  const r = kc(di(n, (e = n.x) !== null && e !== void 0 ? e : {}), t.x),
    s = kc(di(n, (i = n.y) !== null && i !== void 0 ? i : {}), t.y);
  return Math.max(r, s);
}
function qb(n) {
  if (!('y' in n)) return !1;
...
const Mu = {
  toComponents: (n) => n.getComponents(),
  fromComponents: (n) => new Wi(...n),
};
function Kb(n) {
  return Wi.isObject(n) ? new Wi(n.x, n.y, n.z) : new Wi();
}
function $b(n, t) {
...
function Qb(n) {
  return Xi.isObject(n) ? new Xi(n.x, n.y, n.z, n.w) : new Xi();
}
function tw(n, t) {
  n.writeProperty('x', t.x),
    n.writeProperty('y', t.y),
...
const nw = Pe({
  ...
  binding: {
    reader: (n) => Qb,
    constraint: (n) => ew(n.params, n.initialValue),
    equals: Xi.equals,
    writer: (n) => tw,
  },
  controller: (n) => {
...
const rw = Pe({
    ...
    controller: (n) => {
      ...
      return r
        ...
        : new Tr(t, {
            parser: (s) => s,
            props: It.fromObject({ formatter: xa }),
            value: e,
            viewProps: n.viewProps,
          });
    },
...
class sw {
  constructor(t, e) {
    ...
    i.classList.add(Vc('i')),
      (i.style.height = `calc(var(${Jh('containerUnitSize')}) * ${e.rows})`),
      (i.readOnly = !0),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
...
class cw {
  ...
  update_() {
    ...
    const c = jt(this.cursor_.rawValue, 0, i, 0, t),
      h = jt(l, r, s, e, 0);
    (a.style.left = `${c}px`),
      (a.style.top = `${h}px`),
...
class yu {
  ...
  onGraphMouseMove_(t) {
    ...
    this.cursor_.rawValue = Math.floor(
      jt(t.offsetX, 0, e, 0, this.value.rawValue.length)
    );
  }
  ...
  onGraphPointerMove_(t) {
    ...
    this.cursor_.rawValue = Math.floor(
      jt(t.data.point.x, 0, t.data.bounds.width, 0, this.value.rawValue.length)
    );
  }
  onGraphPointerUp_() {
    this.cursor_.rawValue = -1;
...
const dw = Pe({
    ...
    binding: { defaultBufferSize: (n) => (Hc(n) ? 64 : 1), reader: (n) => Th },
    controller: (n) => (Hc(n.params) ? uw(n) : hw(n)),
    api: (n) =>
      n.controller.valueController instanceof yu ? new lw(n.controller) : null,
  }),
  pw = Pe({
    id: 'monitor-string',
    type: 'monitor',
...
function _w(n, t) {
  ...
  const r = {
    ...
    l = new mw({ reader: o, target: t.target, writer: n.binding.writer(r) }),
    c = new Qg(
  ...
  const o = {
    ...
    c =
      (i =
        ...
        : 1,
    h = new x0({
      binding: new vw({ reader: l, target: t.target }),
      bufferSize: c,
      ticker: gw(t.document, a == null ? void 0 : a.interval),
    }),
    d = n.controller({
      document: t.document,
      params: s.params,
...
class bw {
  ...
  createInput_(t, e, i) {
    return this.pluginsMap_.inputs.reduce(
      (r, s) => r ?? _w(s, { document: t, target: e, params: i }),
      null
    );
  }
  createMonitor_(t, e, i) {
    return this.pluginsMap_.monitors.reduce(
      (r, s) => r ?? xw(s, { document: t, params: i, target: e }),
      null
    );
  }
  createBinding(t, e, i) {
  ...
  createBindingApi(t) {
    ...
    if (M0(t)) return this.createMonitorBindingApi_(t);
    throw ae.shouldNeverHappen();
  }
  createApi(t) {
    if (this.apiCache_.has(t)) return this.apiCache_.get(t);
...
function Mw() {
  const n = new bw(ww);
  return (
    [Yb, Jb, nw, rw, Bb, Ib, Db, Tb, fx, aw, pw, dw, T0, V0, jh].forEach(
      (t) => {
        n.register('core', t);
      }
    ),
...
class Rw {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      this.element.classList.add(Gc()),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('hr');
    i.classList.add(Gc('r')), this.element.appendChild(i);
  }
}
class Wc extends Hs {
  constructor(t, e) {
    super(
      Object.assign(Object.assign({}, e), {
        view: new Rw(t, { viewProps: e.viewProps }),
      })
    );
  }
}
const Lw = {
    ...
    controller(n) {
      return new Wc(n.document, { blade: n.blade, viewProps: n.viewProps });
    },
    api(n) {
      return n.controller instanceof Wc ? new yw(n.controller) : null;
    },
  },
  Dw = {
    id: 'slider',
...
class Ow extends Aw {
  constructor(t) {
    ...
    super(a, o),
      (this.pool_ = o),
      (this.containerElem_ =
        (i = r.container) !== null && i !== void 0 ? i : Uw(s)),
  ...
  registerPlugin(t) {
    t.css && Nw(this.document, `plugin-${t.id}`, t.css),
...
or.map = sr;
new De(kw, or);
const Ww = new De(Vw, or);
Ww.position.x = 1.5;
const Ws = new De(zw, or);
Ws.position.x = -1.5;
Ws.rotation.x = -(Math.PI * 0.5);
Ws.scale.set(1e3, 1e3);
const Xw = new De(Hw, or);
Xw.position.y = -1.5;
const jw = new De(Gw, or);
jw.position.y = 1.5;
const Su = new xr();
Su.add(Ws);
Wr.add(Su);
const qw = new Jv(16777215, 0.4);
Wr.add(qw);
const Cu = new Zv(16777215, 1.2);
Cu.position.set(5, 5, 5);
Wr.add(Cu);
const Ji = new ze(30, window.innerWidth / window.innerHeight, 0.1, 2e3);
Ji.position.z = 10;
Ji.position.y = 100;
const Tu = document.querySelector('canvas.threejs'),
  Xs = new Gv({ canvas: Tu, antialias: !0 });
Xs.setSize(window.innerWidth, window.innerHeight);
Xs.setPixelRatio(Math.min(window.devicePixelRatio, 2));
const Au = new eg(Ji, Tu);
Au.enableDamping = !0;
...
Wr.children;
const Pu = () => {
  Au.update(), Xs.render(Wr, Ji), window.requestAnimationFrame(Pu);
};
Pu();
