...
const Pl = new Dt().set(
  ...
  ar = {
    ...
    [Fs]: {
      ...
      toReference: (n) => n.applyMatrix3(Rl),
      fromReference: (n) => n.applyMatrix3(Pl),
    },
    [Ta]: {
      transfer: Qt,
      primaries: Ps,
      luminanceCoefficients: [0.2289, 0.6917, 0.0793],
      toReference: (n) => n.convertSRGBToLinear().applyMatrix3(Rl),
      fromReference: (n) => n.applyMatrix3(Pl).convertLinearToSRGB(),
    },
  },
  zd = new Set([Kn, Fs]),
  jt = {
    ...
    convert: function (n, t, e) {
      ...
      const i = ar[t].toReference,
        r = ar[e].fromReference;
      return r(i(n));
    },
    ...
    getPrimaries: function (n) {
      return ar[n].primaries;
    },
    getTransfer: function (n) {
      return n === zn ? Ts : ar[n].transfer;
    },
    getLuminanceCoefficients: function (n, t = this._workingColorSpace) {
      return n.fromArray(ar[t].luminanceCoefficients);
    },
  };
function Wi(n) {
  return n < 0.04045
    ...
    if (r !== null) {
      ...
      if (Array.isArray(r)) {
        ...
        for (let o = 0, a = r.length; o < a; o++)
          r[o].isDataTexture ? s.push(Js(r[o].image)) : s.push(Js(r[o]));
      } else s = Js(r);
      i.url = s;
    }
...
class D {
  ...
  applyEuler(t) {
    return this.applyQuaternion(Ll.setFromEuler(t));
  }
  applyAxisAngle(t, e) {
    return this.applyQuaternion(Ll.setFromAxisAngle(t, e));
  }
  applyMatrix3(t) {
    const e = this.x,
      i = this.y,
...
class Lr {
  ...
  setFromCenterAndSize(t, e) {
    const i = Je.copy(e).multiplyScalar(0.5);
    ...
    if (i !== void 0) {
      ...
      if (e === !0 && s !== void 0 && t.isInstancedMesh !== !0)
        for (let o = 0, a = s.count; o < a; o++)
          t.isMesh === !0
            ? t.getVertexPosition(o, Je)
            : Je.fromBufferAttribute(s, o),
            Je.applyMatrix4(t.matrixWorld),
            this.expandByPoint(Je);
      else
        t.boundingBox !== void 0
          ? (t.boundingBox === null && t.computeBoundingBox(),
            Yr.copy(t.boundingBox))
          : (i.boundingBox === null && i.computeBoundingBox(),
            Yr.copy(i.boundingBox)),
          Yr.applyMatrix4(t.matrixWorld),
          this.union(Yr);
    }
    const r = t.children;
  ...
  intersectsTriangle(t) {
    ...
    this.getCenter(lr),
      Kr.subVectors(this.max, lr),
      wi.subVectors(t.a, lr),
      Ei.subVectors(t.b, lr),
      yi.subVectors(t.c, lr),
      Ln.subVectors(Ei, wi),
      Dn.subVectors(yi, Ei),
      Zn.subVectors(wi, yi);
    let e = [
    ...
    return !to(e, wi, Ei, yi, Kr) ||
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !to(e, wi, Ei, yi, Kr))
      ? !1
      : ($r.crossVectors(Ln, Dn),
        (e = [$r.x, $r.y, $r.z]),
        to(e, wi, Ei, yi, Kr));
  }
  clampPoint(t, e) {
  ...
  applyMatrix4(t) {
    return this.isEmpty()
      ? this
      : (fn[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(t),
        fn[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(t),
        fn[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(t),
        fn[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(t),
        fn[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(t),
        fn[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(t),
        fn[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(t),
        fn[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(t),
...
class Aa {
  ...
  setFromPoints(t, e) {
    const i = this.center;
    e !== void 0 ? i.copy(e) : qd.setFromPoints(t).getCenter(i);
    let r = 0;
  ...
  expandByPoint(t) {
    ...
    if (e > this.radius * this.radius) {
      const i = Math.sqrt(e),
        r = (i - this.radius) * 0.5;
      this.center.addScaledVector(cr, r / i), (this.radius += r);
    }
    return this;
  }
  union(t) {
    return t.isEmpty()
      ...
      : (this.center.equals(t.center) === !0
          ...
          : (eo.subVectors(t.center, this.center).setLength(t.radius),
            this.expandByPoint(cr.copy(t.center).add(eo)),
            this.expandByPoint(cr.copy(t.center).sub(eo))),
        this);
  }
  equals(t) {
...
class ph {
  ...
  distanceSqToPoint(t) {
    ...
    return e < 0
      ...
      : (mn.copy(this.origin).addScaledVector(this.direction, e),
        mn.distanceToSquared(t));
  }
  distanceSqToSegment(t, e, i, r) {
    no.copy(t).add(e).multiplyScalar(0.5),
      Zr.copy(e).sub(t).normalize(),
      In.copy(this.origin).sub(no);
    const s = t.distanceTo(e) * 0.5,
      o = -this.direction.dot(Zr),
    ...
    return (
      ...
      r && r.copy(no).addScaledVector(Zr, p),
      m
    );
  }
  intersectSphere(t, e) {
    mn.subVectors(t.center, this.origin);
    const i = mn.dot(this.direction),
      r = mn.dot(mn) - i * i,
      s = t.radius * t.radius;
    if (r > s) return null;
  ...
  intersectTriangle(t, e, i, r, s) {
    io.subVectors(e, t), Jr.subVectors(i, t), ro.crossVectors(io, Jr);
    let o = this.direction.dot(ro),
      a;
    if (o > 0) {
      if (r) return null;
      a = 1;
    ...
    const l = a * this.direction.dot(Jr.crossVectors(In, Jr));
    if (l < 0) return null;
    const c = a * this.direction.dot(io.cross(In));
...
class le {
  ...
  lookAt(t, e, i) {
    ...
    return (
      ...
      ze.normalize(),
      Un.crossVectors(i, ze),
      Un.lengthSq() === 0 &&
        (Math.abs(i.z) === 1 ? (ze.x += 1e-4) : (ze.z += 1e-4),
        ze.normalize(),
        Un.crossVectors(i, ze)),
      Un.normalize(),
      Qr.crossVectors(ze, Un),
      (r[0] = Un.x),
      (r[4] = Qr.x),
      (r[8] = ze.x),
      (r[1] = Un.y),
  ...
  multiplyMatrices(t, e) {
    ...
    return (
      ...
      (s[14] = v * w + b * B + f * $ + u * mt),
      (s[3] = S * T + M * x + E * G + N * z),
      (s[7] = S * C + M * P + E * j + N * ot),
      (s[11] = S * U + M * V + E * H + N * ht),
      (s[15] = S * w + M * B + E * $ + N * mt),
      this
    );
  }
  ...
  invert() {
    const t = this.elements,
      ...
      M = v * p * c - h * f * c - v * l * m + o * f * m + h * l * u - o * p * u,
  ...
  makePerspective(t, e, i, r, s, o, a = En) {
    ...
    else if (a === Rs) (m = -o / (o - s)), (v = (-o * s) / (o - s));
    else
      throw new Error(
  ...
  makeOrthographic(t, e, i, r, s, o, a = En) {
    const l = this.elements,
      c = 1 / (e - t),
      h = 1 / (i - r),
      d = 1 / (o - s),
      ...
      m = (i + r) * h;
    let v, b;
    if (a === En) (v = (o + s) * d), (b = -2 * d);
    else if (a === Rs) (v = s * d), (b = -1 * d);
    else
      throw new Error(
...
const Si = new D(),
  ...
  Il = new di();
class cn {
  constructor(t = 0, e = 0, i = 0, r = cn.DEFAULT_ORDER) {
    (this.isEuler = !0),
      (this._x = t),
      (this._y = e),
      (this._z = i),
  ...
  setFromQuaternion(t, e, i) {
    return (
      Dl.makeRotationFromQuaternion(t), this.setFromRotationMatrix(Dl, e, i)
    );
  }
  ...
  reorder(t) {
    return Il.setFromEuler(this), this.setFromQuaternion(Il, t);
  }
  equals(t) {
    return (
      t._x === this._x &&
...
const Ul = new D(),
  ...
  so = { type: 'childremoved', child: null };
class Oe extends _i {
  constructor() {
    super(),
      (this.isObject3D = !0),
  ...
  translateOnAxis(t, e) {
    return (
      Ul.copy(t).applyQuaternion(this.quaternion),
      this.position.add(Ul.multiplyScalar(e)),
      this
    );
  }
  translateX(t) {
  ...
  lookAt(t, e, i) {
    t.isVector3 ? ts.copy(t) : ts.set(t, e, i);
    const r = this.parent;
    this.updateWorldMatrix(!0, !1),
      hr.setFromMatrixPosition(this.matrixWorld),
      this.isCamera || this.isLight
        ? _n.lookAt(hr, ts, this.up)
        : _n.lookAt(ts, hr, this.up),
      this.quaternion.setFromRotationMatrix(_n),
      r &&
        (_n.extractRotation(r.matrixWorld),
        Ci.setFromRotationMatrix(_n),
  ...
  getWorldQuaternion(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(hr, t, Zd), t
    );
  }
  getWorldScale(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(hr, Jd, t), t
    );
  }
  getWorldDirection(t) {
    this.updateWorldMatrix(!0, !1);
...
class an {
  ...
  static getNormal(t, e, i, r) {
    r.subVectors(i, e), tn.subVectors(t, e), r.cross(tn);
    const s = r.lengthSq();
    return s > 0 ? r.multiplyScalar(1 / Math.sqrt(s)) : r.set(0, 0, 0);
  }
  static getBarycoord(t, e, i, r, s) {
    tn.subVectors(r, e), vn.subVectors(i, e), oo.subVectors(t, e);
    const o = tn.dot(tn),
      a = tn.dot(vn),
      l = tn.dot(oo),
      c = vn.dot(vn),
  ...
  static containsPoint(t, e, i, r) {
    return this.getBarycoord(t, e, i, r, gn) === null
      ? !1
  ...
  static getInterpolation(t, e, i, r, s, o, a, l) {
    return this.getBarycoord(t, e, i, r, gn) === null
      ? ((l.x = 0),
        ...
        null)
      : (l.setScalar(0),
        l.addScaledVector(s, gn.x),
        l.addScaledVector(o, gn.y),
        l.addScaledVector(a, gn.z),
        l);
  }
  static isFrontFacing(t, e, i, r) {
    return tn.subVectors(i, e), vn.subVectors(t, e), tn.cross(vn).dot(r) < 0;
  }
  set(t, e, i) {
  ...
  getInterpolation(t, e, i, r, s) {
    return an.getInterpolation(t, this.a, this.b, this.c, e, i, r, s);
  }
  containsPoint(t) {
  ...
  closestPointToPoint(t, e) {
    const i = this.a,
      ...
      s = this.c;
    let o, a;
    Ai.subVectors(r, i), Pi.subVectors(s, i), ao.subVectors(t, i);
    const l = Ai.dot(ao),
      c = Pi.dot(ao);
...
class zt {
  ...
  setHSL(t, e, i, r = jt.workingColorSpace) {
    if (((t = Fd(t, 1)), (e = Ce(e, 0, 1)), (i = Ce(i, 0, 1)), e === 0))
  ...
  copyLinearToSRGB(t) {
    return (this.r = Zs(t.r)), (this.g = Zs(t.g)), (this.b = Zs(t.b)), this;
  }
  convertSRGBToLinear() {
  ...
  offsetHSL(t, e, i) {
    return this.getHSL(Nn), this.setHSL(Nn.h + t, Nn.s + e, Nn.l + i);
  }
  add(t) {
    return (this.r += t.r), (this.g += t.g), (this.b += t.b), this;
  }
  ...
  lerpHSL(t, e) {
    this.getHSL(Nn), t.getHSL(es);
    const i = Ks(Nn.h, es.h, e),
      r = Ks(Nn.s, es.s, e),
      s = Ks(Nn.l, es.l, e);
...
class Dr extends _i {
  ...
  toJSON(t) {
    ...
    (i.uuid = this.uuid),
      ...
      this.blendSrc !== Io && (i.blendSrc = this.blendSrc),
      this.blendDst !== Uo && (i.blendDst = this.blendDst),
      ...
      this.stencilFunc !== Sl && (i.stencilFunc = this.stencilFunc),
...
class Pe {
  ...
  setComponent(t, e, i) {
    return (
      this.normalized && (i = De(i, this.array)),
  ...
  getX(t) {
    ...
    return this.normalized && (e = or(e, this.array)), e;
  }
  setX(t, e) {
    return (
      this.normalized && (e = De(e, this.array)),
  ...
  setXY(t, e, i) {
    return (
      (t *= this.itemSize),
      this.normalized && ((e = De(e, this.array)), (i = De(i, this.array))),
      (this.array[t + 0] = e),
      (this.array[t + 1] = i),
      this
    );
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== Cl && (t.usage = this.usage),
      t
    );
  }
}
...
class dn extends _i {
  ...
  translate(t, e, i) {
    return qe.makeTranslation(t, e, i), this.applyMatrix4(qe), this;
  }
  scale(t, e, i) {
    return qe.makeScale(t, e, i), this.applyMatrix4(qe), this;
  }
  lookAt(t) {
    ...
    if (t !== void 0) {
      if ((this.boundingBox.setFromBufferAttribute(t), e))
        for (let i = 0, r = e.length; i < r; i++) {
          const s = e[i];
          He.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (xe.addVectors(this.boundingBox.min, He.min),
                this.boundingBox.expandByPoint(xe),
                xe.addVectors(this.boundingBox.max, He.max),
                this.boundingBox.expandByPoint(xe))
      ...
      if ((He.setFromBufferAttribute(t), e))
        for (let s = 0, o = e.length; s < o; s++) {
          ...
          ur.setFromBufferAttribute(a),
            this.morphTargetsRelative
              ? (xe.addVectors(He.min, ur.min),
                He.expandByPoint(xe),
                xe.addVectors(He.max, ur.max),
                He.expandByPoint(xe))
              : (He.expandByPoint(ur.min), He.expandByPoint(ur.max));
        }
      He.getCenter(i);
      let r = 0;
  ...
  computeTangents() {
    ...
    this.hasAttribute('tangent') === !1 &&
      this.setAttribute('tangent', new Pe(new Float32Array(4 * i.count), 4));
    ...
    function C(U) {
      ...
      const w = a[U];
      M.copy(w),
        M.sub(N.multiplyScalar(N.dot(w))).normalize(),
        E.crossVectors(T, w);
      const P = E.dot(l[U]) < 0 ? -1 : 1;
      o.setXYZW(U, M.x, M.y, M.z, P);
    }
    for (let U = 0, w = S.length; U < w; ++U) {
      const x = S[U],
        P = x.start,
  ...
  computeVertexNormals() {
    ...
    if (e !== void 0) {
      ...
      if (i === void 0)
        (i = new Pe(new Float32Array(e.count * 3), 3)),
...
class Te extends Oe {
    ...
    if (s && a) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const h = a[l],
          d = s[l];
        h !== 0 &&
          (po.fromBufferAttribute(d, t),
          o ? rs.addScaledVector(po, h) : rs.addScaledVector(po.sub(e), h));
      }
      e.add(rs);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    r !== void 0 &&
      ...
      !(
        is.containsPoint(Qn.origin) === !1 &&
        (Qn.intersectSphere(is, zl) === null ||
          Qn.origin.distanceToSquared(zl) > (t.far - t.near) ** 2)
      ) &&
        (Vl.copy(s).invert(),
        Qn.copy(t.ray).applyMatrix4(Vl),
        !(i.boundingBox !== null && Qn.intersectsBox(i.boundingBox) === !1) &&
          this._computeIntersections(t, e, Qn)));
  }
    ...
    if (a !== null)
      if (Array.isArray(o))
        for (let v = 0, b = p.length; v < b; v++) {
          ...
          for (let E = S, N = M; E < N; E += 3) {
            const T = a.getX(E),
              C = a.getX(E + 1),
              U = a.getX(E + 2);
            (r = hs(this, u, t, i, c, h, d, T, C, U)),
              r &&
...
function np(n, t, e, i, r, s, o, a) {
  ...
  if (
    (t.side === Ne
      ...
      : (l = i.intersectTriangle(r, s, o, t.side === jn, a)),
    l === null)
  )
    return null;
  cs.copy(a), cs.applyMatrix4(n.matrixWorld);
  const c = e.ray.origin.distanceTo(cs);
  return c < e.near || c > e.far
    ? null
    : { distance: c, point: cs.clone(), object: n };
}
function hs(n, t, e, i, r, s, o, a, l, c) {
  n.getVertexPosition(a, Li),
    n.getVertexPosition(l, Di),
    n.getVertexPosition(c, Ii);
  const h = np(n, t, e, i, Li, Di, Ii, ls);
  if (h) {
    r &&
      (ss.fromBufferAttribute(r, a),
      os.fromBufferAttribute(r, l),
      as.fromBufferAttribute(r, c),
      (h.uv = an.getInterpolation(ls, Li, Di, Ii, ss, os, as, new yt()))),
      s &&
        (ss.fromBufferAttribute(s, a),
        os.fromBufferAttribute(s, l),
        as.fromBufferAttribute(s, c),
        (h.uv1 = an.getInterpolation(ls, Li, Di, Ii, ss, os, as, new yt()))),
      o &&
        (Hl.fromBufferAttribute(o, a),
        Gl.fromBufferAttribute(o, l),
        Wl.fromBufferAttribute(o, c),
        (h.normal = an.getInterpolation(ls, Li, Di, Ii, Hl, Gl, Wl, new D())),
        h.normal.dot(i.direction) > 0 && h.normal.multiplyScalar(-1));
    const d = { a, b: l, c, normal: new D(), materialIndex: 0 };
    an.getNormal(Li, Di, Ii, d.normal), (h.face = d);
  }
  return h;
}
class Qi extends dn {
  constructor(t = 1, e = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function v(b, f, u, S, M, E, N, T, C, U, w) {
      const x = E / C,
        P = N / U,
        V = E / 2,
        B = N / 2,
...
class Ge extends bh {
  ...
  getEffectiveFOV() {
    return ua * 2 * Math.atan(Math.tan(ws * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewBounds(t, e, i) {
    On.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      ...
      On.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      i.set(On.x, On.y).multiplyScalar(-t / On.z);
  }
  getViewSize(t, e) {
    return this.getViewBounds(t, Xl, jl), e.subVectors(jl, Xl);
  }
...
class ap extends Oe {
  constructor(t, e, i) {
    ...
    const r = new Ge(Ui, Ni, t, e);
    (r.layers = this.layers), this.add(r);
    const s = new Ge(Ui, Ni, t, e);
    (s.layers = this.layers), this.add(s);
    const o = new Ge(Ui, Ni, t, e);
    (o.layers = this.layers), this.add(o);
    const a = new Ge(Ui, Ni, t, e);
    (a.layers = this.layers), this.add(a);
    const l = new Ge(Ui, Ni, t, e);
    (l.layers = this.layers), this.add(l);
    const c = new Ge(Ui, Ni, t, e);
...
class lp extends ui {
  constructor(t = 1, e = {}) {
    ...
    (this.texture = new Mh(
      ...
      (this.texture.minFilter = e.minFilter !== void 0 ? e.minFilter : en);
  }
...
class Vn {
  ...
  setFromCoplanarPoints(t, e, i) {
    const r = fo.subVectors(i, e).cross(cp.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const i = e || hp.getNormalMatrix(t),
      r = this.coplanarPoint(fo).applyMatrix4(t),
...
class Pa {
  ...
  setFromProjectionMatrix(t, e = En) {
    ...
    if (
      ...
      i[4].setComponents(l - a, p - d, f - b, E - M).normalize(),
      e === En)
    )
      i[5].setComponents(l + a, p + d, f + b, E + M).normalize();
  ...
  intersectsBox(t) {
    ...
    for (let i = 0; i < 6; i++) {
      const r = e[i];
      if (
        ((us.x = r.normal.x > 0 ? t.max.x : t.min.x),
        (us.y = r.normal.y > 0 ? t.max.y : t.min.y),
        (us.z = r.normal.z > 0 ? t.max.z : t.min.z),
        r.distanceToPoint(us) < 0)
      )
        return !1;
    }
    return !0;
...
class Ir extends dn {
  constructor(t = 1, e = 1, i = 1, r = 1) {
    ...
    for (let u = 0; u < h; u++) {
      ...
      for (let M = 0; M < c; M++) {
        const E = M * d - s;
        v.push(E, -S, 0), b.push(0, 0, 1), f.push(M / a), f.push(1 - u / l);
      }
    }
    for (let u = 0; u < l; u++)
      for (let S = 0; S < a; S++) {
...
#endif`,
  fp = `#ifdef USE_ALPHAMAP
	diffuseColor.a *= texture2D( alphaMap, vAlphaMapUv ).g;
#endif`,
  mp = `#ifdef USE_ALPHAMAP
	uniform sampler2D alphaMap;
#endif`,
  _p = `#ifdef USE_ALPHATEST
...
#endif`,
  wp = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  Ep = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
IncidentLight directLight;
  ...
  pf = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  ff = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  mf = `#if defined( USE_LOGDEPTHBUF )
  ...
  wf = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Ef = `float metalnessFactor = metalness;
...
#endif`,
  Tf = `#ifdef USE_MORPHNORMALS
	objectNormal *= morphTargetBaseInfluence;
	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {
		if ( morphTargetInfluences[ i ] != 0.0 ) objectNormal += getMorph( gl_VertexID, i, 1 ).xyz * morphTargetInfluences[ i ];
	}
#endif`,
  Af = `#ifdef USE_MORPHTARGETS
...
#endif`,
  Rf = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  zf = `vec3 packNormalToRGB( const in vec3 normal ) {
...
gl_Position = projectionMatrix * mvPosition;`,
  ...
  Kf = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  $f = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  cm = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
	...
	varying vec2 vThicknessMapUv;
#endif`,
  hm = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	vUv = vec3( uv, 1 ).xy;
#endif
#ifdef USE_MAP
...
void main() {
  ...
  Lt = {
    ...
    batching_vertex: Mp,
    begin_vertex: wp,
    beginnormal_vertex: Ep,
    bsdfs: yp,
    iridescence_fragment: Sp,
    bumpmap_pars_fragment: Cp,
    clipping_planes_fragment: Tp,
    clipping_planes_pars_fragment: Ap,
    clipping_planes_pars_vertex: Pp,
    clipping_planes_vertex: Rp,
    color_fragment: Lp,
    color_pars_fragment: Dp,
...
function qm(n, t, e, i, r, s, o) {
  ...
  function b(S) {
    let M = !1;
    const E = v(S);
    E === null ? u(a, l) : E && E.isColor && (u(E, 1), (M = !0));
  ...
  function f(S, M) {
    const E = v(M);
    E && (E.isCubeTexture || E.mapping === Os)
      ? (h === void 0 &&
          ((h = new Te(
            new Qi(1, 1, 1),
            new qn({
        ...
        h.material.uniforms.backgroundRotation.value.setFromMatrix4(
          jm.makeRotationFromEuler(ei)
        ),
        (h.material.toneMapped = jt.getTransfer(E.colorSpace) !== Qt),
      ...
      : E &&
        ...
        (c.material.toneMapped = jt.getTransfer(E.colorSpace) !== Qt),
  ...
  function u(S, M) {
    S.getRGB(ds, xh(n)), i.buffers.color.setClear(ds.r, ds.g, ds.b, M, o);
  }
  return {
      ...
      if (z.location >= 0) {
        ...
        if (
          ...
          const Kt = Ot.buffer,
            ...
            ft = W === n.INT || W === n.UNSIGNED_INT || ot.gpuType === Ma;
  ...
  (this.uniform = l),
    ...
    (this.setState = function (d, p, m) {
      ...
      if (!r || v === null || v.length === 0 || (s && !f)) s ? h(null) : c();
        ...
        (l.value = E), (E = h(v, p, M, m));
        for (let N = 0; N !== M; ++N) E[N] = e[N];
        (u.clippingState = E),
...
function Jm(n) {
  let t = new WeakMap();
  function e(o, a) {
    return a === No ? (o.mapping = qi) : a === Oo && (o.mapping = Yi), o;
  }
  function i(o) {
    if (o && o.isTexture) {
      const a = o.mapping;
...
const Vi = 4,
  ql = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  oi = 20,
  mo = new Qm(),
  Yl = new zt();
let _o = null,
...
class $l {
  ...
  fromScene(t, e = 0, i = 0.1, r = 100) {
    (_o = this._renderer.getRenderTarget()),
      (vo = this._renderer.getActiveCubeFace()),
      (go = this._renderer.getActiveMipmapLevel()),
      (xo = this._renderer.xr.enabled),
  ...
  _cleanup(t) {
    this._renderer.setRenderTarget(_o, vo, go),
      (this._renderer.xr.enabled = xo),
      (t.scissorTest = !1),
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Zl(t, e, i));
  ...
  _sceneToCubeUV(t, e, i, r) {
    const a = new Ge(90, 1, e, i),
      l = [1, -1, 1, 1, 1, 1],
      c = [1, 1, 1, -1, -1, -1],
      h = this._renderer,
      d = h.autoClear,
      p = h.toneMapping;
    h.getClearColor(Yl), (h.toneMapping = Wn), (h.autoClear = !1);
    const m = new _h({
  ...
  _textureToCubeUV(t, e) {
    ...
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = Ql()),
    ...
    ps(e, 0, 0, 3 * l, 2 * l), i.setRenderTarget(e), i.render(o, mo);
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, i, r, s, o, a) {
    ...
    const h = 3,
      ...
      v = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * oi - 1),
      b = s / v,
    ...
    (p.dTheta.value = v), (p.mipInt.value = M - i);
    const E = this._sizeLods[r],
      N = 3 * E * (r > M - Vi ? r - M + Vi : 0),
      T = 4 * (this._cubeSize - E);
    ps(e, N, T, 3 * E, 2 * E), l.setRenderTarget(e), l.render(d, mo);
  }
}
function t_(n) {
  const t = [],
    ...
    i = [];
  let r = n;
  const s = n - Vi + 1 + ql.length;
  for (let o = 0; o < s; o++) {
    const a = Math.pow(2, r);
    e.push(a);
    let l = 1 / a;
    o > n - Vi ? (l = ql[o - n + Vi - 1]) : o === 0 && (l = 0), i.push(l);
    const c = 1 / (a - 2),
      h = -c,
      d = 1 + c,
    ...
    for (let T = 0; T < m; T++) {
      ...
      S.set(w, b * v * T), M.set(p, f * v * T);
      const x = [T, T, T, T, T, T];
      E.set(x, u * v * T);
    }
    const N = new dn();
    N.setAttribute('position', new Pe(S, b)),
      N.setAttribute('uv', new Pe(M, f)),
      N.setAttribute('faceIndex', new Pe(E, u)),
      t.push(N),
      r > Vi && r--;
  }
...
function r_(n, t, e, i) {
  ...
  function c(d) {
    ...
    if (m !== null) {
      const S = m.array;
      b = m.version;
      for (let M = 0, E = S.length; M < E; M += 3) {
        const N = S[M + 0],
          T = S[M + 1],
          C = S[M + 2];
        p.push(N, T, T, C, C, N);
      ...
      const S = v.array;
      b = v.version;
      for (let M = 0, E = S.length / 3 - 1; M < E; M += 3) {
        const N = M + 0,
          T = M + 1,
          C = M + 2;
        p.push(N, T, T, C, C, N);
...
function a_(n, t, e) {
  ...
  function s(o, a, l) {
    ...
    if (p === void 0 || p.count !== d) {
      ...
      (p = { count: d, texture: U, size: new yt(N, T) }),
        i.set(a, p),
...
class Eh extends Ae {
  constructor(t, e, i, r, s, o, a, l, c, h = Gi) {
    ...
    i === void 0 && h === Gi && (i = hi),
      ...
      (this.magFilter = a !== void 0 ? a : Ke),
      (this.minFilter = l !== void 0 ? l : Ke),
      (this.flipY = !1),
      (this.generateMipmaps = !1),
...
function tr(n, t, e) {
  ...
  const r = t * e;
  let s = ec[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (ec[r] = s)), t !== 0)) {
    i.toArray(s, 0);
...
function Bs(n, t) {
  let e = nc[t];
  e === void 0 && ((e = new Int32Array(t)), (nc[t] = e));
...
function p_(n, t) {
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    sc.set(i), n.uniformMatrix2fv(this.addr, !1, sc), ge(e, i);
  }
}
function f_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    rc.set(i), n.uniformMatrix3fv(this.addr, !1, rc), ge(e, i);
  }
}
function m_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    ic.set(i), n.uniformMatrix4fv(this.addr, !1, ic), ge(e, i);
  }
}
function __(n, t) {
  const e = this.cache;
...
function S_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTexture3D(t || Ch, r);
}
function C_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTextureCube(t || Th, r);
}
function T_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTexture2DArray(t || Sh, r);
}
function A_(n) {
  switch (n) {
    case 5126:
...
function W_(n, t, e) {
  ...
  for (let o = 0; o !== r; ++o) e.setTexture2D(t[o] || yh, s[o]);
}
function X_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = Bs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture3D(t[o] || Ch, s[o]);
}
function j_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = Bs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTextureCube(t[o] || Th, s[o]);
}
function q_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = Bs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture2DArray(t[o] || Sh, s[o]);
}
function Y_(n) {
  switch (n) {
    case 5126:
...
function J_(n, t, e) {
  ...
  for (bo.lastIndex = 0; ; ) {
    ...
    if ((l && (a = a | 0), c === void 0 || (c === '[' && o + 2 === r))) {
      oc(e, c === void 0 ? new K_(a, n, t) : new $_(a, n, t));
      break;
    } else {
      let d = e.map[a];
      d === void 0 && ((d = new Z_(a)), oc(e, d)), (e = d);
    }
  }
}
class Es {
...
const fs = new D();
function sv() {
  jt.getLuminanceCoefficients(fs);
  const n = fs.x.toFixed(4),
    t = fs.y.toFixed(4),
    e = fs.z.toFixed(4);
  return [
...
function fv(n) {
  ...
  return (
    n.shadowMapType === Kc
      ...
      : n.shadowMapType === bn && (t = 'SHADOWMAP_TYPE_VSM'),
    t
  );
}
function mv(n) {
...
`)),
      (u = [
        ...
        e.toneMapping !== Wn ? Lt.tonemapping_pars_fragment : '',
        e.toneMapping !== Wn ? rv('toneMapping', e.toneMapping) : '',
        e.dithering ? '#define DITHERING' : '',
        e.opaque ? '#define OPAQUE' : '',
        Lt.colorspace_pars_fragment,
        iv('linearToOutputTexel', e.outputColorSpace),
        sv(),
...
` +
      ...
      (u =
        [
          ...
          e.glslVersion === Tl ? '' : '#define gl_FragColor pc_fragColor',
...
` +
  ...
  const M = S + f + o,
    E = S + u + a,
    N = ac(r, r.VERTEX_SHADER, M),
    T = ac(r, r.FRAGMENT_SHADER, E);
  r.attachShader(b, N),
    r.attachShader(b, T),
...
` +
    ...
    r.deleteShader(N), r.deleteShader(T), (U = new Es(r, b)), (w = lv(r, b));
  }
  let U;
...
class Mv {
  ...
  _getShaderStage(t) {
    ...
    let i = e.get(t);
    return i === void 0 && ((i = new wv(t)), e.set(t, i)), i;
  }
}
class wv {
  constructor(t) {
    (this.id = bv++), (this.code = t), (this.usedTimes = 0);
  }
}
function Ev(n, t, e, i, r, s, o) {
  const a = new fh(),
    l = new Mv(),
    c = new Set(),
    h = [],
  ...
  function f(w, x, P, V, B) {
    const G = V.fog,
      j = B.geometry,
      H = w.isMeshStandardMaterial ? V.environment : null,
      $ = (w.isMeshStandardMaterial ? e : t).get(w.envMap || H),
      z = $ && $.mapping === Os ? $.image.height : null,
      ot = v[w.type];
    w.precision !== null &&
    ...
    if (ot) {
      const Ht = on[ot];
      (Kt = Ht.vertexShader), (W = Ht.fragmentShader);
    } else
      (Kt = w.vertexShader),
        (W = w.fragmentShader),
        l.update(w),
    ...
    const lt = n.getRenderTarget(),
      ...
      ct = k && !!w.clearcoatMap,
      Rt = k && !!w.clearcoatNormalMap,
      Q = k && !!w.clearcoatRoughnessMap,
    ...
    const be = {
      ...
      emissiveMap: Ct,
      normalMapObjectSpace: gt && w.normalMapType === Pd,
      normalMapTangentSpace: gt && w.normalMapType === lh,
      metalnessMap: Pt,
      roughnessMap: y,
      anisotropy: _,
      anisotropyMap: rt,
      ...
      roughnessMapUv: y && b(w.roughnessMap.channel),
      ...
      alphaMapUv: q && b(w.alphaMap.channel),
  ...
  function N(w, x) {
    ...
    return P === void 0 && ((P = new xv(n, x, w, s)), h.push(P)), P;
  }
  function T(w) {
    if (--w.usedTimes === 0) {
      const x = h.indexOf(w);
...
function fc() {
  ...
  function c(d, p) {
    e.length > 1 && e.sort(d || Sv),
      i.length > 1 && i.sort(p || pc),
      r.length > 1 && r.sort(p || pc);
  }
  function h() {
    ...
    get: function (t) {
      ...
      switch (t.type) {
        case 'DirectionalLight':
          e = { direction: new D(), color: new zt() };
          break;
        case 'SpotLight':
          e = {
            position: new D(),
          ...
          break;
        case 'PointLight':
          e = { position: new D(), color: new zt(), distance: 0, decay: 0 };
          break;
        case 'HemisphereLight':
          e = { direction: new D(), skyColor: new zt(), groundColor: new zt() };
          break;
        case 'RectAreaLight':
          e = {
            color: new zt(),
    ...
    for (let u = 0, S = c.length; u < S; u++) {
      ...
      if (M.isDirectionalLight) {
        ...
        E.position.setFromMatrixPosition(M.matrixWorld),
          ...
          s.premultiply(f),
          o.extractRotation(s),
          E.halfWidth.set(M.width * 0.5, 0, 0),
          E.halfHeight.set(0, M.height * 0.5, 0),
...
function Fv(n, t, e) {
  ...
  this.render = function (T, C, U) {
    ...
    for (let j = 0, H = T.length; j < H; j++) {
      ...
      if (
        ...
        const mt = this.type !== bn ? { minFilter: Ke, magFilter: Ke } : {};
        z.map !== null && z.map.dispose(),
          (z.map = new ui(r.x, r.y, mt)),
      ...
      z.isPointLightShadow !== !0 && this.type === bn && S(z, U),
        (z.needsUpdate = !1);
    }
  ...
  function S(T, C) {
    ...
    p.defines.VSM_SAMPLES !== T.blurSamples &&
      ...
      (p.needsUpdate = !0),
      (m.needsUpdate = !0)),
      T.mapPass === null && (T.mapPass = new ui(r.x, r.y)),
  ...
  function E(T, C, U, w, x) {
    if (T.visible === !1) return;
    if (
      T.layers.test(C.layers) &&
      (T.isMesh || T.isLine || T.isPoints) &&
      (T.castShadow || (T.receiveShadow && x === bn)) &&
    ...
    const V = T.children;
    for (let B = 0, G = V.length; B < G; B++) E(V[B], C, U, w, x);
  }
  function N(T) {
...
function Bv(n) {
  ...
  function i() {
    ...
    return {
      ...
      setFunc: function (Ht, pn, rn) {
        (X !== Ht || q !== pn || nt !== rn) &&
          (n.stencilFunc(Ht, pn, rn), (X = Ht), (q = pn), (nt = rn));
      },
      setOp: function (Ht, pn, rn) {
        (bt !== Ht || Bt !== pn || ue !== rn) &&
          (n.stencilOp(Ht, pn, rn), (bt = Ht), (Bt = pn), (ue = rn));
      },
  ...
  const re = {
    [si]: n.FUNC_ADD,
    [qu]: n.FUNC_SUBTRACT,
    [Yu]: n.FUNC_REVERSE_SUBTRACT,
  };
  (re[Ku] = n.MIN), (re[$u] = n.MAX);
  const A = {
    [Zu]: n.ZERO,
    [Ju]: n.ONE,
    [Qu]: n.SRC_COLOR,
    [Io]: n.SRC_ALPHA,
    [sd]: n.SRC_ALPHA_SATURATE,
    [id]: n.DST_COLOR,
    [ed]: n.DST_ALPHA,
    [td]: n.ONE_MINUS_SRC_COLOR,
    [Uo]: n.ONE_MINUS_SRC_ALPHA,
    [rd]: n.ONE_MINUS_DST_COLOR,
    [nd]: n.ONE_MINUS_DST_ALPHA,
    [od]: n.CONSTANT_COLOR,
    [ad]: n.ONE_MINUS_CONSTANT_COLOR,
    [ld]: n.CONSTANT_ALPHA,
    [cd]: n.ONE_MINUS_CONSTANT_ALPHA,
  };
  function ce(R, tt, X, q, nt, bt, Bt, ue, be, Ht) {
    if (R === Gn) {
      v === !0 && (lt(n.BLEND), (v = !1));
      return;
    }
    if ((v === !1 && (ft(n.BLEND), (v = !0)), R !== ju)) {
      if (R !== b || Ht !== U) {
        if (
          ((f !== si || M !== si) &&
  ...
  function Yt(R, tt) {
    R.side === Mn ? lt(n.CULL_FACE) : ft(n.CULL_FACE);
    let X = R.side === Ne;
    tt && (X = !X),
      $t(X),
...
function Vv(n, t, e, i, r, s, o) {
  ...
  function v(y, _) {
    return m ? new OffscreenCanvas(y, _) : Mr('canvas');
  }
  function b(y, _, k) {
    let Y = 1;
    const Z = Pt(y);
  ...
  function f(y) {
    return y.generateMipmaps && y.minFilter !== Ke && y.minFilter !== en;
  }
  function u(y) {
    n.generateMipmap(y);
  }
  function S(y, _, k, Y, Z = !1) {
    ...
    if (
      ...
      const xt = Z ? Ts : jt.getTransfer(Y);
  ...
  function M(y, _) {
    ...
    return (
      y
        ...
        : _ === br && (k = n.DEPTH_COMPONENT16),
      k
    );
  }
  function E(y, _) {
    return f(y) === !0 ||
      (y.isFramebufferTexture && y.minFilter !== Ke && y.minFilter !== en)
  ...
  function T(y) {
    const _ = y.target;
    _.removeEventListener('dispose', T), w(_);
  }
  function C(y) {
    const _ = i.get(y);
  ...
  const z = { [Fo]: n.REPEAT, [ai]: n.CLAMP_TO_EDGE, [Bo]: n.MIRRORED_REPEAT },
    ot = {
      [Ke]: n.NEAREST,
      [Cd]: n.NEAREST_MIPMAP_NEAREST,
      [qr]: n.NEAREST_MIPMAP_LINEAR,
      [en]: n.LINEAR,
      [Ys]: n.LINEAR_MIPMAP_NEAREST,
  ...
  function mt(y, _) {
    if (
      ...
      if (
        _.magFilter === Ke ||
        (_.minFilter !== qr && _.minFilter !== li) ||
        (_.type === wn && t.has('OES_texture_float_linear') === !1)
      )
        return;
  ...
  function Kt(y, _, k) {
    ...
    if (K.version !== xt.__version || Z === !0) {
      ...
      const rt = jt.getPrimaries(jt.workingColorSpace),
        ct = _.colorSpace === zn ? null : jt.getPrimaries(_.colorSpace),
        Rt =
          _.colorSpace === zn || rt === ct ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      ...
      if (_.isDepthTexture)
        ...
        if (_.isCompressedArrayTexture) {
          ...
          for (let X = 0, q = Tt.length; X < q; X++)
            if (((ut = Tt[X]), _.format !== nn))
              if (at !== null)
                if (Ut) {
                  if (R)
                    if (_.layerUpdates.size > 0) {
                      const nt = _c(ut.width, ut.height, _.format, _.type);
        ...
        if (Ut) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const X = _c(Q.width, Q.height, _.format, _.type);
        ...
        if (ne)
          if (Ut) e.texStorage2D(n.TEXTURE_2D, tt, St, Q.width, Q.height);
            ...
            for (let nt = 0; nt < tt; nt++)
              e.texImage2D(n.TEXTURE_2D, nt, St, X, q, 0, at, Ft, null),
                (X >>= 1),
                (q >>= 1);
          }
      } else if (Tt.length > 0) {
        if (Ut && ne) {
          const X = Pt(Tt[0]);
          e.texStorage2D(n.TEXTURE_2D, tt, St, X.width, X.height);
        }
        for (let X = 0, q = Tt.length; X < q; X++)
          (ut = Tt[X]),
            Ut
              ? R && e.texSubImage2D(n.TEXTURE_2D, X, 0, 0, at, Ft, ut)
              : e.texImage2D(n.TEXTURE_2D, X, St, at, Ft, ut);
        _.generateMipmaps = !1;
      } else if (Ut) {
        if (ne) {
          const X = Pt(Q);
  ...
  function W(y, _, k) {
    ...
    if (Z.version !== K.__version || Y === !0) {
      ...
      const xt = jt.getPrimaries(jt.workingColorSpace),
        rt = _.colorSpace === zn ? null : jt.getPrimaries(_.colorSpace),
        ct =
          _.colorSpace === zn || xt === rt ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, _.flipY),
        n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL, _.premultiplyAlpha),
        n.pixelStorei(n.UNPACK_ALIGNMENT, _.unpackAlignment),
...
function zv(n, t) {
  function e(i, r = zn) {
    ...
    if (i === Cn) return n.UNSIGNED_BYTE;
    if (i === wa) return n.UNSIGNED_SHORT_4_4_4_4;
    if (i === Ea) return n.UNSIGNED_SHORT_5_5_5_1;
    if (i === th) return n.UNSIGNED_INT_5_9_9_9_REV;
    if (i === Jc) return n.BYTE;
    if (i === Qc) return n.SHORT;
    if (i === br) return n.UNSIGNED_SHORT;
    if (i === Ma) return n.INT;
    if (i === hi) return n.UNSIGNED_INT;
    if (i === wn) return n.FLOAT;
    if (i === Pr) return n.HALF_FLOAT;
    if (i === eh) return n.ALPHA;
    if (i === nh) return n.RGB;
    if (i === nn) return n.RGBA;
    if (i === ih) return n.LUMINANCE;
    if (i === rh) return n.LUMINANCE_ALPHA;
    if (i === Gi) return n.DEPTH_COMPONENT;
    if (i === $i) return n.DEPTH_STENCIL;
    if (i === sh) return n.RED;
    if (i === ya) return n.RED_INTEGER;
    if (i === oh) return n.RG;
    if (i === Sa) return n.RG_INTEGER;
    if (i === Ca) return n.RGBA_INTEGER;
    ...
    if (i === ko || i === Vo || i === zo || i === Ho)
      if (((s = t.get('WEBGL_compressed_texture_pvrtc')), s !== null)) {
        if (i === ko) return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (i === Vo) return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (i === zo) return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (i === Ho) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (i === Go || i === Wo || i === Xo)
    ...
    if (i === Ms || i === oa || i === aa)
      if (((s = t.get('EXT_texture_compression_bptc')), s !== null)) {
        ...
        if (i === aa) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (i === ah || i === la || i === ca || i === ha)
      if (((s = t.get('EXT_texture_compression_rgtc')), s !== null)) {
        ...
        if (i === ha) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
...
class jv {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Te(new Ir(20, 20), i);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(t, e) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (W) {
        let J = M[W];
        return (
          J === void 0 && ((J = new Mo()), (M[W] = J)), J.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (W) {
        let J = M[W];
        return J === void 0 && ((J = new Mo()), (M[W] = J)), J.getGripSpace();
      }),
      (this.getHand = function (W) {
        let J = M[W];
        return J === void 0 && ((J = new Mo()), (M[W] = J)), J.getHandSpace();
      });
    function B(W) {
    ...
    function G() {
      ...
      for (let W = 0; W < M.length; W++) {
        const J = E[W];
        J !== null && ((E[W] = null), M[W].disconnect(J));
      }
      (P = null),
        (V = null),
        b.reset(),
    ...
    function j(W) {
      for (let J = 0; J < W.removed.length; J++) {
        const ft = W.removed[J],
          lt = E.indexOf(ft);
        lt >= 0 && ((E[lt] = null), M[lt].disconnect(ft));
      }
    ...
    function ht(W, J, ft) {
      ft === null
        ...
        W.isPerspectiveCamera &&
          ((W.fov = ua * 2 * Math.atan(1 / W.projectionMatrix.elements[5])),
          (W.zoom = 1));
    }
  ...
  function s(f, u) {
    ...
    M &&
      ...
      M.isCubeTexture &&
        ...
        ((ni.y *= -1), (ni.z *= -1)),
      f.envMapRotation.value.setFromMatrix4(Yv.makeRotationFromEuler(ni)),
      (f.flipEnvMap.value =
    ...
    (f.ior.value = u.ior),
      ...
      u.clearcoat > 0 &&
        ...
        u.clearcoatNormalMap &&
          ...
          u.side === Ne && f.clearcoatNormalScale.value.negate())),
...
function $v(n, t, e, i) {
  ...
  function h(S) {
    ...
    return (
      ...
      n.bindBufferBase(n.UNIFORM_BUFFER, M, E),
      E
    );
  }
  function d() {
  ...
  function v(S) {
    ...
    for (let C = 0, U = M.length; C < U; C++) {
      const w = Array.isArray(M[C]) ? M[C] : [M[C]];
  ...
  function f(S) {
    ...
    const E = o.indexOf(M.__bindingPointIndex);
    o.splice(E, 1), n.deleteBuffer(r[M.id]), delete r[M.id], delete s[M.id];
  }
  function u() {
...
class Zv {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in e &&
          e.setAttribute('data-engine', `three.js r${ba}`),
    ...
    function R() {
      (Yt = new i_(A)),
        ...
        (Ft = new a_(A, $t, Pt)),
        (Rt = new Zm(Ct)),
        (K = new Ev(M, y, _, Yt, $t, Ut, Rt)),
        (xt = new Kv(M, Ct)),
        (rt = new Cv()),
        (ct = new Dv(Yt)),
        (at = new qm(M, y, _, gt, Z, p, l)),
        (Q = new Fv(M, Z, $t)),
        (ne = new $v(A, he, $t, gt)),
        (St = new Km(A, Yt, he)),
        (ut = new s_(A, Yt, he)),
    ...
    (this.xr = tt),
      ...
      (this.dispose = function () {
        e.removeEventListener('webglcontextlost', X, !1),
          ...
          K.dispose(),
          tt.dispose(),
          tt.removeEventListener('sessionstart', rn),
          tt.removeEventListener('sessionend', fl),
          $n.stop();
      });
    function X(g) {
      g.preventDefault(),
    ...
    this.renderBufferDirect = function (g, L, O, F, I, et) {
      ...
      let ke,
        Wt = St;
      if (
        (pt !== null && ((ke = k.get(pt)), (Wt = ut), Wt.setIndex(ke)),
        I.isMesh)
      )
        F.wireframe === !0
          ? (gt.setLineWidth(F.wireframeLinewidth * re()), Wt.setMode(A.LINES))
          : Wt.setMode(A.TRIANGLES);
      else if (I.isLine) {
        let vt = F.linewidth;
        vt === void 0 && (vt = 1),
          ...
          I.isLineSegments
            ? Wt.setMode(A.LINES)
            : I.isLineLoop
            ? Wt.setMode(A.LINE_LOOP)
            : Wt.setMode(A.LINE_STRIP);
      } else
        I.isPoints
          ? Wt.setMode(A.POINTS)
          : I.isSprite && Wt.setMode(A.TRIANGLES);
      if (I.isBatchedMesh)
        if (I._multiDrawInstances !== null)
          ...
          const vt = I._multiDrawStarts,
            Me = I._multiDrawCounts,
            Xt = I._multiDrawCount,
            Ze = pt ? k.get(pt).bytesPerElement : 1,
            xi = Ct.get(F).currentProgram.getUniforms();
          for (let Ve = 0; Ve < Xt; Ve++)
            xi.setValue(A, '_gl_DrawID', Ve), Wt.render(vt[Ve] / Ze, Me[Ve]);
        }
      else if (I.isInstancedMesh) Wt.renderInstances(Gt, oe, I.count);
      else if (O.isInstancedBufferGeometry) {
        const vt = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0,
          Me = Math.min(O.instanceCount, vt);
        Wt.renderInstances(Gt, oe, Me);
      } else Wt.render(Gt, oe);
    };
    function be(g, L, O) {
      g.transparent === !0 && g.side === Mn && g.forceSinglePass === !1
        ? ((g.side = Ne),
          (g.needsUpdate = !0),
          jr(g, L, O),
          (g.side = jn),
    ...
    const $n = new wh();
    $n.setAnimationLoop(pn),
      typeof self < 'u' && $n.setContext(self),
      (this.setAnimationLoop = function (g) {
        (Ht = g), tt.setAnimationLoop(g), g === null ? $n.stop() : $n.start();
      }),
      tt.addEventListener('sessionstart', rn),
      tt.addEventListener('sessionend', fl),
      (this.render = function (g, L) {
        ...
        if (
          ...
          tt.enabled === !0 &&
            ...
            (L = tt.getCamera())),
          g.isScene === !0 && g.onBeforeRender(M, g, L, C),
          (f = ct.get(g, S.length)),
          f.init(L),
          S.push(f),
          ...
          et !== null && Ws(et, L, -1 / 0, M.sortObjects);
        }
        Ws(g, L, 0, M.sortObjects),
          b.finish(),
          M.sortObjects === !0 && b.sort(z, ot),
          (Nt =
            tt.enabled === !1 ||
            tt.isPresenting === !1 ||
        ...
        if ((f.setupLights(), L.isArrayCamera)) {
          ...
          for (let st = 0, dt = et.length; st < dt; st++) {
            const pt = et[st];
            ml(b, g, pt, pt.viewport);
          }
        } else I.length > 0 && _l(F, I, g, L), Nt && at.render(g), ml(b, g, L);
        C !== null &&
          (Pt.updateMultisampleRenderTarget(C), Pt.updateRenderTargetMipmap(C)),
          g.isScene === !0 && g.onAfterRender(M, g, L),
          ...
          S.length > 0
            ? ((f = S[S.length - 1]),
              W === !0 && Rt.setGlobalState(M.clippingPlanes, f.state.camera))
            : (f = null),
          u.pop(),
      ...
      if (g.layers.test(L.layers)) {
        if (g.isGroup) O = g.renderOrder;
          ...
          if (!g.frustumCulled || Kt.intersectsSprite(g)) {
            F && wt.setFromMatrixPosition(g.matrixWorld).applyMatrix4(ft);
            const st = Z.update(g),
              dt = g.material;
            dt.visible && b.push(g, st, dt, O, wt.z, null);
          }
        } else if (
          ...
          if (
            ...
            for (let Mt = 0, Et = pt.length; Mt < Et; Mt++) {
              ...
              Gt && Gt.visible && b.push(g, st, Gt, O, wt.z, _t);
            }
          } else dt.visible && b.push(g, st, dt, O, wt.z, null);
        }
      }
      const et = g.children;
      for (let st = 0, dt = et.length; st < dt; st++) Ws(et[st], L, O, F);
    }
    function ml(g, L, O, F) {
      const I = g.opaque,
        et = g.transmissive,
        st = g.transparent;
      f.setupLightsView(O),
        W === !0 && Rt.setGlobalState(M.clippingPlanes, O),
        F && gt.viewport(x.copy(F)),
        I.length > 0 && Xr(I, L, O),
        et.length > 0 && Xr(et, L, O),
        st.length > 0 && Xr(st, L, O),
    ...
    function _l(g, L, O, F) {
      ...
      f.state.transmissionRenderTarget[F.id] === void 0 &&
        (f.state.transmissionRenderTarget[F.id] = new ui(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        f.setupLightsView(F),
        W === !0 && Rt.setGlobalState(M.clippingPlanes, F),
        Xr(g, O, F),
        ...
        for (let _t = 0, Gt = L.length; _t < Gt; _t++) {
          const se = L[_t],
            ...
            Wt = se.material,
            vt = se.group;
          if (Wt.side === Mn && oe.layers.test(F.layers)) {
            const Me = Wt.side;
            (Wt.side = Ne),
              (Wt.needsUpdate = !0),
              vl(oe, O, F, ke, Wt, vt),
    ...
    function Xr(g, L, O) {
      ...
      for (let I = 0, et = g.length; I < et; I++) {
        const st = g[I],
          dt = st.object,
          pt = st.geometry,
          Mt = F === null ? st.material : F,
          Et = st.group;
        dt.layers.test(O.layers) && vl(dt, L, O, pt, Mt, Et);
      }
    }
    function vl(g, L, O, F, I, et) {
      g.onBeforeRender(M, L, O, F, I, et),
        g.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, g.matrixWorld),
        g.normalMatrix.getNormalMatrix(g.modelViewMatrix),
        I.onBeforeRender(M, L, O, F, g, et),
        I.transparent === !0 && I.side === Mn && I.forceSinglePass === !1
          ? ((I.side = Ne),
            (I.needsUpdate = !0),
            M.renderBufferDirect(O, L, F, I, g, et),
            (I.side = jn),
            (I.needsUpdate = !0),
            M.renderBufferDirect(O, L, F, I, g, et),
            (I.side = Mn))
          : M.renderBufferDirect(O, L, F, I, g, et),
        g.onAfterRender(M, L, O, F, I, et);
    }
    function jr(g, L, O) {
      L.isScene !== !0 && (L = At);
      const F = Ct.get(g),
    ...
    function gl(g) {
      if (g.uniformsList === null) {
        ...
        g.uniformsList = Es.seqWithValue(L.seq, g.uniforms);
      }
    ...
    function ku(g, L, O, F, I) {
      ...
      F.version === vt.__version
        ? ((vt.needsLights && vt.lightsStateVersion !== Me.state.version) ||
          ...
          (Xt = !0)
        : ((Xt = !0), (vt.__version = F.version));
      let Ze = vt.currentProgram;
      Xt === !0 && (Ze = jr(F, L, I));
      let xi = !1,
        Ve = !1,
        Xs = !1;
      const de = Ze.getUniforms(),
        Rn = vt.uniforms;
      if (
        (gt.useProgram(Ze.program) && ((xi = !0), (Ve = !0), (Xs = !0)),
        F.id !== U && ((U = F.id), (Ve = !0)),
        xi || w !== g)
      ) {
        ...
        je !== void 0 &&
          je.setValue(A, lt.setFromMatrixPosition(g.matrixWorld)),
      ...
      if (I.isSkinnedMesh) {
        ...
        je &&
          ...
          de.setValue(A, 'boneTexture', je.boneTexture, Pt));
      }
      I.isBatchedMesh &&
      ...
      if (
        ((js.position !== void 0 ||
          ...
          js.color !== void 0) &&
          Ft.update(I, O, Ze),
        (Ve || vt.receiveShadow !== I.receiveShadow) &&
        ...
        F.isMeshStandardMaterial &&
          F.envMap === null &&
          L.environment !== null &&
          (Rn.envMapIntensity.value = L.environmentIntensity),
        Ve &&
          (de.setValue(A, 'toneMappingExposure', M.toneMappingExposure),
          vt.needsLights && Vu(Rn, Xs),
          et && F.fog === !0 && xt.refreshFogUniforms(Rn, et),
          ...
          Es.upload(A, gl(vt), Rn, Pt)),
        F.isShaderMaterial &&
          F.uniformsNeedUpdate === !0 &&
          (Es.upload(A, gl(vt), Rn, Pt), (F.uniformsNeedUpdate = !1)),
        ...
        const je = F.uniformsGroups;
        for (let qs = 0, Hu = je.length; qs < Hu; qs++) {
          const bl = je[qs];
          ne.update(bl, Ze), ne.bind(bl, Ze);
        }
      }
      return Ze;
    }
    ...
    (this.getActiveCubeFace = function () {
        ...
        if ((g.isWebGLCubeRenderTarget && st !== void 0 && (dt = dt[st]), dt)) {
          ...
          try {
            ...
            L >= 0 &&
              ...
              O >= 0 &&
              O <= g.height - I &&
              A.readPixels(L, O, F, I, Tt.convert(Mt), Tt.convert(Et), et);
          } finally {
          ...
          try {
            ...
            if (L >= 0 && L <= g.width - F && O >= 0 && O <= g.height - I) {
              ...
              A.bindBuffer(A.PIXEL_PACK_BUFFER, _t),
                ...
                A.readPixels(L, O, F, I, Tt.convert(Mt), Tt.convert(Et), 0),
                A.flush();
              const Gt = A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE, 0);
              await Vd(A, Gt, 4);
              try {
                A.bindBuffer(A.PIXEL_PACK_BUFFER, _t),
                  A.getBufferSubData(A.PIXEL_PACK_BUFFER, 0, et);
              } finally {
                A.deleteBuffer(_t), A.deleteSync(Gt);
              }
              return et;
            }
          } finally {
      ...
      (this.copyTextureToTexture = function (g, L, O = null, F = null, I = 0) {
        ...
        O !== null
          ...
          F !== null ? ((Mt = F.x), (Et = F.y)) : ((Mt = 0), (Et = 0));
        ...
        const se = A.getParameter(A.UNPACK_ROW_LENGTH),
          ...
          Me = g.isCompressedTexture ? g.mipmaps[I] : g.image;
        A.pixelStorei(A.UNPACK_ROW_LENGTH, Me.width),
          A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Me.height),
          A.pixelStorei(A.UNPACK_SKIP_PIXELS, dt),
          A.pixelStorei(A.UNPACK_SKIP_ROWS, pt),
          g.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, I, Mt, Et, et, st, _t, Gt, Me.data)
            ...
            : A.texSubImage2D(A.TEXTURE_2D, I, Mt, Et, et, st, _t, Gt, Me),
      ...
      (this.copyTextureToTexture3D = function (
        ...
        O !== null
          ...
          : ((et = oe.width),
            ...
            (Et = 0)),
          F !== null
            ? ((_t = F.x), (Gt = F.y), (se = F.z))
            : ((_t = 0), (Gt = 0), (se = 0));
        const ke = Tt.convert(L.format),
        ...
        A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL, L.flipY),
          A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL, L.premultiplyAlpha),
          A.pixelStorei(A.UNPACK_ALIGNMENT, L.unpackAlignment);
        const Me = A.getParameter(A.UNPACK_ROW_LENGTH),
          Xt = A.getParameter(A.UNPACK_IMAGE_HEIGHT),
          Ze = A.getParameter(A.UNPACK_SKIP_PIXELS),
          xi = A.getParameter(A.UNPACK_SKIP_ROWS),
          Ve = A.getParameter(A.UNPACK_SKIP_IMAGES);
        A.pixelStorei(A.UNPACK_ROW_LENGTH, oe.width),
          ...
          A.pixelStorei(A.UNPACK_SKIP_ROWS, Mt),
          A.pixelStorei(A.UNPACK_SKIP_IMAGES, Et),
          g.isDataTexture || g.isData3DTexture
            ? A.texSubImage3D(vt, I, _t, Gt, se, et, st, dt, ke, Wt, oe.data)
            ...
            : A.texSubImage3D(vt, I, _t, Gt, se, et, st, dt, ke, Wt, oe),
          A.pixelStorei(A.UNPACK_ROW_LENGTH, Me),
          A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Xt),
          A.pixelStorei(A.UNPACK_SKIP_PIXELS, Ze),
...
class Da extends dn {
  constructor(
    ...
    for (let u = 0; u <= i; u++) {
      ...
      for (let N = 0; N <= e; N++) {
        const T = N / e;
        (d.x = -t * Math.cos(r + T * s) * Math.sin(o + M * a)),
          (d.y = t * Math.cos(o + M * a)),
          (d.z = t * Math.sin(r + T * s) * Math.sin(o + M * a)),
          v.push(d.x, d.y, d.z),
          p.copy(d).normalize(),
          b.push(p.x, p.y, p.z),
          f.push(T + E, 1 - M),
...
class ng extends Ua {
  ...
  load(t, e, i, r) {
    ...
    const a = Mr('img');
    function l() {
      h(), vc.add(t, this), e && e(this), s.manager.itemEnd(t);
    }
    function c(d) {
...
class sg extends rg {
  ...
  updateMatrices(t, e = 0) {
    ...
    s !== i.far && ((i.far = s), i.updateProjectionMatrix()),
      dr.setFromMatrixPosition(t.matrixWorld),
      i.position.copy(dr),
      Eo.copy(i.position),
      Eo.add(this._cubeDirections[e]),
      i.up.copy(this._cubeUps[e]),
      i.lookAt(Eo),
      i.updateMatrixWorld(),
      r.makeTranslation(-dr.x, -dr.y, -dr.z),
      bc.multiplyMatrices(i.projectionMatrix, i.matrixWorldInverse),
...
typeof __THREE_DEVTOOLS__ < 'u' &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent('register', { detail: { revision: ba } })
  );
typeof window < 'u' &&
  (window.__THREE__
...
class hg extends lg {
  constructor(t, e = null) {
    super(t, e),
      ...
      (this._quat = new di().setFromUnitVectors(t.up, new D(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new Mc()),
      (this._sphericalDelta = new Mc()),
      (this._scale = 1),
      ...
      (this._onPointerMove = dg.bind(this)),
      (this._onPointerDown = ug.bind(this)),
      (this._onPointerUp = pg.bind(this)),
      (this._onContextMenu = bg.bind(this)),
      (this._onMouseWheel = _g.bind(this)),
      (this._onKeyDown = vg.bind(this)),
      (this._onTouchStart = gg.bind(this)),
      (this._onTouchMove = xg.bind(this)),
      (this._onMouseDown = fg.bind(this)),
      (this._onMouseMove = mg.bind(this)),
      (this._interceptControlDown = Mg.bind(this)),
      (this._interceptControlUp = wg.bind(this)),
  ...
  update(t = null) {
    ...
    isFinite(i) &&
      isFinite(r) &&
      (i < -Math.PI ? (i += Ie) : i > Math.PI && (i -= Ie),
      r < -Math.PI ? (r += Ie) : r > Math.PI && (r -= Ie),
      i <= r
      ...
      o !== null &&
        (this.screenSpacePanning
          ...
          : (ms.origin.copy(this.object.position),
            ...
            Math.abs(this.object.up.dot(ms.direction)) < cg
              ? this.object.lookAt(this.target)
              : (Ec.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                ms.intersectPlane(Ec, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > yo ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > yo ||
      this._lastTargetPosition.distanceToSquared(this.target) > yo
        ? (this.dispatchEvent(wc),
  ...
  _getAutoRotationAngle(t) {
    return t !== null
      ? (Ie / 60) * this.autoRotateSpeed * t
      : (Ie / 60 / 60) * this.autoRotateSpeed;
  }
  _getZoomScale(t) {
  ...
  _handleMouseMoveRotate(t) {
    ...
    this._rotateLeft((Ie * this._rotateDelta.x) / e.clientHeight),
      this._rotateUp((Ie * this._rotateDelta.y) / e.clientHeight),
    ...
    switch (t.code) {
      case this.keys.UP:
        t.ctrlKey || t.metaKey || t.shiftKey
          ? this._rotateUp(
              (Ie * this.rotateSpeed) / this.domElement.clientHeight
            )
...
class ae {
  ...
  constructor(t) {
    var e;
    (this.message =
      (e = yg[t.type](t.context)) !== null && e !== void 0
        ? e
        : 'Unexpected error'),
...
function ee(n, t) {
  ...
  return !e && !i ? new Cg(n) : new Sg(n, t);
}
function Ag(n) {
  return [
    new Tg(n),
...
const Yg = Ba([Gg, Xg, qg]),
  Kg = Ba([Yg, zg]);
function $g(n, t) {
  const e = Kg(n, t);
  return (t += e.length), e === '' ? null : { evaluable: new Lg(e), cursor: t };
}
function Zg(n, t) {
  const e = n.substr(t, 1);
...
function Jg(n, t) {
  var e;
  return (e = $g(n, t)) !== null && e !== void 0 ? e : Zg(n, t);
}
function Lh(n, t) {
  const e = Jg(n, t);
  if (e) return e;
  ...
  const r = Lh(n, t);
  return r
    ? ((t = r.cursor), { cursor: t, evaluable: new Ng(i, r.evaluable) })
    : null;
}
function Qg(n, t, e) {
  e += wr(t, e).length;
...
function t0(n, t) {
  return (e, i) => {
    ...
    for (;;) {
      ...
      const a = n(e, i);
      if (!a) return null;
      (i = a.cursor), (s = new Ig(o.operator, s, a.evaluable));
    }
...
const e0 = [
  ...
  ['^'],
  ['|'],
].reduce((n, t) => t0(n, t), Lh);
function Dh(n, t) {
  return (t += wr(n, t).length), e0(n, t);
}
function n0(n) {
  const t = Dh(n, 0);
...
function r0(n, t) {
  return Jt(n.step) ? Math.max(yc(t), 2) : yc(n.step);
}
function Nh(n) {
  var t;
...
function Fh(n, t) {
  return Jt(n.step) ? null : new Rg(n.step, t);
}
function Bh(n) {
  return !Jt(n.max) && !Jt(n.min)
    ? new Ur({ max: n.max, min: n.min })
    : !Jt(n.max) || !Jt(n.min)
    ? new Pg({ max: n.max, min: n.min })
    : null;
}
function kh(n, t) {
  var e, i, r;
  return {
    formatter: (e = n.format) !== null && e !== void 0 ? e : Fe(r0(n, t)),
    keyScale: (i = n.keyScale) !== null && i !== void 0 ? i : Nh(n),
    pointerScale: (r = n.pointerScale) !== null && r !== void 0 ? r : Oh(n, t),
  };
}
function Vh(n) {
  return {
...
function Va(n) {
  return {
    ...
    textProps: It.fromObject(kh(n.params, n.initialValue)),
  };
}
class vi {
  constructor(t) {
...
function Sc(n) {
  return {
    custom: (t) => xn(t)(n),
    boolean: xn((t) => (typeof t == 'boolean' ? t : void 0))(n),
    number: xn((t) => (typeof t == 'number' ? t : void 0))(n),
    string: xn((t) => (typeof t == 'string' ? t : void 0))(n),
    function: xn((t) => (typeof t == 'function' ? t : void 0))(n),
    constant: (t) => xn((e) => (e === t ? t : void 0))(n),
    raw: xn((t) => t)(n),
    object: (t) =>
      xn((e) => {
        if (d0(e)) return h0(e, t);
      })(n),
    array: (t) =>
      xn((e) => {
        if (Array.isArray(e)) return u0(e, t);
      })(n),
  };
}
const fa = { optional: Sc(!0), required: Sc(!1) };
function ie(n, t) {
  const e = t(fa),
    i = fa.required.object(e)(n);
...
function Vs(n, t) {
  const e = n.createElementNS(ln, 'svg');
  return (e.innerHTML = v0[t]), e;
}
function Hh(n, t, e) {
...
class Xh {
  constructor(t, e) {
    ...
    i.classList.add(pr('l')),
      hn(e.props, 'label', (s) => {
        Jt(s)
          ? this.element.classList.add(pr(void 0, 'nol'))
          : (this.element.classList.remove(pr(void 0, 'nol')),
            g0(i),
            i.appendChild(b0(t, s)));
      }),
      this.element.appendChild(i),
      (this.labelElement = i);
    const r = t.createElement('div');
    r.classList.add(pr('v')),
...
class jh {
  constructor(t, e) {
    (this.props = e.props),
      ...
      (this.view = new Xh(t, { props: e.props, viewProps: this.viewProps })),
  ...
  exportProps() {
    return Xe(null, { label: this.props.get('label') });
  }
}
function M0() {
...
const Cc = kt(''),
  Tc = { veryfirst: 'vfst', first: 'fst', last: 'lst', verylast: 'vlst' };
class zs {
  constructor(t) {
    (this.parent_ = null),
      (this.blade = t.blade),
    ...
    this.blade.value('positions').emitter.on('change', () => {
      M0().forEach((i) => {
        e.classList.remove(Cc(void 0, Tc[i]));
      }),
        this.blade.get('positions').forEach((i) => {
          e.classList.add(Cc(void 0, Tc[i]));
        });
    }),
  ...
  exportState() {
    return Xe(null, Object.assign({}, this.viewProps.exportState()));
  }
}
class fi extends zs {
  constructor(t, e) {
    ...
    super(
      Object.assign(Object.assign({}, e), {
        view: new Xh(t, { props: e.props, viewProps: i }),
        viewProps: i,
      })
    ),
...
class qh extends fi {
  ...
  importState(t) {
    return We(
      t,
      (e) => super.importState(Ac(t)),
      (e) => ({ tag: e.optional.string }),
      (e) => ((this.tag = e.tag), !0)
    );
  }
  exportState() {
    return Xe(() => Ac(super.exportState()), {
      binding: {
...
function T0(n, t) {
  const e = [...C0(n), t];
  return (
    e.length > n.length ? e.splice(0, e.length - n.length) : Yh(e, n.length), e
  );
}
class A0 {
  constructor(t) {
    (this.emitter = new fe()),
      ...
      (this.value_ = ee(S0(t.bufferSize))),
      this.value_.emitter.on('beforechange', this.onValueBeforeChange_),
      this.value_.emitter.on('change', this.onValueChange_),
  ...
  fetch() {
    this.value_.rawValue = T0(this.value_.rawValue, this.binding.read());
  }
  onTick_() {
    this.fetch();
  }
...
class R0 extends qh {
  exportState() {
    return Xe(() => super.exportState(), { binding: { readonly: !0 } });
  }
}
function L0(n) {
  return ci(n) && P0(n.value);
}
class D0 extends vi {
  get label() {
    return this.controller.labelController.props.get('label');
...
class N0 {
  constructor(t, e) {
    (this.emitter = new fe()),
      ...
      (this.view = new U0(t, { props: this.props, viewProps: this.viewProps })),
  ...
  exportProps() {
    return Xe(null, { title: this.props.get('title') });
  }
  onClick_(t) {
...
class Pc extends zs {
  constructor(t, e) {
    const i = new N0(t, { props: e.buttonProps, viewProps: e.viewProps }),
      r = new jh(t, {
        blade: e.blade,
        props: e.labelProps,
        valueController: i,
...
const O0 = Le({
  ...
  api(n) {
    return n.controller instanceof Pc ? new D0(n.controller) : null;
  },
});
function F0(n, t) {
...
class H0 {
  ...
  addBinding(t, e, i) {
    const r = i ?? {},
      ...
      o = this.pool_.createBinding(s, z0(t, e), r),
  ...
  onRackValueChange_(t) {
    const e = t.bladeController,
      ...
      r = zh(e.value) ? e.value.binding : null;
    this.emitter_.emit(
      'change',
...
class Wa extends vi {
  constructor(t, e) {
    super(t), (this.rackApi_ = new H0(t.rackController, e));
  }
  refresh() {
...
function X0(n) {
  return ma(n) ? n.rackController.rack.bcSet_ : null;
}
class j0 {
  constructor(t) {
    var e, i;
  ...
  onChildValueChange_(t) {
    const e = W0(this.find(ci), t.sender);
...
class ja {
  ...
  onRackAdd_(t) {
    t.root && Hh(this.element, t.bladeController.view.element, t.index);
  }
  onRackRemove_(t) {
...
function ir() {
  return new It({ positions: ee([], { equals: Eg }) });
}
class Or extends It {
  constructor(t) {
    super(t);
  ...
  bindExpandedClass(t, e) {
    ...
    hn(this, 'expanded', i), hn(this, 'temporaryExpanded', i);
  }
  cleanUpTransition() {
  ...
  constructor(t, e) {
    super(t, e),
      ...
      this.controller.foldable.value('expanded').emitter.on('change', (i) => {
        this.emitter_.emit('fold', new s0(this, i.sender.rawValue));
      }),
...
class Y0 {
  constructor(t, e) {
    ...
    (this.className_ = kt(
      ...
      (this.element = t.createElement('div')),
      this.element.classList.add(this.className_(), Zh()),
      e.viewProps.bindClassModifiers(this.element),
...
const K0 = Le({
    ...
    api(n) {
      return n.controller instanceof _a ? new $h(n.controller, n.pool) : null;
    },
  }),
  $0 = kt('');
function Lc(n, t) {
  return er(n, $0(void 0, t));
}
class Pn extends It {
  constructor(t) {
    var e;
    super(t),
      ...
      ([this.globalDisabled_, this.setGlobalDisabled_] = Ag(
  ...
  bindClassModifiers(t) {
    Sn(this.globalDisabled_, Lc(t, 'disabled')),
      hn(this, 'hidden', Lc(t, 'hidden'));
  }
  bindDisabled(t) {
    Sn(this.globalDisabled_, (e) => {
      t.disabled = e;
    });
  }
  bindTabIndex(t) {
...
class J0 {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      hn(e.props, 'selected', (s) => {
        s
          ? this.element.classList.add(fr(void 0, 'sel'))
          : this.element.classList.remove(fr(void 0, 'sel'));
      });
    const i = t.createElement('button');
    i.classList.add(fr('b')),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
      (this.buttonElement = i);
    const r = t.createElement('div');
    r.classList.add(fr('t')),
      Ga(e.props.value('title'), r),
      this.buttonElement.appendChild(r),
      (this.titleElement = r);
  }
...
class Q0 {
  constructor(t, e) {
    (this.emitter = new fe()),
      ...
      (this.props = e.props),
      (this.viewProps = e.viewProps),
      (this.view = new J0(t, { props: e.props, viewProps: e.viewProps })),
      this.view.buttonElement.addEventListener('click', this.onClick_);
  }
  onClick_() {
...
class va extends Xa {
  constructor(t, e) {
    const i = new Z0(t, { viewProps: e.viewProps });
    super(
      Object.assign(Object.assign({}, e), {
        rackController: new ja({
          blade: e.blade,
      ...
      (this.ic_ = new Q0(t, { props: e.itemProps, viewProps: Pn.create() })),
      this.ic_.emitter.on('click', this.onItemClick_),
      (this.props = e.props),
      hn(this.props, 'selected', (r) => {
...
class tx extends Wa {
  ...
  onSelect_(t) {
    this.emitter_.emit('select', new o0(this, t.rawValue));
  }
}
class ex extends Wa {
  get title() {
...
class nx {
  ...
  keepSelection_() {
    if (this.items_.length === 0) {
      (this.selectedIndex.rawValue = Ic), (this.empty.rawValue = !0);
      return;
    }
...
class ix {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      this.element.classList.add(mr(), Zh()),
      e.viewProps.bindClassModifiers(this.element),
      Sn(e.empty, er(this.element, mr(void 0, 'nop')));
    const i = t.createElement('div');
    i.classList.add(mr('t')),
      this.element.appendChild(i),
      (this.itemsElement = i);
    const r = t.createElement('div');
    r.classList.add(mr('i')), this.element.appendChild(r);
    const s = t.createElement('div');
    s.classList.add(mr('c')),
...
class Uc extends Xa {
  constructor(t, e) {
    const i = new nx(),
      r = new ix(t, { empty: i.empty, viewProps: e.viewProps });
    super({
      blade: e.blade,
      rackController: new ja({
        blade: e.blade,
  ...
  onRackAdd_(t) {
    if (!t.root) return;
    const e = t.bladeController;
    Hh(this.view.itemsElement, e.itemController.view.element, t.index),
...
const Jh = Le({
  ...
  controller(n) {
    const t = new Uc(n.document, { blade: n.blade, viewProps: n.viewProps });
    return (
      n.params.pages.forEach((e) => {
        const i = new va(n.document, {
          blade: ir(),
  ...
  api(n) {
    return n.controller instanceof Uc
      ? new tx(n.controller, n.pool)
      : n.controller instanceof va
      ? new ex(n.controller, n.pool)
      : null;
  },
});
function rx(n, t) {
...
class ax {
  constructor(t, e) {
    ...
    i.classList.add(Co('s')),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
      (this.selectElement = i);
    const r = t.createElement('div');
    r.classList.add(Co('m')),
      r.appendChild(Vs(t, 'dropdown')),
      this.element.appendChild(r),
      e.value.emitter.on('change', this.onValueChange_),
      (this.value_ = e.value),
      hn(this.props_, 'options', (s) => {
        Gh(this.selectElement),
          s.forEach((o) => {
...
class Yn {
  ...
  exportProps() {
    return Xe(null, { options: this.props.get('options') });
  }
}
const Nc = kt('pop');
class lx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      Sn(e.shows, er(this.element, Nc(void 0, 'v')));
  }
}
class Qh {
  constructor(t, e) {
    (this.shows = ee(!1)),
      (this.viewProps = e.viewProps),
      (this.view = new lx(t, { shows: this.shows, viewProps: this.viewProps }));
  }
}
const Oc = kt('txt');
class cx {
...
function nu(n) {
  return px(n) || n === 'ArrowLeft' || n === 'ArrowRight';
}
function To(n, t) {
  var e, i;
  ...
  onMouseDown_(t) {
    ...
    i.addEventListener('mousemove', this.onDocumentMouseMove_),
      ...
      this.emitter.emit('down', {
        altKey: t.altKey,
        data: this.computePosition_(To(t, this.elem_)),
        sender: this,
        shiftKey: t.shiftKey,
      });
  }
...
class fx {
  constructor(t, e) {
    (this.onChange_ = this.onChange_.bind(this)),
      ...
      e.arrayPosition &&
        this.element.classList.add(Ye(void 0, e.arrayPosition)),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('input');
    ...
    r.classList.add(Ye('k')),
      this.element.appendChild(r),
      (this.knobElement = r);
    const s = t.createElementNS(ln, 'svg');
    s.classList.add(Ye('g')), this.knobElement.appendChild(s);
    const o = t.createElementNS(ln, 'path');
    o.classList.add(Ye('gb')), s.appendChild(o), (this.guideBodyElem_ = o);
    const a = t.createElementNS(ln, 'path');
    a.classList.add(Ye('gh')), s.appendChild(a), (this.guideHeadElem_ = a);
    const l = t.createElement('div');
...
class Vr {
  ...
  onInputKeyDown_(t) {
    const e = Ue(this.props.get('keyScale'), Cr(t));
    e !== 0 &&
  ...
  onInputKeyUp_(t) {
    Ue(this.props.get('keyScale'), Cr(t)) !== 0 &&
...
class mx {
  constructor(t, e) {
    (this.onChange_ = this.onChange_.bind(this)),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Ao('t')),
      e.viewProps.bindTabIndex(i),
      this.element.appendChild(i),
      (this.trackElement = i);
    const r = t.createElement('div');
    r.classList.add(Ao('k')),
...
class _x {
  ...
  onKeyDown_(t) {
    const e = Ue(this.props.get('keyScale'), An(t));
    e !== 0 &&
  ...
  onKeyUp_(t) {
    Ue(this.props.get('keyScale'), An(t)) !== 0 &&
      this.value.setRawValue(this.value.rawValue, { forceEmit: !0, last: !0 });
  }
}
const Po = kt('sldtxt');
class vx {
  constructor(t, e) {
    (this.element = t.createElement('div')), this.element.classList.add(Po());
    const i = t.createElement('div');
...
class Ns {
  ...
  exportProps() {
    ...
    return Xe(null, { max: t.get('max'), min: t.get('min') });
  }
}
function iu(n) {
  return {
...
const gx = { containerUnitSize: 'cnt-usz' };
function ru(n) {
  return `--${gx[n]}`;
}
function Tr(n) {
...
class Mx {
  constructor(t, e) {
    (this.onInputChange_ = this.onInputChange_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new bx(t, { value: this.value, viewProps: this.viewProps })),
      this.view.inputElement.addEventListener('change', this.onInputChange_),
...
const Ex = Le({
    ...
    controller: (n) => {
      ...
      return r
        ...
        : new Mx(t, { value: e, viewProps: n.viewProps });
    },
    api(n) {
      return typeof n.controller.value.rawValue != 'boolean'
        ? null
        : n.controller.valueController instanceof Yn
        ? new Ya(n.controller)
        : null;
    },
  }),
...
class yx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.foldable.bindExpandedClass(this.element, ii(void 0, 'expanded')),
      hn(e.foldable, 'completed', er(this.element, ii(void 0, 'cpl')));
    const i = t.createElement('div');
    i.classList.add(ii('h')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(ii('s')), i.appendChild(r), (this.swatchElement = r);
    const s = t.createElement('div');
    if (
      (s.classList.add(ii('t')),
      i.appendChild(s),
      (this.textElement = s),
      e.pickerLayout === 'inline')
    ) {
      const o = t.createElement('div');
      o.classList.add(ii('p')),
...
const Rx = {
  hsl: { hsl: (n, t, e) => [n, t, e], hsv: Ax, rgb: Cx },
  hsv: { hsl: Px, hsv: (n, t, e) => [n, t, e], rgb: ou },
  rgb: { hsl: Sx, hsv: Tx, rgb: (n, t, e) => [n, t, e] },
};
function Ji(n, t) {
  return [
...
function lu(n, t, e) {
  const i = Bc(n, t.mode, t.type, 'int'),
    r = Rx[t.mode][e.mode](...i);
  return Bc(r, e.mode, 'int', e.type);
}
class Vt {
  static black() {
  ...
  constructor(t, e) {
    (this.type = 'int'), (this.mode = e), (this.comps_ = au(t, e, this.type));
  }
  getComponents(t) {
    return Hs(
      lu(
...
function Za(n) {
  return ie(n, (t) => ({
    color: t.optional.object({
      ...
      type: t.optional.custom(Ix),
    }),
    expanded: t.optional.boolean,
    picker: t.optional.custom(su),
...
class Ja {
  constructor(t, e) {
    (this.type = 'float'), (this.mode = e), (this.comps_ = au(t, e, this.type));
  }
  getComponents(t) {
    return Hs(
      lu(
...
const Ux = { int: (n, t) => new Vt(n, t), float: (n, t) => new Ja(n, t) };
function Qa(n, t, e) {
  return Ux[e](n, t);
}
function Nx(n) {
...
function Re(n, t) {
  ...
  if (Ox(n) && t === 'float') return Bx(n);
  if (Nx(n) && t === 'int') return Fx(n);
...
function pu(n) {
  ...
  if (!t) return null;
  const e = [hu(t[1]), $e(t[2], 100), $e(t[3], 100)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) ? null : e;
}
function Gx(n) {
  const t = pu(n);
...
function fu(n) {
  ...
  if (!t) return null;
  const e = [hu(t[1]), $e(t[2], 100), $e(t[3], 100), $e(t[4], 1)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) || isNaN(e[3]) ? null : e;
}
function Wx(n) {
  const t = fu(n);
...
const Kx = [
  { parser: mu, result: { alpha: !1, mode: 'rgb', notation: 'hex' } },
  { parser: _u, result: { alpha: !0, mode: 'rgb', notation: 'hex' } },
  { parser: uu, result: { alpha: !1, mode: 'rgb', notation: 'func' } },
  { parser: du, result: { alpha: !0, mode: 'rgb', notation: 'func' } },
  { parser: pu, result: { alpha: !1, mode: 'hsl', notation: 'func' } },
  { parser: fu, result: { alpha: !0, mode: 'hsl', notation: 'func' } },
  { parser: vu, result: { alpha: !1, mode: 'rgb', notation: 'object' } },
  { parser: gu, result: { alpha: !0, mode: 'rgb', notation: 'object' } },
];
function $x(n) {
  return Kx.reduce(
...
function Hr(n) {
  const t = [Xx, jx, zx, Hx, Gx, Wx];
  t.push(qx('int'), Yx('int'));
  const e = ux(t);
  return (i) => {
    const r = e(i);
...
function tl(n, t = '#') {
  const e = un(n.getComponents('rgb')).map(xu).join('');
  return `${t}${e}`;
}
function el(n, t = '#') {
  const e = n.getComponents('rgb'),
    i = [e[0], e[1], e[2], e[3] * 255].map(xu).join('');
  return `${t}${i}`;
}
function bu(n) {
  const t = Fe(0),
    e = Re(n, 'int');
  return `rgb(${un(e.getComponents('rgb'))
    .map((r) => t(r))
    .join(', ')})`;
}
function ys(n) {
...
function Qx(n) {
  const t = [Fe(0), Us, Us],
    e = Re(n, 'int');
  return `hsl(${un(e.getComponents('hsl'))
    .map((r, s) => t[s](r))
    .join(', ')})`;
}
function tb(n) {
  const t = [Fe(0), Us, Us, Fe(2)];
  return `hsla(${Re(n, 'int')
    .getComponents('hsl')
    .map((r, s) => t[s](r))
    .join(', ')})`;
}
function Mu(n, t) {
  const e = Fe(t === 'float' ? 2 : 0),
    i = ['r', 'g', 'b'],
    r = Re(n, t);
  return `{${un(r.getComponents('rgb'))
    .map((o, a) => `${i[a]}: ${e(o)}`)
    .join(', ')}}`;
}
function eb(n) {
...
function Eu(n) {
  return ib.reduce(
    (t, e) => t || (kx(e.format, n) ? e.stringifier : null),
    null
  );
}
const _r = kt('apl');
class rb {
  constructor(t, e) {
    ...
    const i = t.createElement('div');
    i.classList.add(_r('b')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(_r('c')), i.appendChild(r), (this.colorElem_ = r);
    const s = t.createElement('div');
    s.classList.add(_r('m')),
      this.element.appendChild(s),
      (this.markerElem_ = s);
    const o = t.createElement('div');
  ...
  update_() {
    const t = this.value.rawValue,
      ...
      s = ['to right', ys(i), ys(r)];
    (this.colorElem_.style.background = `linear-gradient(${s.join(',')})`),
      (this.previewElem_.style.backgroundColor = ys(t));
...
class sb {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new rb(t, { value: this.value, viewProps: this.viewProps })),
...
function hb(n, t, e) {
  return new Vr(n, {
    ...
    parser: t.parser,
    props: It.fromObject({
      formatter: lb(t.colorType),
      keyScale: mi(!1),
      pointerScale: t.colorType === 'float' ? 0.01 : 1,
    }),
    value: ee(0, { constraint: cb(t.colorMode, t.colorType, e) }),
    viewProps: t.viewProps,
  });
}
function ub(n, t) {
    ...
    return (
      rr({
        ...
        backward(s, o) {
          ...
          c[i] = o;
          const h = Qa(Hs(un(c), c[3]), a, t.colorType);
          return Re(h, 'int');
        },
      }),
      r
...
function db(n, t) {
  ...
  return (
    rr({
      primary: t.value,
      secondary: e.value,
      forward: (i) => new Vt(un(i.getComponents()), i.mode),
      backward: (i, r) =>
        new Vt(Hs(un(r.getComponents(i.mode)), i.getComponents()[3]), i.mode),
    }),
    [e]
  );
}
...
class fb {
  ...
  createComponentControllers_(t) {
    ...
    return pb(e)
      ...
      : db(t, { value: this.value, viewProps: this.viewProps });
  }
...
class mb {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      e.viewProps.bindTabIndex(this.element);
    const i = t.createElement('div');
    i.classList.add(Ro('c')), this.element.appendChild(i);
    const r = t.createElement('div');
  ...
  update_() {
    ...
    this.markerElem_.style.backgroundColor = bu(new Vt([e, 100, 100], 'hsv'));
...
class _b {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new mb(t, { value: this.value, viewProps: this.viewProps })),
      (this.ptHandler_ = new gi(this.view.element)),
      this.ptHandler_.emitter.on('down', this.onPointerDown_),
      this.ptHandler_.emitter.on('move', this.onPointerMove_),
      this.ptHandler_.emitter.on('up', this.onPointerUp_),
...
class vb {
  constructor(t, e) {
    ...
    (i.height = kc),
      (i.width = kc),
      i.classList.add(Lo('c')),
      this.element.appendChild(i),
      (this.canvasElement = i);
    const r = t.createElement('div');
    r.classList.add(Lo('m')),
      this.element.appendChild(r),
      (this.markerElem_ = r),
      this.update_();
  }
  update_() {
    const t = _0(this.canvasElement);
    if (!t) return;
...
class xb {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.hPaletteC_ = new _b(t, {
        value: this.value,
        viewProps: this.viewProps,
      })),
      (this.svPaletteC_ = new gb(t, {
        value: this.value,
        viewProps: this.viewProps,
      })),
...
class bb {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      (this.value = e.value),
      (this.element = t.createElement('div')),
      this.element.classList.add(Do()),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Do('sw')),
      this.element.appendChild(i),
      (this.swatchElem_ = i);
    const r = t.createElement('button');
    r.classList.add(Do('b')),
      e.viewProps.bindDisabled(r),
      this.element.appendChild(r),
      (this.buttonElement = r),
      this.update_();
...
class Mb {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new bb(t, { value: this.value, viewProps: this.viewProps }));
  }
}
class nl {
  constructor(t, e) {
    ...
    i.addEventListener('blur', this.onButtonBlur_),
      ...
      (this.popC_ =
        e.pickerLayout === 'popup'
          ? new Qh(t, { viewProps: this.viewProps })
          : null);
    const r = new xb(t, {
      colorType: e.colorType,
      supportsAlpha: e.supportsAlpha,
...
function wb(n) {
  return un(n.getComponents('rgb')).reduce(
...
function Cb(n) {
  return typeof n != 'number' ? Vt.black() : yb(n);
}
function Tb(n) {
  return typeof n != 'number' ? Vt.black() : Sb(n);
}
function Ss(n, t) {
  return typeof n != 'object' || Jt(n) ? !1 : t in n && typeof n[t] == 'number';
}
function yu(n) {
  return Ss(n, 'r') && Ss(n, 'g') && Ss(n, 'b');
}
function Su(n) {
  return yu(n) && Ss(n, 'a');
}
...
const Ob = Le({
  ...
  type: 'input',
  accept: (n, t) => {
    if (typeof n != 'number' || !Nb(t)) return null;
    const e = Za(t);
    return e
      ? {
          initialValue: n,
          params: Object.assign(Object.assign({}, e), { supportsAlpha: Ib(t) }),
        }
      : null;
  },
  binding: {
    reader: (n) => (n.params.supportsAlpha ? Tb : Cb),
    equals: il,
    writer: (n) => Pb(n.params.supportsAlpha),
  },
  controller: (n) => {
    var t, e;
    return new nl(n.document, {
      ...
      formatter: Ub(n.params.supportsAlpha),
      parser: Hr('int'),
      pickerLayout:
      ...
      return i
        ? {
            ...
            params: Object.assign(Object.assign({}, i), {
              colorType: (e = cu(t)) !== null && e !== void 0 ? e : 'int',
            }),
          }
        : null;
    },
    binding: {
      reader: (n) => kb(n.params.colorType),
      equals: il,
      writer: (n) => Db(Bb(n.initialValue), n.params.colorType),
    },
    controller: (n) => {
      var t, e;
      const i = Su(n.initialValue);
      return new nl(n.document, {
        colorType: n.params.colorType,
        expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : !1,
        formatter: Vb(i, n.params.colorType),
        parser: Hr('int'),
        pickerLayout:
          (e = n.params.picker) !== null && e !== void 0 ? e : 'popup',
        supportsAlpha: i,
...
class sl {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.acs_ = e.axes.map((i, r) => Wb(t, e, r))),
      ...
      (this.view = new Gb(t, { textViews: this.acs_.map((i) => i.view) }));
  }
  get textControllers() {
    return this.acs_;
  }
...
const qb = Le({
  ...
  accept: (n, t) => {
    ...
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Vh(i)), {
        options: i.optional.custom(kr),
        readonly: i.optional.constant(!1),
      })
    );
  ...
  binding: {
    reader: (n) => Ih,
    constraint: (n) => jb(n.params, n.initialValue),
    writer: (n) => zr,
  },
  controller: (n) => {
    const t = n.value,
      ...
      i = e && Is(e, Br);
    if (i)
      return new Yn(n.document, {
        props: new It({ options: i.values.value('options') }),
        value: t,
        viewProps: n.viewProps,
      });
    const r = kh(n.params, t.rawValue),
      s = e && Is(e, Ur);
    return s
      ? new Ns(
          n.document,
          Object.assign(
            ...
            { parser: Tn, value: t, viewProps: n.viewProps }
          )
        )
      : new Vr(n.document, {
          parser: Tn,
...
class Yb {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      Sn(e.expanded, er(this.element, Bi(void 0, 'expanded')));
    const i = t.createElement('div');
    i.classList.add(Bi('h')), this.element.appendChild(i);
    const r = t.createElement('button');
    r.classList.add(Bi('b')),
      r.appendChild(Vs(t, 'p2dpad')),
      e.viewProps.bindDisabled(r),
      i.appendChild(r),
      (this.buttonElement = r);
    const s = t.createElement('div');
...
class Kb {
  constructor(t, e) {
    (this.onFoldableChange_ = this.onFoldableChange_.bind(this)),
      ...
      e.layout === 'popup' && this.element.classList.add(Bn(void 0, 'p')),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Bn('p')),
      e.viewProps.bindTabIndex(i),
      this.element.appendChild(i),
      (this.padElement = i);
    const r = t.createElementNS(ln, 'svg');
    r.classList.add(Bn('g')),
      this.padElement.appendChild(r),
      (this.svgElem_ = r);
    const s = t.createElementNS(ln, 'line');
    s.classList.add(Bn('ax')),
    ...
    const o = t.createElementNS(ln, 'line');
    o.classList.add(Bn('ax')),
...
function Hc(n, t, e) {
  return [Ue(t[0], An(n)), Ue(t[1], Cr(n)) * (e ? 1 : -1)];
}
class $b {
  constructor(t, e) {
  ...
  handlePointerEvent_(t, e) {
    ...
    this.value.setRawValue(new Xn(r, s), e);
  }
  onPointerDown_(t) {
    this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
  }
  ...
  onPadKeyDown_(t) {
    ...
    (e === 0 && i === 0) ||
      this.value.setRawValue(
        new Xn(this.value.rawValue.x + e, this.value.rawValue.y + i),
        { forceEmit: !1, last: !1 }
      );
  }
  onPadKeyUp_(t) {
...
function Jb(n) {
  return Xn.isObject(n) ? new Xn(n.x, n.y) : new Xn();
}
function Qb(n, t) {
...
function tM(n, t) {
  return new rl({
    assembly: Tu,
    components: [
      yn(Object.assign(Object.assign({}, n), n.x), t.x),
      yn(Object.assign(Object.assign({}, n), n.y), t.y),
    ],
  });
}
function Gc(n, t) {
...
function eM(n, t) {
  var e, i;
  const r = Gc(pi(n, (e = n.x) !== null && e !== void 0 ? e : {}), t.x),
    s = Gc(pi(n, (i = n.y) !== null && i !== void 0 ? i : {}), t.y);
  return Math.max(r, s);
}
function nM(n) {
  if (!('y' in n)) return !1;
...
const iM = Le({
  ...
  type: 'input',
  accept: (n, t) => {
    if (!Xn.isObject(n)) return null;
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Tr(i)), {
        expanded: i.optional.boolean,
        picker: i.optional.custom(su),
        readonly: i.optional.constant(!1),
        x: i.optional.custom(Hn),
        y: i.optional.object(
          Object.assign(Object.assign({}, Tr(i)), {
  ...
  binding: {
    reader: () => Jb,
    constraint: (n) => tM(n.params, n.initialValue),
    equals: Xn.equals,
    writer: () => Qb,
  },
  controller: (n) => {
    ...
    return new Zb(i, {
      ...
      expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : !1,
      invertsY: nM(n.params),
      max: eM(n.params, r.rawValue),
      parser: Tn,
      pickerLayout:
        (e = n.params.picker) !== null && e !== void 0 ? e : 'popup',
      value: r,
...
function oM(n, t) {
  return new rl({
    ...
    components: [
      yn(Object.assign(Object.assign({}, n), n.x), t.x),
      yn(Object.assign(Object.assign({}, n), n.y), t.y),
      yn(Object.assign(Object.assign({}, n), n.z), t.z),
    ],
  });
}
const aM = Le({
  ...
  accept: (n, t) => {
    ...
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Tr(i)), {
        readonly: i.optional.constant(!1),
        x: i.optional.custom(Hn),
        y: i.optional.custom(Hn),
        z: i.optional.custom(Hn),
      })
    );
    return e ? { initialValue: n, params: e } : null;
  },
  binding: {
    reader: (n) => rM,
    constraint: (n) => oM(n.params, n.initialValue),
    equals: Xi.equals,
    writer: (n) => sM,
  },
  controller: (n) => {
...
function hM(n, t) {
  return new rl({
    ...
    components: [
      ...
      yn(Object.assign(Object.assign({}, n), n.y), t.y),
      yn(Object.assign(Object.assign({}, n), n.z), t.z),
      yn(Object.assign(Object.assign({}, n), n.w), t.w),
    ],
  });
}
const uM = Le({
  ...
  binding: {
    reader: (n) => lM,
    constraint: (n) => hM(n.params, n.initialValue),
    equals: ji.equals,
    writer: (n) => cM,
  },
  controller: (n) => {
...
const pM = Le({
    ...
    controller: (n) => {
      ...
      return r
        ...
        : new Sr(t, {
            parser: (s) => s,
            props: It.fromObject({ formatter: ga }),
            value: e,
            viewProps: n.viewProps,
          });
    },
...
class fM {
  constructor(t, e) {
    ...
    i.classList.add(Wc('i')),
      (i.style.height = `calc(var(${ru('containerUnitSize')}) * ${e.rows})`),
      (i.readOnly = !0),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
...
class gM {
  constructor(t, e) {
    ...
    const i = t.createElementNS(ln, 'svg');
    i.classList.add(kn('g')),
      (i.style.height = `calc(var(${ru('containerUnitSize')}) * ${e.rows})`),
      this.element.appendChild(i),
      (this.svgElem_ = i);
    const r = t.createElementNS(ln, 'polyline');
    this.svgElem_.appendChild(r), (this.lineElem_ = r);
    const s = t.createElement('div');
    s.classList.add(kn('t'), kt('tt')()),
      this.element.appendChild(s),
      (this.tooltipElem_ = s),
      e.value.emitter.on('change', this.onValueUpdate_),
      (this.value = e.value),
  ...
  update_() {
    ...
    (a.style.left = `${c}px`),
      ...
      a.classList.contains(kn('t', 'a')) ||
        (a.classList.add(kn('t', 'a'), kn('t', 'in')),
        Ds(a),
        a.classList.remove(kn('t', 'in')));
  }
  onValueUpdate_() {
    this.update_();
  }
...
class Ru {
  ...
  exportProps() {
    return Xe(null, { max: this.props.get('max'), min: this.props.get('min') });
  }
  onGraphMouseLeave_() {
...
function xa(n) {
  return Jt(n.format) ? Fe(2) : n.format;
}
function xM(n) {
  var t;
  return n.value.rawValue.length === 1
    ? new al(n.document, {
        formatter: xa(n.params),
        value: n.value,
        viewProps: n.viewProps,
      })
    : new ol(n.document, {
...
const MM = Le({
    ...
    binding: { defaultBufferSize: (n) => (jc(n) ? 64 : 1), reader: (n) => Ih },
    controller: (n) => (jc(n.params) ? bM(n) : xM(n)),
    api: (n) =>
      n.controller.valueController instanceof Ru ? new vM(n.controller) : null,
  }),
  wM = Le({
    id: 'monitor-string',
    type: 'monitor',
...
function SM(n, t) {
  ...
  const r = {
    ...
    l = new yM({ reader: o, target: t.target, writer: n.binding.writer(r) }),
    c = new l0(
...
function TM(n, t) {
  return t === 0 ? new sx() : new ox(n, t ?? Gr.monitor.defaultInterval);
}
function AM(n, t) {
  var e, i, r;
  ...
  const o = {
    ...
    c =
      (i =
        ...
        : 1,
    h = new A0({
      binding: new CM({ reader: l, target: t.target }),
      bufferSize: c,
      ticker: TM(t.document, a == null ? void 0 : a.interval),
    }),
    d = n.controller({
      document: t.document,
      params: s.params,
...
class PM {
  ...
  register(t, e) {
    if (!xx(e.core)) throw ae.notCompatible(t, e.id);
    e.type === 'blade'
  ...
  createInput_(t, e, i) {
    return this.pluginsMap_.inputs.reduce(
      (r, s) => r ?? SM(s, { document: t, target: e, params: i }),
      null
    );
  }
  createMonitor_(t, e, i) {
    return this.pluginsMap_.monitors.reduce(
      (r, s) => r ?? AM(s, { document: t, params: i, target: e }),
      null
    );
  }
  createBinding(t, e, i) {
  ...
  createBlade(t, e) {
    const i = this.pluginsMap_.blades.reduce(
      (r, s) => r ?? rx(s, { document: t, params: e }),
      null
    );
  ...
  createInputBindingApi_(t) {
    ...
    return this.apiCache_.add(t, e ?? new yr(t));
  }
  ...
  createBindingApi(t) {
    ...
    if (y0(t)) return this.createInputBindingApi_(t);
    if (L0(t)) return this.createMonitorBindingApi_(t);
    throw ae.shouldNeverHappen();
  }
  createApi(t) {
    if (this.apiCache_.has(t)) return this.apiCache_.get(t);
    if (w0(t)) return this.createBindingApi(t);
...
function LM() {
  const n = new PM(RM);
  return (
    [iM, aM, uM, pM, qb, Hb, zb, Ob, Ex, _M, wM, MM, O0, K0, Jh].forEach(
      (t) => {
        n.register('core', t);
      }
    ),
...
const OM = (function () {
  return {
    ...
    controller(n) {
      const t = new Br(Ka(n.params.options)),
...
class kM {
  constructor(t, e) {
    ...
    i.classList.add(qc('r')), this.element.appendChild(i);
  }
}
class Yc extends zs {
  constructor(t, e) {
    super(
      Object.assign(Object.assign({}, e), {
        view: new kM(t, { viewProps: e.viewProps }),
      })
    );
  }
}
const VM = {
    ...
    controller(n) {
      return new Yc(n.document, { blade: n.blade, viewProps: n.viewProps });
    },
    api(n) {
      return n.controller instanceof Yc ? new IM(n.controller) : null;
    },
  },
  zM = {
    id: 'slider',
        ...
        o = new Ns(
          ...
          Object.assign(
            Object.assign(
              ...
              iu({
                formatter:
                  (e = n.params.format) !== null && e !== void 0 ? e : i0,
                keyScale: ee(1),
                max: r.values.value('max'),
                min: r.values.value('min'),
                pointerScale: Oh(n.params, i),
              })
            ),
            { parser: Tn, value: s, viewProps: n.viewProps }
          )
        );
      return new fi(n.document, {
        blade: n.blade,
  ...
  HM = (function () {
    return {
      ...
      api(n) {
        return !(n.controller instanceof fi) ||
          !(n.controller.valueController instanceof Sr)
          ? null
          : new NM(n.controller);
      },
    };
...
class XM extends FM {
  constructor(t) {
    var e, i;
    const r = t ?? {},
      s = (e = r.document) !== null && e !== void 0 ? e : m0(),
      o = LM(),
      a = new BM(s, {
        expanded: r.expanded,
        blade: ir(),
    ...
    super(a, o),
      (this.pool_ = o),
      (this.containerElem_ =
        (i = r.container) !== null && i !== void 0 ? i : GM(s)),
  ...
  registerPlugin(t) {
    t.css && WM(this.document, `plugin-${t.id}`, t.css),
...
const Wr = new Jv(),
  sr = new ig(),
  ll = new Qi(1, 1, 1),
  jM = new Pe(ll.attributes.uv.array, 2);
ll.setAttribute('uv2', jM);
const cl = new Ia(0.5, 0.15, 100, 16),
  qM = new Pe(cl.attributes.uv.array, 2);
cl.setAttribute('uv2', qM);
const hl = new Ir(1, 1),
  YM = new Pe(hl.attributes.uv.array, 2);
hl.setAttribute('uv2', YM);
const ul = new Da(0.5, 32, 32),
  KM = new Pe(ul.attributes.uv.array, 2);
ul.setAttribute('uv2', KM);
...
Be.metalness = 0.1;
Be.normalMap = ew;
Be.displacementMap = QM;
Be.displacementScale = 0.01;
Be.aoMap = JM;
const iw = new Te(ll, Be),
  Lu = new Te(cl, Be);
Lu.position.x = 1.5;
const Du = new Te(hl, Be);
Du.position.x = -1.5;
const Iu = new Te(ul, Be);
Iu.position.y = -1.5;
const Uu = new Te(dl, Be);
Uu.position.y = 1.5;
const pl = new gr();
pl.add(iw, Lu, Du, Iu, Uu);
Wr.add(pl);
const rw = new ag(16777215, 0.5);
Wr.add(rw);
const Nu = new og(16777215, 1.2);
Nu.position.set(5, 5, 5);
Wr.add(Nu);
const Ar = new Ge(35, window.innerWidth / window.innerHeight, 0.1, 200);
Ar.position.z = 10;
const Ou = document.querySelector('canvas.threejs'),
  Gs = new Zv({ canvas: Ou, antialias: !0 });
Gs.setSize(window.innerWidth, window.innerHeight);
Gs.setPixelRatio(Math.min(window.devicePixelRatio, 2));
const Fu = new hg(Ar, Ou);
Fu.enableDamping = !0;
...
Wr.children;
const Bu = () => {
  pl.children.forEach((n) => {
    n instanceof Te && (n.rotation.y += 0.001);
  }),
    Fu.update(),
    Gs.render(Wr, Ar),
    window.requestAnimationFrame(Bu);
};
Bu();
