...
const Dl = new Dt().set(
  ...
  cr = {
    ...
    [ks]: {
      ...
      toReference: (n) => n.applyMatrix3(Il),
      fromReference: (n) => n.applyMatrix3(Dl),
    },
    [Na]: {
      transfer: Qt,
      primaries: Ls,
      luminanceCoefficients: [0.2289, 0.6917, 0.0793],
      toReference: (n) => n.convertSRGBToLinear().applyMatrix3(Il),
      fromReference: (n) => n.applyMatrix3(Dl).convertLinearToSRGB(),
    },
  },
  Wd = new Set([Zn, ks]),
  jt = {
    ...
    convert: function (n, t, e) {
      ...
      const i = cr[t].toReference,
        r = cr[e].fromReference;
      return r(i(n));
    },
    ...
    getPrimaries: function (n) {
      return cr[n].primaries;
    },
    getTransfer: function (n) {
      return n === Gn ? Ps : cr[n].transfer;
    },
    getLuminanceCoefficients: function (n, t = this._workingColorSpace) {
      return n.fromArray(cr[t].luminanceCoefficients);
    },
  };
function qi(n) {
  return n < 0.04045
  ...
  static sRGBToLinear(t) {
    if (
      ...
      const r = i.getImageData(0, 0, t.width, t.height),
        s = r.data;
      for (let o = 0; o < s.length; o++) s[o] = qi(s[o] / 255) * 255;
      return i.putImageData(r, 0, 0), e;
    } else if (t.data) {
      const e = t.data.slice(0);
      for (let i = 0; i < e.length; i++)
        e instanceof Uint8Array || e instanceof Uint8ClampedArray
          ? (e[i] = Math.floor(qi(e[i] / 255) * 255))
          : (e[i] = qi(e[i]));
    ...
    if (r !== null) {
      ...
      if (Array.isArray(r)) {
        ...
        for (let o = 0, a = r.length; o < a; o++)
          r[o].isDataTexture ? s.push(oo(r[o].image)) : s.push(oo(r[o]));
      } else s = oo(r);
      i.url = s;
    }
...
class I {
  ...
  applyEuler(t) {
    return this.applyQuaternion(Ul.setFromEuler(t));
  }
  applyAxisAngle(t, e) {
    return this.applyQuaternion(Ul.setFromAxisAngle(t, e));
  }
  applyMatrix3(t) {
    const e = this.x,
      i = this.y,
...
class Dr {
  ...
  setFromCenterAndSize(t, e) {
    const i = tn.copy(e).multiplyScalar(0.5);
  ...
  intersectsTriangle(t) {
    ...
    this.getCenter(hr),
      Zr.subVectors(this.max, hr),
      yi.subVectors(t.a, hr),
      Ci.subVectors(t.b, hr),
      Ti.subVectors(t.c, hr),
      In.subVectors(Ci, yi),
      Un.subVectors(Ti, Ci),
      ti.subVectors(yi, Ti);
    let e = [
    ...
    return !lo(e, yi, Ci, Ti, Zr) ||
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !lo(e, yi, Ci, Ti, Zr))
      ? !1
      : (Jr.crossVectors(In, Un),
        (e = [Jr.x, Jr.y, Jr.z]),
        lo(e, yi, Ci, Ti, Zr));
  }
  clampPoint(t, e) {
  ...
  applyMatrix4(t) {
    return this.isEmpty()
      ? this
      : (_n[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(t),
...
function lo(n, t, e, i, r) {
  for (let s = 0, o = n.length - 3; s <= o; s += 3) {
    ei.fromArray(n, s);
    const a =
        r.x * Math.abs(ei.x) + r.y * Math.abs(ei.y) + r.z * Math.abs(ei.z),
      l = t.dot(ei),
      c = e.dot(ei),
      h = i.dot(ei);
...
class Oa {
  ...
  setFromPoints(t, e) {
    const i = this.center;
    e !== void 0 ? i.copy(e) : $d.setFromPoints(t).getCenter(i);
    let r = 0;
  ...
  union(t) {
    return t.isEmpty()
      ...
      : (this.center.equals(t.center) === !0
          ...
          : (co.subVectors(t.center, this.center).setLength(t.radius),
            this.expandByPoint(ur.copy(t.center).add(co)),
            this.expandByPoint(ur.copy(t.center).sub(co))),
        this);
  }
  equals(t) {
...
class _h {
  ...
  distanceSqToSegment(t, e, i, r) {
    ho.copy(t).add(e).multiplyScalar(0.5),
      Qr.copy(e).sub(t).normalize(),
      Nn.copy(this.origin).sub(ho);
    ...
    return (
      ...
      r && r.copy(ho).addScaledVector(Qr, p),
      m
    );
  }
  intersectSphere(t, e) {
  ...
  intersectTriangle(t, e, i, r, s) {
    uo.subVectors(e, t), ts.subVectors(i, t), po.crossVectors(uo, ts);
    let o = this.direction.dot(po),
      a;
    if (o > 0) {
      if (r) return null;
      a = 1;
    ...
    if (l < 0) return null;
    const c = a * this.direction.dot(uo.cross(Nn));
...
class le {
  ...
  extractRotation(t) {
    const e = this.elements,
      i = t.elements,
      r = 1 / Ai.setFromMatrixColumn(t, 0).length(),
      s = 1 / Ai.setFromMatrixColumn(t, 1).length(),
      o = 1 / Ai.setFromMatrixColumn(t, 2).length();
    return (
      (e[0] = i[0] * r),
      (e[1] = i[1] * r),
      (e[2] = i[2] * r),
  ...
  lookAt(t, e, i) {
    ...
    return (
      ...
      ke.normalize(),
      On.crossVectors(i, ke),
      On.lengthSq() === 0 &&
        (Math.abs(i.z) === 1 ? (ke.x += 1e-4) : (ke.z += 1e-4),
        ke.normalize(),
        On.crossVectors(i, ke)),
      On.normalize(),
      es.crossVectors(ke, On),
      (r[0] = On.x),
      (r[4] = es.x),
      (r[8] = ke.x),
      (r[1] = On.y),
  ...
  decompose(t, e, i) {
    ...
    const o = Ai.set(r[4], r[5], r[6]).length(),
      a = Ai.set(r[8], r[9], r[10]).length();
  ...
  makePerspective(t, e, i, r, s, o, a = yn) {
    const l = this.elements,
      ...
      p = (i + r) / (i - r);
    let m, g;
    if (a === yn) (m = -(o + s) / (o - s)), (g = (-2 * o * s) / (o - s));
    else if (a === Ds) (m = -o / (o - s)), (g = (-o * s) / (o - s));
    else
      throw new Error(
  ...
  makeOrthographic(t, e, i, r, s, o, a = yn) {
    const l = this.elements,
      ...
      m = (i + r) * h;
    let g, b;
    if (a === yn) (g = (o + s) * d), (b = -2 * d);
    else if (a === Ds) (g = s * d), (b = -1 * d);
    else
      throw new Error(
...
const Ai = new I(),
  ...
  Ol = new mi();
class dn {
  constructor(t = 0, e = 0, i = 0, r = dn.DEFAULT_ORDER) {
    (this.isEuler = !0),
      (this._x = t),
      (this._y = e),
      (this._z = i),
  ...
  setFromQuaternion(t, e, i) {
    return (
      Nl.makeRotationFromQuaternion(t), this.setFromRotationMatrix(Nl, e, i)
    );
  }
...
const Fl = new I(),
  ...
  fo = { type: 'childremoved', child: null };
class Ue extends xi {
  constructor() {
    super(),
      (this.isObject3D = !0),
  ...
  translateOnAxis(t, e) {
    return (
      Fl.copy(t).applyQuaternion(this.quaternion),
      this.position.add(Fl.multiplyScalar(e)),
      this
    );
  }
  translateX(t) {
  ...
  lookAt(t, e, i) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? gn.lookAt(dr, ns, this.up)
        : gn.lookAt(ns, dr, this.up),
      this.quaternion.setFromRotationMatrix(gn),
      r &&
        (gn.extractRotation(r.matrixWorld),
        Pi.setFromRotationMatrix(gn),
  ...
  attach(t) {
    return (
      ...
      t.parent !== null &&
        (t.parent.updateWorldMatrix(!0, !1), gn.multiply(t.parent.matrixWorld)),
      t.applyMatrix4(gn),
      t.removeFromParent(),
      (t.parent = this),
      this.children.push(t),
  ...
  getWorldQuaternion(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(dr, t, tp), t
    );
  }
  getWorldScale(t) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(dr, ep, t), t
    );
  }
  getWorldDirection(t) {
    this.updateWorldMatrix(!0, !1);
...
class cn {
  ...
  static getNormal(t, e, i, r) {
    r.subVectors(i, e), nn.subVectors(t, e), r.cross(nn);
    const s = r.lengthSq();
    return s > 0 ? r.multiplyScalar(1 / Math.sqrt(s)) : r.set(0, 0, 0);
  }
  static getBarycoord(t, e, i, r, s) {
    nn.subVectors(r, e), xn.subVectors(i, e), mo.subVectors(t, e);
    const o = nn.dot(nn),
      a = nn.dot(xn),
      l = nn.dot(mo),
      c = xn.dot(xn),
  ...
  static containsPoint(t, e, i, r) {
    return this.getBarycoord(t, e, i, r, bn) === null
      ? !1
  ...
  static isFrontFacing(t, e, i, r) {
    return nn.subVectors(i, e), xn.subVectors(t, e), nn.cross(xn).dot(r) < 0;
  }
  set(t, e, i) {
  ...
  getInterpolation(t, e, i, r, s) {
    return cn.getInterpolation(t, this.a, this.b, this.c, e, i, r, s);
  }
  containsPoint(t) {
  ...
  closestPointToPoint(t, e) {
    const i = this.a,
      ...
      s = this.c;
    let o, a;
    Li.subVectors(r, i), Di.subVectors(s, i), _o.subVectors(t, i);
    const l = Li.dot(_o),
      c = Di.dot(_o);
    ...
    const p = l * d - h * c;
    if (p <= 0 && l >= 0 && h <= 0)
      return (o = l / (l - h)), e.copy(i).addScaledVector(Li, o);
    go.subVectors(t, s);
    const m = Li.dot(go),
      g = Di.dot(go);
    ...
    const b = m * c - l * g;
    if (b <= 0 && c >= 0 && g <= 0)
      return (a = c / (c - g)), e.copy(i).addScaledVector(Di, a);
    const f = h * g - m * d;
    if (f <= 0 && d - h >= 0 && m - g >= 0)
      return (
        Hl.subVectors(s, r),
        (a = (d - h) / (d - h + (m - g))),
        e.copy(r).addScaledVector(Hl, a)
      );
    const u = 1 / (f + b + p);
    return (
      (o = b * u),
      (a = p * u),
      e.copy(i).addScaledVector(Li, o).addScaledVector(Di, a)
    );
  }
  equals(t) {
...
class zt {
  ...
  setHSL(t, e, i, r = jt.workingColorSpace) {
    if (((t = Vd(t, 1)), (e = Ce(e, 0, 1)), (i = Ce(i, 0, 1)), e === 0))
  ...
  copyLinearToSRGB(t) {
    return (this.r = so(t.r)), (this.g = so(t.g)), (this.b = so(t.b)), this;
  }
  convertSRGBToLinear() {
  ...
  getHex(t = ze) {
    return (
      jt.fromWorkingColorSpace(Se.copy(this), t),
      Math.round(Ce(Se.r * 255, 0, 255)) * 65536 +
        Math.round(Ce(Se.g * 255, 0, 255)) * 256 +
        Math.round(Ce(Se.b * 255, 0, 255))
    );
  }
  getHexString(t = ze) {
  ...
  getHSL(t, e = jt.workingColorSpace) {
    jt.fromWorkingColorSpace(Se.copy(this), e);
    const i = Se.r,
      r = Se.g,
      s = Se.b,
      o = Math.max(i, r, s),
  ...
  offsetHSL(t, e, i) {
    return this.getHSL(Fn), this.setHSL(Fn.h + t, Fn.s + e, Fn.l + i);
  }
  add(t) {
    return (this.r += t.r), (this.g += t.g), (this.b += t.b), this;
  }
  ...
  lerpHSL(t, e) {
    this.getHSL(Fn), t.getHSL(is);
    const i = io(Fn.h, is.h, e),
      r = io(Fn.s, is.s, e),
      s = io(Fn.l, is.l, e);
...
class Ir extends xi {
  constructor() {
    super(),
      (this.isMaterial = !0),
      Object.defineProperty(this, 'id', { value: ip++ }),
      (this.uuid = Lr()),
      (this.name = ''),
      (this.type = 'Material'),
      (this.blending = Xi),
  ...
  toJSON(t) {
    ...
    (i.uuid = this.uuid),
      ...
      this.blendSrc !== zo && (i.blendSrc = this.blendSrc),
      this.blendDst !== Ho && (i.blendDst = this.blendDst),
      this.blendEquation !== li && (i.blendEquation = this.blendEquation),
      ...
      this.depthFunc !== As && (i.depthFunc = this.depthFunc),
      ...
      this.stencilFail !== Ei && (i.stencilFail = this.stencilFail),
      this.stencilZFail !== Ei && (i.stencilZFail = this.stencilZFail),
      this.stencilZPass !== Ei && (i.stencilZPass = this.stencilZPass),
...
class on {
  ...
  setComponent(t, e, i) {
    return (
      this.normalized && (i = Re(i, this.array)),
  ...
  getX(t) {
    ...
    return this.normalized && (e = lr(e, this.array)), e;
  }
  setX(t, e) {
    return (
  ...
  setXY(t, e, i) {
    return (
      (t *= this.itemSize),
      this.normalized && ((e = Re(e, this.array)), (i = Re(i, this.array))),
      (this.array[t + 0] = e),
      (this.array[t + 1] = i),
      this
    );
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== Pl && (t.usage = this.usage),
      t
    );
  }
}
...
class Jn extends xi {
  ...
  translate(t, e, i) {
    return je.makeTranslation(t, e, i), this.applyMatrix4(je), this;
  }
  scale(t, e, i) {
    return je.makeScale(t, e, i), this.applyMatrix4(je), this;
  }
  lookAt(t) {
        ...
        for (let i = 0, r = e.length; i < r; i++) {
          ...
          Ve.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (be.addVectors(this.boundingBox.min, Ve.min),
                this.boundingBox.expandByPoint(be),
                be.addVectors(this.boundingBox.max, Ve.max),
                this.boundingBox.expandByPoint(be))
      ...
      if ((Ve.setFromBufferAttribute(t), e))
        for (let s = 0, o = e.length; s < o; s++) {
          ...
          pr.setFromBufferAttribute(a),
            this.morphTargetsRelative
              ? (be.addVectors(Ve.min, pr.min),
                Ve.expandByPoint(be),
                be.addVectors(Ve.max, pr.max),
                Ve.expandByPoint(be))
              : (Ve.expandByPoint(pr.min), Ve.expandByPoint(pr.max));
        }
      Ve.getCenter(i);
      let r = 0;
      for (let s = 0, o = t.count; s < o; s++)
        be.fromBufferAttribute(t, s),
          (r = Math.max(r, i.distanceToSquared(be)));
      if (e)
        for (let s = 0, o = e.length; s < o; s++) {
          const a = e[s],
            l = this.morphTargetsRelative;
          for (let c = 0, h = a.count; c < h; c++)
            be.fromBufferAttribute(a, c),
              l && (Ii.fromBufferAttribute(t, c), be.add(Ii)),
              (r = Math.max(r, i.distanceToSquared(be)));
        }
...
class Ke extends Ue {
    ...
    if (s && a) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const h = a[l],
          d = s[l];
        h !== 0 &&
          (Mo.fromBufferAttribute(d, t),
          o ? os.addScaledVector(Mo, h) : os.addScaledVector(Mo.sub(e), h));
      }
      e.add(os);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    r !== void 0 &&
      ...
      !(
        ss.containsPoint(ni.origin) === !1 &&
        (ni.intersectSphere(ss, Wl) === null ||
          ni.origin.distanceToSquared(Wl) > (t.far - t.near) ** 2)
      ) &&
        (Gl.copy(s).invert(),
        ni.copy(t.ray).applyMatrix4(Gl),
        !(i.boundingBox !== null && ni.intersectsBox(i.boundingBox) === !1) &&
...
function sp(n, t, e, i, r, s, o, a) {
  let l;
  if (
    (t.side === Ie
      ? (l = i.intersectTriangle(o, s, r, !0, a))
      : (l = i.intersectTriangle(r, s, o, t.side === Yn, a)),
    l === null)
  )
    return null;
  us.copy(a), us.applyMatrix4(n.matrixWorld);
  const c = e.ray.origin.distanceTo(us);
  return c < e.near || c > e.far
    ? null
    : { distance: c, point: us.clone(), object: n };
}
function ds(n, t, e, i, r, s, o, a, l, c) {
  n.getVertexPosition(a, Ui),
    n.getVertexPosition(l, Ni),
    n.getVertexPosition(c, Oi);
  const h = sp(n, t, e, i, Ui, Ni, Oi, hs);
  if (h) {
    r &&
      (as.fromBufferAttribute(r, a),
      ls.fromBufferAttribute(r, l),
      cs.fromBufferAttribute(r, c),
      (h.uv = cn.getInterpolation(hs, Ui, Ni, Oi, as, ls, cs, new yt()))),
      s &&
        (as.fromBufferAttribute(s, a),
        ls.fromBufferAttribute(s, l),
        cs.fromBufferAttribute(s, c),
        (h.uv1 = cn.getInterpolation(hs, Ui, Ni, Oi, as, ls, cs, new yt()))),
      o &&
        (Xl.fromBufferAttribute(o, a),
        jl.fromBufferAttribute(o, l),
        ql.fromBufferAttribute(o, c),
        (h.normal = cn.getInterpolation(hs, Ui, Ni, Oi, Xl, jl, ql, new I())),
        h.normal.dot(i.direction) > 0 && h.normal.multiplyScalar(-1));
    const d = { a, b: l, c, normal: new I(), materialIndex: 0 };
    cn.getNormal(Ui, Ni, Oi, d.normal), (h.face = d);
  }
  return h;
}
class Ur extends Jn {
  constructor(t = 1, e = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    g('z', 'y', 'x', -1, -1, i, e, t, o, s, 0),
      ...
      this.setAttribute('normal', new un(h, 3)),
...
class Kn extends Ir {
  ...
  copy(t) {
    return (
      ...
      (this.uniformsGroups = op(t.uniformsGroups)),
...
class He extends Eh {
  ...
  setFocalLength(t) {
    ...
    (this.fov = xa * 2 * Math.atan(e)), this.updateProjectionMatrix();
  }
  getFocalLength() {
    const t = Math.tan(Ss * 0.5 * this.fov);
    return (0.5 * this.getFilmHeight()) / t;
  }
  getEffectiveFOV() {
    return xa * 2 * Math.atan(Math.tan(Ss * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(t, e) {
    return this.getViewBounds(t, Yl, Kl), e.subVectors(Kl, Yl);
  }
  ...
  updateProjectionMatrix() {
    const t = this.near;
    let e = (t * Math.tan(Ss * 0.5 * this.fov)) / this.zoom,
      i = 2 * e,
      r = this.aspect * i,
      s = -0.5 * r;
    const o = this.view;
...
class hp extends Ue {
  constructor(t, e, i) {
    ...
    const r = new He(Fi, Bi, t, e);
    (r.layers = this.layers), this.add(r);
    const s = new He(Fi, Bi, t, e);
    (s.layers = this.layers), this.add(s);
    const o = new He(Fi, Bi, t, e);
    (o.layers = this.layers), this.add(o);
    const a = new He(Fi, Bi, t, e);
    (a.layers = this.layers), this.add(a);
    const l = new He(Fi, Bi, t, e);
    (l.layers = this.layers), this.add(l);
    const c = new He(Fi, Bi, t, e);
...
class up extends fi {
  constructor(t = 1, e = {}) {
    ...
    (this.texture = new Sh(
      ...
      (this.texture.minFilter = e.minFilter !== void 0 ? e.minFilter : rn);
  }
  fromEquirectangularTexture(t, e) {
    ...
    const o = new Ke(r, s),
      a = e.minFilter;
    return (
      e.minFilter === ui && (e.minFilter = rn),
      new hp(1, 10, this).update(t, o),
      (e.minFilter = a),
      o.geometry.dispose(),
      o.material.dispose(),
      this
...
class Hn {
  ...
  setFromCoplanarPoints(t, e, i) {
    const r = wo.subVectors(i, e).cross(dp.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const i = e || pp.getNormalMatrix(t),
      r = this.coplanarPoint(wo).applyMatrix4(t),
...
class Fa {
  ...
  setFromProjectionMatrix(t, e = yn) {
    ...
    else if (e === Ds) i[5].setComponents(a, d, b, M).normalize();
    else
      throw new Error(
  ...
  intersectsBox(t) {
    ...
    for (let i = 0; i < 6; i++) {
      const r = e[i];
      if (
        ((ps.x = r.normal.x > 0 ? t.max.x : t.min.x),
        (ps.y = r.normal.y > 0 ? t.max.y : t.min.y),
        (ps.z = r.normal.z > 0 ? t.max.z : t.min.z),
        r.distanceToPoint(ps) < 0)
      )
        return !1;
    }
    return !0;
...
class Vs extends Jn {
  constructor(t = 1, e = 1, i = 1, r = 1) {
    ...
    this.setIndex(m),
      this.setAttribute('position', new un(g, 3)),
      this.setAttribute('normal', new un(b, 3)),
...
#endif`,
  Sp = `#ifdef USE_BATCHING
	mat4 batchingMatrix = getBatchingMatrix( getIndirectIndex( gl_DrawID ) );
#endif`,
  yp = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  Cp = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
	vec3 objectTangent = vec3( tangent.xyz );
#endif`,
  Tp = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Bp = `#define PI 3.141592653589793
...
#endif`,
  Vp = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
#endif`,
  Xp = 'gl_FragColor = linearToOutputTexel( gl_FragColor );',
  jp = `
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  uf = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
#endif`,
  _f = `#if defined( RE_IndirectDiffuse )
	#ifdef USE_LIGHTMAP
...
#endif`,
  If = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  Wf = `vec3 packNormalToRGB( const in vec3 normal ) {
...
#endif`,
  jf = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
gl_Position = projectionMatrix * mvPosition;`,
...
#endif`,
  Kf = `float roughnessFactor = roughness;
#ifdef USE_ROUGHNESSMAP
	vec4 texelRoughness = texture2D( roughnessMap, vRoughnessMapUv );
	roughnessFactor *= texelRoughness.g;
#endif`,
  $f = `#ifdef USE_ROUGHNESSMAP
  ...
  Jf = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Qf = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  fm = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Lt = {
    ...
    batching_vertex: Sp,
    begin_vertex: yp,
    beginnormal_vertex: Cp,
    bsdfs: Tp,
    iridescence_fragment: Ap,
    bumpmap_pars_fragment: Pp,
    clipping_planes_fragment: Rp,
    clipping_planes_pars_fragment: Lp,
    clipping_planes_pars_vertex: Dp,
    clipping_planes_vertex: Ip,
    color_fragment: Up,
    color_pars_fragment: Np,
    color_pars_vertex: Op,
    color_vertex: Fp,
    common: Bp,
    ...
    lights_toon_pars_fragment: hf,
    lights_phong_fragment: uf,
    ...
    normal_pars_fragment: Nf,
    normal_pars_vertex: Of,
    normal_vertex: Ff,
  ...
  ln = {
    ...
    depth: {
      uniforms: ye([it.common, it.displacementmap]),
...
function $m(n, t, e, i, r, s, o) {
  ...
  function f(S, M) {
    const y = g(M);
    y && (y.isCubeTexture || y.mapping === Bs)
      ? (h === void 0 &&
          ((h = new Ke(
            new Ur(1, 1, 1),
            new Kn({
              name: 'BackgroundCubeMaterial',
              uniforms: tr(ln.backgroundCube.uniforms),
        ...
        (c === void 0 &&
          ((c = new Ke(
            ...
            new Kn({
              ...
              uniforms: tr(ln.background.uniforms),
  ...
  function u(S, M) {
    S.getRGB(fs, wh(n)), i.buffers.color.setClear(fs.r, fs.g, fs.b, M, o);
  }
  return {
      ...
      if (V.location >= 0) {
        ...
        if (
          ...
          const Kt = Ot.buffer,
            ...
            ft = z === n.INT || z === n.UNSIGNED_INT || ot.gpuType === Pa;
...
function e_(n) {
  let t = new WeakMap();
  function e(o, a) {
    return a === Go ? (o.mapping = $i) : a === Wo && (o.mapping = Zi), o;
  }
  function i(o) {
    if (o && o.isTexture) {
      const a = o.mapping;
...
class Ql {
  ...
  fromScene(t, e = 0, i = 0.1, r = 100) {
    (So = this._renderer.getRenderTarget()),
      (yo = this._renderer.getActiveCubeFace()),
      (Co = this._renderer.getActiveMipmapLevel()),
  ...
  compileCubemapShader() {
    this._cubemapMaterial === null &&
      ((this._cubemapMaterial = nc()),
      this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    this._equirectMaterial === null &&
      ((this._equirectMaterial = ec()),
  ...
  _cleanup(t) {
    this._renderer.setRenderTarget(So, yo, Co),
      (this._renderer.xr.enabled = To),
      (t.scissorTest = !1),
      ms(t, 0, 0, t.width, t.height);
  }
  _fromTexture(t, e) {
    t.mapping === $i || t.mapping === Zi
      ? this._setSize(
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = tc(t, e, i));
  ...
  _sceneToCubeUV(t, e, i, r) {
    const a = new He(90, 1, e, i),
      l = [1, -1, 1, 1, 1, 1],
      c = [1, 1, 1, -1, -1, -1],
      h = this._renderer,
      d = h.autoClear,
      p = h.toneMapping;
    h.getClearColor(Zl), (h.toneMapping = jn), (h.autoClear = !1);
    const m = new xh({
  ...
  _textureToCubeUV(t, e) {
    const i = this._renderer,
      r = t.mapping === $i || t.mapping === Zi;
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = nc()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value =
          t.isRenderTargetTexture === !1 ? -1 : 1))
      : this._equirectMaterial === null && (this._equirectMaterial = ec());
    const s = r ? this._cubemapMaterial : this._equirectMaterial,
      o = new Ke(this._lodPlanes[0], s),
      a = s.uniforms;
    a.envMap.value = t;
    const l = this._cubeSize;
    ms(e, 0, 0, 3 * l, 2 * l), i.setRenderTarget(e), i.render(o, Eo);
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, i, r, s, o, a) {
    ...
    const h = 3,
      d = new Ke(this._lodPlanes[r], c),
      p = c.uniforms,
      m = this._sizeLods[i] - 1,
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * ci - 1),
      b = s / g,
      f = isFinite(s) ? 1 + Math.floor(h * b) : ci;
    f > ci &&
      console.warn(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${f} samples when the maximum is set to ${ci}`
      );
    const u = [];
    let S = 0;
    for (let T = 0; T < ci; ++T) {
    ...
    const y = this._sizeLods[r],
      F = 3 * y * (r > M - Gi ? r - M + Gi : 0),
      A = 4 * (this._cubeSize - y);
    ms(e, F, A, 3 * y, 2 * y), l.setRenderTarget(e), l.render(d, Eo);
  }
}
function i_(n) {
  const t = [],
    ...
    i = [];
  let r = n;
  const s = n - Gi + 1 + $l.length;
  for (let o = 0; o < s; o++) {
    const a = Math.pow(2, r);
    e.push(a);
    let l = 1 / a;
    o > n - Gi ? (l = $l[o - n + Gi - 1]) : o === 0 && (l = 0), i.push(l);
    const c = 1 / (a - 2),
      h = -c,
      d = 1 + c,
...
function tc(n, t, e) {
  const i = new fi(n, t, e);
  return (
    (i.texture.mapping = Bs),
...
function o_(n) {
  ...
  return {
    ...
    get: function (i) {
      ...
      return (
        r === null &&
          Mr('THREE.WebGLRenderer: ' + i + ' extension not supported.'),
        r
      );
    },
  };
...
class Ch extends Te {
  constructor(t, e, i, r, s, o, a, l, c, h = ji) {
    if (h !== ji && h !== Qi)
      throw new Error(
...
function ir(n, t, e) {
  ...
  const r = t * e;
  let s = rc[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (rc[r] = s)), t !== 0)) {
    i.toArray(s, 0);
...
function zs(n, t) {
  let e = sc[t];
  e === void 0 && ((e = new Int32Array(t)), (sc[t] = e));
...
function __(n, t) {
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    lc.set(i), n.uniformMatrix2fv(this.addr, !1, lc), ge(e, i);
  }
}
function v_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    ac.set(i), n.uniformMatrix3fv(this.addr, !1, ac), ge(e, i);
  }
}
function g_(n, t) {
  const e = this.cache,
  ...
  if (i === void 0) {
    ...
    if (ve(e, i)) return;
    oc.set(i), n.uniformMatrix4fv(this.addr, !1, oc), ge(e, i);
  }
}
function x_(n, t) {
  const e = this.cache;
...
function A_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTexture3D(t || Ph, r);
}
function P_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTextureCube(t || Rh, r);
}
function R_(n, t, e) {
  const i = this.cache,
    r = e.allocateTextureUnit();
  i[0] !== r && (n.uniform1i(this.addr, r), (i[0] = r)),
    e.setTexture2DArray(t || Ah, r);
}
function L_(n) {
  switch (n) {
    case 5126:
...
function q_(n, t, e) {
  ...
  for (let o = 0; o !== r; ++o) e.setTexture2D(t[o] || Th, s[o]);
}
function Y_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = zs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture3D(t[o] || Ph, s[o]);
}
function K_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = zs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTextureCube(t[o] || Rh, s[o]);
}
function $_(n, t, e) {
  const i = this.cache,
    r = t.length,
    s = zs(e, r);
  ve(i, s) || (n.uniform1iv(this.addr, s), ge(i, s));
  for (let o = 0; o !== r; ++o) e.setTexture2DArray(t[o] || Ah, s[o]);
}
function Z_(n) {
  switch (n) {
    case 5126:
...
function ev(n, t, e) {
  ...
  for (Ao.lastIndex = 0; ; ) {
    ...
    if ((l && (a = a | 0), c === void 0 || (c === '[' && o + 2 === r))) {
      cc(e, c === void 0 ? new J_(a, n, t) : new Q_(a, n, t));
      break;
    } else {
      let d = e.map[a];
      d === void 0 && ((d = new tv(a)), cc(e, d)), (e = d);
    }
  }
}
class ys {
...
function sv(n) {
  ...
  switch (
    (t === e
      ...
      : t === Rs && e === Ls && (i = 'LinearSRGBToLinearDisplayP3'),
    n)
  ) {
    case Zn:
    case ks:
...
const dv = /^[ \t]*#include +<([\w\d./]+)>/gm;
function ba(n) {
  return n.replace(dv, fv);
}
const pv = new Map();
function fv(n, t) {
  let e = Lt[t];
...
function vv(n) {
  ...
  return (
    n.shadowMapType === Jc
      ...
      : n.shadowMapType === wn && (t = 'SHADOWMAP_TYPE_VSM'),
    t
  );
}
function gv(n) {
...
`)),
      (u = [
        ...
        e.toneMapping !== jn ? Lt.tonemapping_pars_fragment : '',
        e.toneMapping !== jn ? av('toneMapping', e.toneMapping) : '',
...
` +
  ...
  const M = S + f + o,
    y = S + u + a,
    F = hc(r, r.VERTEX_SHADER, M),
    A = hc(r, r.FRAGMENT_SHADER, y);
  r.attachShader(b, F),
    r.attachShader(b, A),
...
` +
    ...
    r.deleteShader(F), r.deleteShader(A), (B = new ys(r, b)), (w = uv(r, b));
  }
  let B;
  ...
  return (
    (this.isReady = function () {
      return x === !1 && (x = r.getProgramParameter(b, nv)), x;
    }),
...
class Sv {
  ...
  _getShaderStage(t) {
    ...
    let i = e.get(t);
    return i === void 0 && ((i = new yv(t)), e.set(t, i)), i;
  }
}
class yv {
  constructor(t) {
    (this.id = Ev++), (this.code = t), (this.usedTimes = 0);
  }
}
function Cv(n, t, e, i, r, s, o) {
  const a = new vh(),
    l = new Sv(),
    c = new Set(),
    h = [],
  ...
  function f(w, x, P, H, k) {
    const Y = H.fog,
      ...
      V = $ && $.mapping === Bs ? $.image.height : null,
      ot = g[w.type];
    w.precision !== null &&
    ...
    const Me = {
      ...
      emissiveMap: Ct,
      normalMapObjectSpace: gt && w.normalMapType === Dd,
      normalMapTangentSpace: gt && w.normalMapType === uh,
      metalnessMap: Pt,
      roughnessMap: E,
      anisotropy: _,
      anisotropyMap: rt,
      ...
      gradientMap: W,
      opaque:
        w.transparent === !1 && w.blending === Xi && w.alphaToCoverage === !1,
      alphaMap: X,
      alphaTest: nt,
      alphaHash: bt,
      combine: w.combine,
  ...
  function F(w, x) {
    ...
    return P === void 0 && ((P = new wv(n, x, w, s)), h.push(P)), P;
  }
  function A(w) {
    if (--w.usedTimes === 0) {
      const x = h.indexOf(w);
...
function vc() {
  ...
  function c(d, p) {
    e.length > 1 && e.sort(d || Av),
      i.length > 1 && i.sort(p || _c),
      r.length > 1 && r.sort(p || _c);
  }
  function h() {
...
function Vv(n, t, e) {
  ...
  this.render = function (A, T, B) {
    ...
    for (let q = 0, G = A.length; q < G; q++) {
      ...
      if (
        ...
        const mt = this.type !== wn ? { minFilter: Ye, magFilter: Ye } : {};
        V.map !== null && V.map.dispose(),
          (V.map = new fi(r.x, r.y, mt)),
      ...
      V.isPointLightShadow !== !0 && this.type === wn && S(V, B),
        (V.needsUpdate = !1);
    }
  ...
  function S(A, T) {
    ...
    p.defines.VSM_SAMPLES !== A.blurSamples &&
      ...
      (p.needsUpdate = !0),
      (m.needsUpdate = !0)),
      A.mapPass === null && (A.mapPass = new fi(r.x, r.y)),
  ...
  function y(A, T, B, w, x) {
    ...
    if (
      ...
      (A.castShadow || (A.receiveShadow && x === wn)) &&
...
function zv(n) {
  function t() {
    ...
    return {
      ...
      setClear: function (nt, bt, Bt, ue, Me) {
        Me === !0 && ((nt *= ue), (bt *= ue), (Bt *= ue)),
          tt.set(nt, bt, Bt, ue),
  ...
  function i() {
    ...
    return {
      ...
      setFunc: function (Ht, mn, an) {
        (W !== Ht || X !== mn || nt !== an) &&
          (n.stencilFunc(Ht, mn, an), (W = Ht), (X = mn), (nt = an));
      },
      setOp: function (Ht, mn, an) {
        (bt !== Ht || Bt !== mn || ue !== an) &&
          (n.stencilOp(Ht, mn, an), (bt = Ht), (Bt = mn), (ue = an));
      },
      setLocked: function (Ht) {
        R = Ht;
      },
      setClear: function (Ht) {
        Me !== Ht && (n.clearStencil(Ht), (Me = Ht));
      },
      reset: function () {
        (R = !1),
          (tt = null),
  ...
  (re[Ju] = n.MIN), (re[Qu] = n.MAX);
  const C = {
    [td]: n.ZERO,
    [ed]: n.ONE,
    [nd]: n.SRC_COLOR,
    [zo]: n.SRC_ALPHA,
    [ld]: n.SRC_ALPHA_SATURATE,
    [od]: n.DST_COLOR,
    [rd]: n.DST_ALPHA,
    [id]: n.ONE_MINUS_SRC_COLOR,
    [Ho]: n.ONE_MINUS_SRC_ALPHA,
    [ad]: n.ONE_MINUS_DST_COLOR,
    [sd]: n.ONE_MINUS_DST_ALPHA,
    [cd]: n.CONSTANT_COLOR,
    [hd]: n.ONE_MINUS_CONSTANT_COLOR,
    [ud]: n.CONSTANT_ALPHA,
    [dd]: n.ONE_MINUS_CONSTANT_ALPHA,
  };
  function ce(R, tt, W, X, nt, bt, Bt, ue, Me, Ht) {
    if (R === Xn) {
      g === !0 && (lt(n.BLEND), (g = !1));
      return;
    }
    if ((g === !1 && (ft(n.BLEND), (g = !0)), R !== Ku)) {
      if (R !== b || Ht !== B) {
        if (
          ((f !== li || M !== li) &&
            (n.blendEquation(n.FUNC_ADD), (f = li), (M = li)),
          Ht)
        )
          switch (R) {
            case Xi:
    ...
    (nt = nt || tt),
      ...
      (W !== u || X !== S || bt !== y || Bt !== F) &&
        ...
        (F = Bt)),
      (ue.equals(A) === !1 || Me !== T) &&
        (n.blendColor(ue.r, ue.g, ue.b, Me), A.copy(ue), (T = Me)),
      (b = R),
      (B = !1);
  }
  function Yt(R, tt) {
    R.side === En ? lt(n.CULL_FACE) : ft(n.CULL_FACE);
    let W = R.side === Ie;
    tt && (W = !W),
      $t(W),
      R.blending === Xi && R.transparent === !1
        ? ce(Xn)
        : ce(
            R.blending,
            R.blendEquation,
...
function Gv(n, t, e, i, r, s, o) {
  ...
  function g(E, _) {
    return m ? new OffscreenCanvas(E, _) : Er('canvas');
  }
  function b(E, _, O) {
    let j = 1;
    const Z = Pt(E);
  ...
  function f(E) {
    return E.generateMipmaps && E.minFilter !== Ye && E.minFilter !== rn;
  }
  function u(E) {
    n.generateMipmap(E);
  }
  function S(E, _, O, j, Z = !1) {
    ...
    if (
      ...
      const xt = Z ? Ps : jt.getTransfer(j);
  ...
  function M(E, _) {
    ...
    return (
      E
        ...
        : _ === wr && (O = n.DEPTH_COMPONENT16),
      O
    );
  }
  function y(E, _) {
    return f(E) === !0 ||
      (E.isFramebufferTexture && E.minFilter !== Ye && E.minFilter !== rn)
  ...
  const V = { [Xo]: n.REPEAT, [hi]: n.CLAMP_TO_EDGE, [jo]: n.MIRRORED_REPEAT },
    ot = {
      [Ye]: n.NEAREST,
      [Pd]: n.NEAREST_MIPMAP_NEAREST,
      [Kr]: n.NEAREST_MIPMAP_LINEAR,
      [rn]: n.LINEAR,
      [no]: n.LINEAR_MIPMAP_NEAREST,
      [ui]: n.LINEAR_MIPMAP_LINEAR,
    },
    ht = {
      [Id]: n.NEVER,
      [kd]: n.ALWAYS,
  ...
  function mt(E, _) {
    if (
      ...
      if (
        _.magFilter === Ye ||
        (_.minFilter !== Kr && _.minFilter !== ui) ||
        (_.type === Sn && t.has('OES_texture_float_linear') === !1)
      )
        return;
  ...
  function Kt(E, _, O) {
    ...
    if (K.version !== xt.__version || Z === !0) {
      ...
      const rt = jt.getPrimaries(jt.workingColorSpace),
        ct = _.colorSpace === Gn ? null : jt.getPrimaries(_.colorSpace),
        Rt =
          _.colorSpace === Gn || rt === ct ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      ...
      if (_.isDepthTexture)
        ...
        if (_.isCompressedArrayTexture) {
          ...
          for (let W = 0, X = Tt.length; W < X; W++)
            if (((ut = Tt[W]), _.format !== sn))
              if (at !== null)
                if (Ut) {
                  if (R)
                    if (_.layerUpdates.size > 0) {
                      const nt = xc(ut.width, ut.height, _.format, _.type);
        ...
        if (Ut) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const W = xc(Q.width, Q.height, _.format, _.type);
  ...
  function z(E, _, O) {
    ...
    if (Z.version !== K.__version || j === !0) {
      ...
      const xt = jt.getPrimaries(jt.workingColorSpace),
        rt = _.colorSpace === Gn ? null : jt.getPrimaries(_.colorSpace),
        ct =
          _.colorSpace === Gn || xt === rt ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, _.flipY),
        n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL, _.premultiplyAlpha),
        n.pixelStorei(n.UNPACK_ALIGNMENT, _.unpackAlignment),
  ...
  function lt(E, _) {
    ...
    else if (_.depthTexture.format === Qi)
      gt(_)
        ? a.framebufferTexture2DMultisampleEXT(
            n.FRAMEBUFFER,
...
function Wv(n, t) {
  function e(i, r = Gn) {
    ...
    if (i === An) return n.UNSIGNED_BYTE;
    if (i === Ra) return n.UNSIGNED_SHORT_4_4_4_4;
    if (i === La) return n.UNSIGNED_SHORT_5_5_5_1;
    if (i === ih) return n.UNSIGNED_INT_5_9_9_9_REV;
    if (i === eh) return n.BYTE;
    if (i === nh) return n.SHORT;
    if (i === wr) return n.UNSIGNED_SHORT;
    if (i === Pa) return n.INT;
    if (i === pi) return n.UNSIGNED_INT;
    if (i === Sn) return n.FLOAT;
    if (i === Rr) return n.HALF_FLOAT;
    if (i === rh) return n.ALPHA;
    if (i === sh) return n.RGB;
    if (i === sn) return n.RGBA;
    if (i === oh) return n.LUMINANCE;
    if (i === ah) return n.LUMINANCE_ALPHA;
    if (i === ji) return n.DEPTH_COMPONENT;
    if (i === Qi) return n.DEPTH_STENCIL;
    if (i === lh) return n.RED;
    if (i === Da) return n.RED_INTEGER;
    if (i === ch) return n.RG;
    if (i === Ia) return n.RG_INTEGER;
    if (i === Ua) return n.RGBA_INTEGER;
    if (i === xs || i === bs || i === Ms || i === ws)
      if (o === Qt)
        if (((s = t.get('WEBGL_compressed_texture_s3tc_srgb')), s !== null)) {
          if (i === xs) return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (i === bs) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (i === Ms) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
          if (i === ws) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
        } else return null;
      else if (((s = t.get('WEBGL_compressed_texture_s3tc')), s !== null)) {
        if (i === xs) return s.COMPRESSED_RGB_S3TC_DXT1_EXT;
        if (i === bs) return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;
        if (i === Ms) return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (i === ws) return s.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
    if (i === qo || i === Yo || i === Ko || i === $o)
      if (((s = t.get('WEBGL_compressed_texture_pvrtc')), s !== null)) {
        if (i === qo) return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (i === Yo) return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (i === Ko) return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (i === $o) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (i === Zo || i === Jo || i === Qo)
    ...
    if (i === Es || i === fa || i === ma)
      if (((s = t.get('EXT_texture_compression_bptc')), s !== null)) {
        ...
        if (i === fa) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (i === ma) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (i === hh || i === _a || i === va || i === ga)
      if (((s = t.get('EXT_texture_compression_rgtc')), s !== null)) {
        if (i === Es) return s.COMPRESSED_RED_RGTC1_EXT;
        if (i === _a) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (i === va) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (i === ga) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
    return i === Ji ? n.UNSIGNED_INT_24_8 : n[i] !== void 0 ? n[i] : null;
  }
  return { convert: e };
}
class Xv extends He {
...
class Kv {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Ke(new Vs(20, 20), i);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(t, e) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (z) {
        let J = M[z];
        return (
          J === void 0 && ((J = new Po()), (M[z] = J)), J.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (z) {
        let J = M[z];
        return J === void 0 && ((J = new Po()), (M[z] = J)), J.getGripSpace();
      }),
      (this.getHand = function (z) {
        let J = M[z];
        return J === void 0 && ((J = new Po()), (M[z] = J)), J.getHandSpace();
      });
    function k(z) {
        ...
        if (((r = z), r !== null)) {
          if (
            ...
            (m = new XRWebGLLayer(r, e, J)),
              ...
              (S = new fi(m.framebufferWidth, m.framebufferHeight, {
                format: sn,
                type: An,
            ...
            (d = new XRWebGLBinding(r, e)),
              ...
              (S = new fi(p.textureWidth, p.textureHeight, {
                format: sn,
                type: An,
                depthTexture: new Ch(
                  p.textureWidth,
    ...
    function ht(z, J, ft) {
      ft === null
        ...
        z.isPerspectiveCamera &&
          ((z.fov = xa * 2 * Math.atan(1 / z.projectionMatrix.elements[5])),
          (z.zoom = 1));
    }
...
function Jv(n, t) {
  ...
  function i(f, u) {
    u.color.getRGB(f.fogColor.value, wh(n)),
      u.isFog
  ...
  function s(f, u) {
    ...
    M &&
      ...
      M.isCubeTexture &&
        ...
        ((si.y *= -1), (si.z *= -1)),
      f.envMapRotation.value.setFromMatrix4(Zv.makeRotationFromEuler(si)),
      (f.flipEnvMap.value =
    ...
    (f.ior.value = u.ior),
      ...
      u.clearcoat > 0 &&
        ...
        u.clearcoatNormalMap &&
          ...
          u.side === Ie && f.clearcoatNormalScale.value.negate())),
...
class tg {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in e &&
          e.setAttribute('data-engine', `three.js r${Aa}`),
    ...
    function R() {
      (Yt = new o_(C)),
        ...
        (Ft = new h_(C, $t, Pt)),
        (Rt = new t_(Ct)),
        (K = new Cv(M, E, _, Yt, $t, Ut, Rt)),
        (xt = new Jv(M, Ct)),
        (rt = new Pv()),
        (ct = new Nv(Yt)),
        (at = new $m(M, E, _, gt, Z, p, l)),
        (Q = new Vv(M, Z, $t)),
        (ne = new Qv(C, he, $t, gt)),
        (St = new Jm(C, Yt, he)),
        (ut = new l_(C, Yt, he)),
    ...
    (this.xr = tt),
      ...
      (this.dispose = function () {
        e.removeEventListener('webglcontextlost', W, !1),
          ...
          K.dispose(),
          tt.dispose(),
          tt.removeEventListener('sessionstart', an),
          tt.removeEventListener('sessionend', vl),
          Qn.stop();
      });
    function W(v) {
      v.preventDefault(),
    ...
    this.renderBufferDirect = function (v, L, U, N, D, et) {
      ...
      let Fe,
        Wt = St;
      if (
        (pt !== null && ((Fe = O.get(pt)), (Wt = ut), Wt.setIndex(Fe)),
        D.isMesh)
      )
        N.wireframe === !0
      ...
      if (D.isBatchedMesh)
        if (D._multiDrawInstances !== null)
          ...
          const vt = D._multiDrawStarts,
            we = D._multiDrawCounts,
            Xt = D._multiDrawCount,
            Qe = pt ? O.get(pt).bytesPerElement : 1,
            wi = Ct.get(N).currentProgram.getUniforms();
          for (let Be = 0; Be < Xt; Be++)
            wi.setValue(C, '_gl_DrawID', Be), Wt.render(vt[Be] / Qe, we[Be]);
        }
        ...
        const vt = U._maxInstanceCount !== void 0 ? U._maxInstanceCount : 1 / 0,
          we = Math.min(U.instanceCount, vt);
        Wt.renderInstances(Gt, oe, we);
      } else Wt.render(Gt, oe);
    };
    function Me(v, L, U) {
      v.transparent === !0 && v.side === En && v.forceSinglePass === !1
        ? ((v.side = Ie),
          (v.needsUpdate = !0),
          Yr(v, L, U),
          (v.side = Yn),
    ...
    const Qn = new yh();
    Qn.setAnimationLoop(mn),
      typeof self < 'u' && Qn.setContext(self),
      (this.setAnimationLoop = function (v) {
        (Ht = v), tt.setAnimationLoop(v), v === null ? Qn.stop() : Qn.start();
      }),
      tt.addEventListener('sessionstart', an),
      tt.addEventListener('sessionend', vl),
      (this.render = function (v, L) {
        ...
        if (
          ...
          et !== null && Js(et, L, -1 / 0, M.sortObjects);
        }
        Js(v, L, 0, M.sortObjects),
          b.finish(),
        ...
        if ((f.setupLights(), L.isArrayCamera)) {
          ...
          for (let st = 0, dt = et.length; st < dt; st++) {
            const pt = et[st];
            gl(b, v, pt, pt.viewport);
          }
        } else D.length > 0 && xl(N, D, v, L), Nt && at.render(v), gl(b, v, L);
        T !== null &&
    ...
    function Js(v, L, U, N) {
      ...
      const et = v.children;
      for (let st = 0, dt = et.length; st < dt; st++) Js(et[st], L, U, N);
    }
    function gl(v, L, U, N) {
      const D = v.opaque,
        et = v.transmissive,
      ...
      f.setupLightsView(U),
        ...
        D.length > 0 && qr(D, L, U),
        et.length > 0 && qr(et, L, U),
        st.length > 0 && qr(st, L, U),
    ...
    function xl(v, L, U, N) {
      ...
      f.state.transmissionRenderTarget[N.id] === void 0 &&
        (f.state.transmissionRenderTarget[N.id] = new fi(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        for (let _t = 0, Gt = L.length; _t < Gt; _t++) {
          const se = L[_t],
            ...
            Wt = se.material,
            vt = se.group;
          if (Wt.side === En && oe.layers.test(N.layers)) {
            const we = Wt.side;
            (Wt.side = Ie),
              (Wt.needsUpdate = !0),
              bl(oe, U, N, Fe, Wt, vt),
    ...
    function qr(v, L, U) {
      ...
      for (let D = 0, et = v.length; D < et; D++) {
        const st = v[D],
          ...
          Et = st.group;
        dt.layers.test(U.layers) && bl(dt, L, U, pt, Mt, Et);
      }
    }
    function bl(v, L, U, N, D, et) {
      v.onBeforeRender(M, L, U, N, D, et),
        ...
        D.transparent === !0 && D.side === En && D.forceSinglePass === !1
          ? ((D.side = Ie),
            (D.needsUpdate = !0),
    ...
    function Ml(v) {
      if (v.uniformsList === null) {
        ...
        v.uniformsList = ys.seqWithValue(L.seq, v.uniforms);
      }
    ...
    function Hu(v, L, U, N, D) {
      ...
      let Qe = vt.currentProgram;
      Xt === !0 && (Qe = Yr(N, L, D));
      let wi = !1,
        Be = !1,
        Qs = !1;
      const de = Qe.getUniforms(),
        Dn = vt.uniforms;
      if (
        (gt.useProgram(Qe.program) && ((wi = !0), (Be = !0), (Qs = !0)),
        N.id !== B && ((B = N.id), (Be = !0)),
        wi || w !== v)
      ) {
        ...
        Xe !== void 0 &&
          Xe.setValue(C, lt.setFromMatrixPosition(v.matrixWorld)),
      ...
      if (D.isSkinnedMesh) {
        ...
        Xe &&
          ...
          de.setValue(C, 'boneTexture', Xe.boneTexture, Pt));
      }
      D.isBatchedMesh &&
      ...
      const to = U.morphAttributes;
      if (
        ((to.position !== void 0 ||
          to.normal !== void 0 ||
          to.color !== void 0) &&
          Ft.update(D, U, Qe),
        (Be || vt.receiveShadow !== D.receiveShadow) &&
        ...
        N.isMeshStandardMaterial &&
          N.envMap === null &&
          L.environment !== null &&
          (Dn.envMapIntensity.value = L.environmentIntensity),
        Be &&
          (de.setValue(C, 'toneMappingExposure', M.toneMappingExposure),
          vt.needsLights && Gu(Dn, Qs),
          et && N.fog === !0 && xt.refreshFogUniforms(Dn, et),
          ...
          ys.upload(C, Ml(vt), Dn, Pt)),
        N.isShaderMaterial &&
          N.uniformsNeedUpdate === !0 &&
          (ys.upload(C, Ml(vt), Dn, Pt), (N.uniformsNeedUpdate = !1)),
        ...
        const Xe = N.uniformsGroups;
        for (let eo = 0, Xu = Xe.length; eo < Xu; eo++) {
          const El = Xe[eo];
          ne.update(El, Qe), ne.bind(El, Qe);
        }
      }
      return Qe;
    }
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.copyTextureToTexture = function (v, L, U = null, N = null, D = 0) {
        ...
        const se = C.getParameter(C.UNPACK_ROW_LENGTH),
          ...
          Fe = C.getParameter(C.UNPACK_SKIP_PIXELS),
          Wt = C.getParameter(C.UNPACK_SKIP_ROWS),
          vt = C.getParameter(C.UNPACK_SKIP_IMAGES),
          we = v.isCompressedTexture ? v.mipmaps[D] : v.image;
        C.pixelStorei(C.UNPACK_ROW_LENGTH, we.width),
          C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, we.height),
          C.pixelStorei(C.UNPACK_SKIP_PIXELS, dt),
          C.pixelStorei(C.UNPACK_SKIP_ROWS, pt),
          v.isDataTexture
            ? C.texSubImage2D(C.TEXTURE_2D, D, Mt, Et, et, st, _t, Gt, we.data)
            ...
            : C.texSubImage2D(C.TEXTURE_2D, D, Mt, Et, et, st, _t, Gt, we),
      ...
      (this.copyTextureToTexture3D = function (
        ...
        C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL, L.flipY),
          C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL, L.premultiplyAlpha),
          C.pixelStorei(C.UNPACK_ALIGNMENT, L.unpackAlignment);
        const we = C.getParameter(C.UNPACK_ROW_LENGTH),
          Xt = C.getParameter(C.UNPACK_IMAGE_HEIGHT),
          Qe = C.getParameter(C.UNPACK_SKIP_PIXELS),
          wi = C.getParameter(C.UNPACK_SKIP_ROWS),
          Be = C.getParameter(C.UNPACK_SKIP_IMAGES);
        C.pixelStorei(C.UNPACK_ROW_LENGTH, oe.width),
          ...
          v.isDataTexture || v.isData3DTexture
            ? C.texSubImage3D(vt, D, _t, Gt, se, et, st, dt, Fe, Wt, oe.data)
            ...
            : C.texSubImage3D(vt, D, _t, Gt, se, et, st, dt, Fe, Wt, oe),
          C.pixelStorei(C.UNPACK_ROW_LENGTH, we),
          C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, Xt),
          C.pixelStorei(C.UNPACK_SKIP_PIXELS, Qe),
          C.pixelStorei(C.UNPACK_SKIP_ROWS, wi),
  ...
  set outputColorSpace(t) {
    ...
    (e.drawingBufferColorSpace = t === Na ? 'display-p3' : 'srgb'),
      (e.unpackColorSpace =
        jt.workingColorSpace === ks ? 'display-p3' : 'srgb');
  }
}
class eg extends Ue {
  constructor() {
...
class rg extends za {
  ...
  load(t, e, i, r) {
    ...
    const a = Er('img');
    function l() {
      h(), bc.add(t, this), e && e(this), s.manager.itemEnd(t);
    }
    function c(d) {
...
class og {
  ...
  updateMatrices(t) {
    ...
    Mc.setFromMatrixPosition(t.matrixWorld),
      e.position.copy(Mc),
      wc.setFromMatrixPosition(t.target.matrixWorld),
      e.lookAt(wc),
      e.updateMatrixWorld(),
      Ro.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
...
class ag extends og {
  ...
  updateMatrices(t, e = 0) {
    ...
    s !== i.far && ((i.far = s), i.updateProjectionMatrix()),
      fr.setFromMatrixPosition(t.matrixWorld),
      i.position.copy(fr),
      Lo.copy(i.position),
      Lo.add(this._cubeDirections[e]),
      i.up.copy(this._cubeUps[e]),
      i.lookAt(Lo),
      i.updateMatrixWorld(),
      r.makeTranslation(-fr.x, -fr.y, -fr.z),
...
typeof __THREE_DEVTOOLS__ < 'u' &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent('register', { detail: { revision: Aa } })
  );
typeof window < 'u' &&
  (window.__THREE__
...
class dg extends hg {
  constructor(t, e = null) {
    super(t, e),
      ...
      (this._lastQuaternion = new mi()),
      (this._lastTargetPosition = new I()),
      (this._quat = new mi().setFromUnitVectors(t.up, new I(0, 1, 0))),
      ...
      (this._onPointerMove = fg.bind(this)),
      (this._onPointerDown = pg.bind(this)),
      (this._onPointerUp = mg.bind(this)),
      (this._onContextMenu = wg.bind(this)),
      (this._onMouseWheel = gg.bind(this)),
      (this._onKeyDown = xg.bind(this)),
      (this._onTouchStart = bg.bind(this)),
      (this._onTouchMove = Mg.bind(this)),
      (this._onMouseDown = _g.bind(this)),
      (this._onMouseMove = vg.bind(this)),
      (this._interceptControlDown = Eg.bind(this)),
      (this._interceptControlUp = Sg.bind(this)),
  ...
  update(t = null) {
    ...
    isFinite(i) &&
      isFinite(r) &&
      (i < -Math.PI ? (i += Le) : i > Math.PI && (i -= Le),
      r < -Math.PI ? (r += Le) : r > Math.PI && (r -= Le),
      i <= r
    ...
    if (
      ...
      o !== null &&
        (this.screenSpacePanning
          ...
          : (vs.origin.copy(this.object.position),
            vs.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(vs.direction)) < ug
              ? this.object.lookAt(this.target)
              : (Cc.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                vs.intersectPlane(Cc, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > Do ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Do ||
      this._lastTargetPosition.distanceToSquared(this.target) > Do
        ? (this.dispatchEvent(yc),
  ...
  _getAutoRotationAngle(t) {
    return t !== null
      ? (Le / 60) * this.autoRotateSpeed * t
      : (Le / 60 / 60) * this.autoRotateSpeed;
  }
  _getZoomScale(t) {
  ...
  _handleMouseMoveRotate(t) {
    ...
    this._rotateLeft((Le * this._rotateDelta.x) / e.clientHeight),
      this._rotateUp((Le * this._rotateDelta.y) / e.clientHeight),
    ...
    switch (t.code) {
      case this.keys.UP:
        t.ctrlKey || t.metaKey || t.shiftKey
          ? this._rotateUp(
              (Le * this.rotateSpeed) / this.domElement.clientHeight
            )
...
function _g(n) {
  ...
  this.state !== Zt.NONE && this.dispatchEvent(Ha);
}
function vg(n) {
  switch (this.state) {
    case Zt.ROTATE:
  ...
  return Array.from(new Set([...Object.keys(n), ...Object.keys(t)])).reduce(
    (i, r) => {
      const s = n[r],
        o = t[r];
      return Ma(s) && Ma(o)
        ? Object.assign(Object.assign({}, i), { [r]: _i(s, o) })
...
class ae {
  ...
  constructor(t) {
    var e;
    (this.message =
      (e = Cg[t.type](t.context)) !== null && e !== void 0
        ? e
        : 'Unexpected error'),
...
class Is {
  ...
  writeProperty(t, e) {
    const i = this.read();
    if (!Is.isBindable(i)) throw ae.notBindable();
...
function ee(n, t) {
  ...
  return !e && !i ? new Ag(n) : new Tg(n, t);
}
function Rg(n) {
  return [
    new Pg(n),
...
function Vg(n, t) {
  ...
  const r = yr(n, t);
  return (t += r.length), e + i + r + ja(n, t);
}
function zg(n, t) {
  const e = n.substr(t, 1);
  if (((t += e.length), e !== '.')) return '';
...
function Jg(n, t) {
  const e = Zg(n, t);
  return (t += e.length), e === '' ? null : { evaluable: new Ig(e), cursor: t };
}
function Qg(n, t) {
  const e = n.substr(t, 1);
...
function t0(n, t) {
  var e;
  return (e = Jg(n, t)) !== null && e !== void 0 ? e : Qg(n, t);
}
function Uh(n, t) {
  const e = t0(n, t);
  if (e) return e;
  ...
  const r = Uh(n, t);
  return r
    ? ((t = r.cursor), { cursor: t, evaluable: new Fg(i, r.evaluable) })
    : null;
}
function e0(n, t, e) {
  e += Sr(t, e).length;
  ...
  return i
    ? ((e += i.length), (e += Sr(t, e).length), { cursor: e, operator: i })
    : null;
}
function n0(n, t) {
  return (e, i) => {
    ...
    for (;;) {
      ...
      const a = n(e, i);
      if (!a) return null;
      (i = a.cursor), (s = new Ng(o.operator, s, a.evaluable));
    }
...
const i0 = [
  ...
  ['^'],
  ['|'],
].reduce((n, t) => n0(n, t), Uh);
function Nh(n, t) {
  return (t += Sr(n, t).length), i0(n, t);
}
function r0(n) {
  const t = Nh(n, 0);
  return !t || t.cursor + Sr(n, t.cursor).length !== n.length
    ? null
    : t.evaluable;
}
function Pn(n) {
...
function o0(n, t) {
  return Jt(n.step) ? Math.max(Tc(t), 2) : Tc(n.step);
}
function Bh(n) {
  var t;
...
function Vh(n, t) {
  return Jt(n.step) ? null : new Dg(n.step, t);
}
function zh(n) {
  return !Jt(n.max) && !Jt(n.min)
    ? new Nr({ max: n.max, min: n.min })
    : !Jt(n.max) || !Jt(n.min)
    ? new Lg({ max: n.max, min: n.min })
    : null;
}
function Hh(n, t) {
  var e, i, r;
  return {
    formatter: (e = n.format) !== null && e !== void 0 ? e : Ne(o0(n, t)),
    keyScale: (i = n.keyScale) !== null && i !== void 0 ? i : Bh(n),
    pointerScale: (r = n.pointerScale) !== null && r !== void 0 ? r : kh(n, t),
  };
}
function Gh(n) {
  return {
...
function qa(n) {
  return {
    ...
    textProps: It.fromObject(Hh(n.params, n.initialValue)),
  };
}
class bi {
  constructor(t) {
...
class Cr extends bi {
  ...
  onValueChange_(t) {
    ...
    this.emitter_.emit(
      'change',
      new Or(this, e.binding.target.read(), t.options.last)
    );
  }
}
class h0 {
...
function u0(n) {
  ...
  const t = n.binding;
  return Wa(t) && 'read' in t && 'write' in t;
}
function d0(n, t) {
...
function Ac(n) {
  return {
    custom: (t) => Mn(t)(n),
    boolean: Mn((t) => (typeof t == 'boolean' ? t : void 0))(n),
    number: Mn((t) => (typeof t == 'number' ? t : void 0))(n),
    string: Mn((t) => (typeof t == 'string' ? t : void 0))(n),
    function: Mn((t) => (typeof t == 'function' ? t : void 0))(n),
    constant: (t) => Mn((e) => (e === t ? t : void 0))(n),
    raw: Mn((t) => t)(n),
    object: (t) =>
      Mn((e) => {
        if (f0(e)) return d0(e, t);
      })(n),
    array: (t) =>
      Mn((e) => {
        if (Array.isArray(e)) return p0(e, t);
      })(n),
  };
}
const wa = { optional: Ac(!0), required: Ac(!1) };
function ie(n, t) {
  const e = t(wa),
    i = wa.required.object(e)(n);
...
function Gs(n, t) {
  const e = n.createElementNS(hn, 'svg');
  return (e.innerHTML = x0[t]), e;
}
function Xh(n, t, e) {
...
class Yh {
  constructor(t, e) {
    ...
    i.classList.add(mr('l')),
      pn(e.props, 'label', (s) => {
        Jt(s)
          ? this.element.classList.add(mr(void 0, 'nol'))
          : (this.element.classList.remove(mr(void 0, 'nol')),
            b0(i),
            i.appendChild(w0(t, s)));
      }),
      this.element.appendChild(i),
      (this.labelElement = i);
    const r = t.createElement('div');
    r.classList.add(mr('v')),
...
class Kh {
  constructor(t, e) {
    (this.props = e.props),
      ...
      (this.view = new Yh(t, { props: e.props, viewProps: this.viewProps })),
  ...
  exportProps() {
    return We(null, { label: this.props.get('label') });
  }
}
function E0() {
...
const Pc = kt(''),
  Rc = { veryfirst: 'vfst', first: 'fst', last: 'lst', verylast: 'vlst' };
class Ws {
  constructor(t) {
    (this.parent_ = null),
      (this.blade = t.blade),
    ...
    this.blade.value('positions').emitter.on('change', () => {
      E0().forEach((i) => {
        e.classList.remove(Pc(void 0, Rc[i]));
      }),
        this.blade.get('positions').forEach((i) => {
          e.classList.add(Pc(void 0, Rc[i]));
        });
    }),
  ...
  exportState() {
    return We(null, Object.assign({}, this.viewProps.exportState()));
  }
}
class vi extends Ws {
  constructor(t, e) {
    ...
    super(
      Object.assign(Object.assign({}, e), {
        view: new Yh(t, { props: e.props, viewProps: i }),
        viewProps: i,
      })
    ),
...
class $h extends vi {
  ...
  importState(t) {
    return Ge(
      t,
      (e) => super.importState(Lc(t)),
      (e) => ({ tag: e.optional.string }),
      (e) => ((this.tag = e.tag), !0)
    );
  }
  exportState() {
    return We(() => Lc(super.exportState()), {
      binding: {
...
class R0 {
  constructor(t) {
    (this.emitter = new fe()),
      ...
      (this.value_ = ee(T0(t.bufferSize))),
      this.value_.emitter.on('beforechange', this.onValueBeforeChange_),
      this.value_.emitter.on('change', this.onValueChange_),
  ...
  fetch() {
    this.value_.rawValue = P0(this.value_.rawValue, this.binding.read());
  }
  onTick_() {
    this.fetch();
  }
...
class D0 extends $h {
  exportState() {
    return We(() => super.exportState(), { binding: { readonly: !0 } });
  }
}
function I0(n) {
  return di(n) && L0(n.value);
}
class U0 extends bi {
  get label() {
    return this.controller.labelController.props.get('label');
...
class O0 {
  constructor(t, e) {
    ...
    i.classList.add(Io('b')),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
      (this.buttonElement = i);
    const r = t.createElement('div');
    r.classList.add(Io('t')),
      $a(e.props.value('title'), r),
...
class F0 {
  constructor(t, e) {
    (this.emitter = new fe()),
      ...
      (this.view = new O0(t, { props: this.props, viewProps: this.viewProps })),
  ...
  exportProps() {
    return We(null, { title: this.props.get('title') });
  }
  onClick_(t) {
...
class Dc extends Ws {
  constructor(t, e) {
    const i = new F0(t, { props: e.buttonProps, viewProps: e.viewProps }),
      r = new Kh(t, {
        blade: e.blade,
        props: e.labelProps,
        valueController: i,
...
const sr = new Jh('2.0.5');
function Pe(n) {
  return Object.assign({ core: sr }, n);
}
const B0 = Pe({
  id: 'button',
  type: 'blade',
  ...
  api(n) {
    return n.controller instanceof Dc ? new U0(n.controller) : null;
  },
});
function k0(n, t) {
...
function H0(n) {
  return Ga(n) ? 'refresh' in n && typeof n.refresh == 'function' : !1;
}
function G0(n, t) {
  if (!Is.isBindable(n)) throw ae.notBindable();
  return new Is(n, t);
}
class W0 {
  constructor(t, e) {
  ...
  addBinding(t, e, i) {
    const r = i ?? {},
      ...
      o = this.pool_.createBinding(s, G0(t, e), r),
  ...
  onRackValueChange_(t) {
    const e = t.bladeController,
      ...
      r = Wh(e.value) ? e.value.binding : null;
    this.emitter_.emit(
      'change',
      new Or(i, r ? r.target.read() : e.value.rawValue, t.options.last)
    );
  }
}
class Za extends bi {
  constructor(t, e) {
    super(t), (this.rackApi_ = new W0(t.rackController, e));
  }
  refresh() {
...
function j0(n, t) {
  for (let e = 0; e < n.length; e++) {
    const i = n[e];
    if (di(i) && i.value === t) return i;
  }
  return null;
}
function q0(n) {
  return Ea(n) ? n.rackController.rack.bcSet_ : null;
}
class Y0 {
  constructor(t) {
    var e, i;
  ...
  onSetRemove_(t) {
    ...
    if (
      ...
      return;
    const i = t.item;
    if (di(i)) i.value.emitter.off('change', this.onChildValueChange_);
    else if (Ea(i)) {
      const r = i.rackController.rack;
      if (r) {
        const s = r.emitter;
  ...
  onChildValueChange_(t) {
    const e = j0(this.find(di), t.sender);
...
class Qa {
  ...
  onRackAdd_(t) {
    t.root && Xh(this.element, t.bladeController.view.element, t.index);
  }
  onRackRemove_(t) {
...
function or() {
  return new It({ positions: ee([], { equals: yg }) });
}
class Fr extends It {
  constructor(t) {
    super(t);
  ...
  bindExpandedClass(t, e) {
    ...
    pn(this, 'expanded', i), pn(this, 'temporaryExpanded', i);
  }
  cleanUpTransition() {
  ...
  constructor(t, e) {
    super(t, e),
      ...
      this.controller.foldable.value('expanded').emitter.on('change', (i) => {
        this.emitter_.emit('fold', new a0(this, i.sender.rawValue));
      }),
...
class $0 {
  constructor(t, e) {
    ...
    (this.className_ = kt(
      ...
      (this.element = t.createElement('div')),
      this.element.classList.add(this.className_(), tu()),
      e.viewProps.bindClassModifiers(this.element),
      ...
      pn(
        this.foldable_,
        'completed',
        rr(this.element, this.className_(void 0, 'cpl'))
      );
...
class Sa extends Ja {
  constructor(t, e) {
    var i;
    const r = Fr.create((i = e.expanded) !== null && i !== void 0 ? i : !0),
      s = new $0(t, {
        foldable: r,
        props: e.props,
    ...
    super(
      ...
      (this.props = e.props),
      (this.foldable = r),
      tl(this.foldable, this.view.containerElement),
...
const Z0 = Pe({
    ...
    api(n) {
      return n.controller instanceof Sa ? new Qh(n.controller, n.pool) : null;
    },
  }),
  J0 = kt('');
function Uc(n, t) {
  return rr(n, J0(void 0, t));
}
class Ln extends It {
  constructor(t) {
    var e;
    super(t),
      ...
      ([this.globalDisabled_, this.setGlobalDisabled_] = Rg(
  ...
  bindClassModifiers(t) {
    Tn(this.globalDisabled_, Uc(t, 'disabled')),
      pn(this, 'hidden', Uc(t, 'hidden'));
  }
  bindDisabled(t) {
    Tn(this.globalDisabled_, (e) => {
      t.disabled = e;
    });
  }
  bindTabIndex(t) {
  ...
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      pn(e.props, 'selected', (s) => {
        s
          ? this.element.classList.add(_r(void 0, 'sel'))
          : this.element.classList.remove(_r(void 0, 'sel'));
      });
    const i = t.createElement('button');
    i.classList.add(_r('b')),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
      (this.buttonElement = i);
    const r = t.createElement('div');
    r.classList.add(_r('t')),
      $a(e.props.value('title'), r),
      this.buttonElement.appendChild(r),
      (this.titleElement = r);
  }
...
class ex {
  constructor(t, e) {
    (this.emitter = new fe()),
      ...
      (this.props = e.props),
      (this.viewProps = e.viewProps),
      (this.view = new tx(t, { props: e.props, viewProps: e.viewProps })),
      this.view.buttonElement.addEventListener('click', this.onClick_);
  }
  onClick_() {
...
class ya extends Ja {
  constructor(t, e) {
    const i = new Q0(t, { viewProps: e.viewProps });
    super(
      Object.assign(Object.assign({}, e), {
        rackController: new Qa({
          blade: e.blade,
      ...
      (this.ic_ = new ex(t, { props: e.itemProps, viewProps: Ln.create() })),
...
class nx extends Za {
  ...
  onSelect_(t) {
    this.emitter_.emit('select', new l0(this, t.rawValue));
  }
}
class ix extends Za {
  get title() {
...
class rx {
  ...
  keepSelection_() {
    if (this.items_.length === 0) {
      (this.selectedIndex.rawValue = Oc), (this.empty.rawValue = !0);
      return;
    }
...
class sx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      this.element.classList.add(vr(), tu()),
      e.viewProps.bindClassModifiers(this.element),
      Tn(e.empty, rr(this.element, vr(void 0, 'nop')));
    const i = t.createElement('div');
    i.classList.add(vr('t')),
      this.element.appendChild(i),
      (this.itemsElement = i);
    const r = t.createElement('div');
    r.classList.add(vr('i')), this.element.appendChild(r);
    const s = t.createElement('div');
    s.classList.add(vr('c')),
...
class Fc extends Ja {
  constructor(t, e) {
    const i = new rx(),
      r = new sx(t, { empty: i.empty, viewProps: e.viewProps });
    super({
      blade: e.blade,
      rackController: new Qa({
        blade: e.blade,
  ...
  onRackAdd_(t) {
    if (!t.root) return;
    const e = t.bladeController;
    Xh(this.view.itemsElement, e.itemController.view.element, t.index),
...
const eu = Pe({
  ...
  controller(n) {
    const t = new Fc(n.document, { blade: n.blade, viewProps: n.viewProps });
    return (
      n.params.pages.forEach((e) => {
        const i = new ya(n.document, {
          blade: or(),
  ...
  api(n) {
    return n.controller instanceof Fc
      ? new nx(n.controller, n.pool)
      : n.controller instanceof ya
      ? new ix(n.controller, n.pool)
      : null;
  },
});
function ox(n, t) {
...
class $n {
  ...
  importProps(t) {
    return Ge(
      t,
      null,
      (e) => ({ options: e.required.custom(Vr) }),
      (e) => (this.props.set('options', nl(e.options)), !0)
    );
  }
  exportProps() {
    return We(null, { options: this.props.get('options') });
  }
}
const Bc = kt('pop');
class hx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      Tn(e.shows, rr(this.element, Bc(void 0, 'v')));
  }
}
class nu {
  constructor(t, e) {
    (this.shows = ee(!1)),
      (this.viewProps = e.viewProps),
      (this.view = new hx(t, { shows: this.shows, viewProps: this.viewProps }));
  }
}
const kc = kt('txt');
class ux {
...
function ar({ primary: n, secondary: t, forward: e, backward: i }) {
  let r = !1;
  function s(o) {
    r || ((r = !0), o(), (r = !1));
  }
...
function su(n) {
  return mx(n) || n === 'ArrowLeft' || n === 'ArrowRight';
}
function No(n, t) {
  var e, i;
  ...
  onMouseDown_(t) {
    ...
    i.addEventListener('mousemove', this.onDocumentMouseMove_),
      ...
      this.emitter.emit('down', {
        altKey: t.altKey,
        data: this.computePosition_(No(t, this.elem_)),
        sender: this,
        shiftKey: t.shiftKey,
      });
  }
...
class _x {
  constructor(t, e) {
    (this.onChange_ = this.onChange_.bind(this)),
      ...
      this.props_.emitter.on('change', this.onChange_),
      (this.element = t.createElement('div')),
      this.element.classList.add(qe(), qe(void 0, 'num')),
      e.arrayPosition &&
        this.element.classList.add(qe(void 0, e.arrayPosition)),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('input');
    i.classList.add(qe('i')),
      (i.type = 'text'),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
      (this.inputElement = i),
      ...
      this.inputElement.classList.add(qe('i'));
    const r = t.createElement('div');
    r.classList.add(qe('k')),
      this.element.appendChild(r),
      (this.knobElement = r);
    const s = t.createElementNS(hn, 'svg');
    s.classList.add(qe('g')), this.knobElement.appendChild(s);
    const o = t.createElementNS(hn, 'path');
    o.classList.add(qe('gb')), s.appendChild(o), (this.guideBodyElem_ = o);
    const a = t.createElementNS(hn, 'path');
    a.classList.add(qe('gh')), s.appendChild(a), (this.guideHeadElem_ = a);
    const l = t.createElement('div');
...
class zr {
  constructor(t, e) {
    ...
    const r = new Mi(this.view.knobElement);
  ...
  onInputKeyDown_(t) {
    const e = De(this.props.get('keyScale'), Ar(t));
    e !== 0 &&
  ...
  onInputKeyUp_(t) {
    De(this.props.get('keyScale'), Ar(t)) !== 0 &&
...
class vx {
  constructor(t, e) {
    (this.onChange_ = this.onChange_.bind(this)),
      ...
      this.props_.emitter.on('change', this.onChange_),
      (this.element = t.createElement('div')),
      this.element.classList.add(Oo()),
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Oo('t')),
      e.viewProps.bindTabIndex(i),
      this.element.appendChild(i),
      (this.trackElement = i);
    const r = t.createElement('div');
    r.classList.add(Oo('k')),
...
class gx {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.ptHandler_ = new Mi(this.view.trackElement)),
  ...
  onKeyDown_(t) {
    const e = De(this.props.get('keyScale'), Rn(t));
    e !== 0 &&
  ...
  onKeyUp_(t) {
    De(this.props.get('keyScale'), Rn(t)) !== 0 &&
      this.value.setRawValue(this.value.rawValue, { forceEmit: !0, last: !0 });
  }
}
const Fo = kt('sldtxt');
class xx {
  constructor(t, e) {
    (this.element = t.createElement('div')), this.element.classList.add(Fo());
    const i = t.createElement('div');
    i.classList.add(Fo('s')),
      (this.sliderView_ = e.sliderView),
      i.appendChild(this.sliderView_.element),
      this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(Fo('t')),
...
class Fs {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.sliderC_ = new gx(t, {
        props: e.sliderProps,
        value: e.value,
        viewProps: this.viewProps,
      })),
      (this.textC_ = new zr(t, {
        parser: e.parser,
        props: e.textProps,
  ...
  exportProps() {
    ...
    return We(null, { max: t.get('max'), min: t.get('min') });
  }
}
function ou(n) {
  return {
...
const bx = { containerUnitSize: 'cnt-usz' };
function au(n) {
  return `--${bx[n]}`;
}
function Pr(n) {
...
function Cn(n, t) {
  ...
  i && e.push(i);
  const r = zh(n);
  return r && e.push(r), new Br(e);
}
function Mx(n) {
  return n ? n.major === sr.major : !1;
}
function lu(n) {
...
class wx {
  constructor(t, e) {
    ...
    const s = t.createElement('div');
    s.classList.add(gs('w')), this.labelElement.appendChild(s);
    const o = Gs(t, 'check');
    s.appendChild(o),
      e.value.emitter.on('change', this.onValueChange_),
      (this.value = e.value),
...
class Ex {
  constructor(t, e) {
    (this.onInputChange_ = this.onInputChange_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new wx(t, { value: this.value, viewProps: this.viewProps })),
      this.view.inputElement.addEventListener('change', this.onInputChange_),
...
const yx = Pe({
    ...
    controller: (n) => {
      ...
      return r
        ...
        : new Ex(t, { value: e, viewProps: n.viewProps });
    },
    api(n) {
      return typeof n.controller.value.rawValue != 'boolean'
        ? null
        : n.controller.valueController instanceof $n
        ? new el(n.controller)
        : null;
    },
  }),
...
class Cx {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.foldable.bindExpandedClass(this.element, oi(void 0, 'expanded')),
      pn(e.foldable, 'completed', rr(this.element, oi(void 0, 'cpl')));
    const i = t.createElement('div');
    i.classList.add(oi('h')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(oi('s')), i.appendChild(r), (this.swatchElement = r);
    const s = t.createElement('div');
    if (
      (s.classList.add(oi('t')),
      i.appendChild(s),
      (this.textElement = s),
      e.pickerLayout === 'inline')
    ) {
      const o = t.createElement('div');
      o.classList.add(oi('p')),
...
const Dx = {
  hsl: { hsl: (n, t, e) => [n, t, e], hsv: Rx, rgb: Ax },
  hsv: { hsl: Lx, hsv: (n, t, e) => [n, t, e], rgb: cu },
  rgb: { hsl: Tx, hsv: Px, rgb: (n, t, e) => [n, t, e] },
};
function er(n, t) {
  return [
...
function uu(n, t, e) {
  const i = zc(n, t.mode, t.type, 'int'),
    r = Dx[t.mode][e.mode](...i);
  return zc(r, e.mode, 'int', e.type);
}
class Vt {
  static black() {
  ...
  constructor(t, e) {
    (this.type = 'int'), (this.mode = e), (this.comps_ = hu(t, e, this.type));
  }
  getComponents(t) {
    return Xs(
      uu(
...
function rl(n) {
  return ie(n, (t) => ({
    color: t.optional.object({
      ...
      type: t.optional.custom(Nx),
    }),
    expanded: t.optional.boolean,
    picker: t.optional.custom(lu),
...
class sl {
  constructor(t, e) {
    (this.type = 'float'), (this.mode = e), (this.comps_ = hu(t, e, this.type));
  }
  getComponents(t) {
    return Xs(
      uu(
...
const Ox = { int: (n, t) => new Vt(n, t), float: (n, t) => new sl(n, t) };
function ol(n, t, e) {
  return Ox[e](n, t);
}
function Fx(n) {
...
function Ae(n, t) {
  ...
  if (Bx(n) && t === 'float') return Vx(n);
  if (Fx(n) && t === 'int') return kx(n);
...
function _u(n) {
  ...
  if (!t) return null;
  const e = [pu(t[1]), $e(t[2], 100), $e(t[3], 100)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) ? null : e;
}
function Xx(n) {
  const t = _u(n);
...
function vu(n) {
  ...
  if (!t) return null;
  const e = [pu(t[1]), $e(t[2], 100), $e(t[3], 100), $e(t[4], 1)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) || isNaN(e[3]) ? null : e;
}
function jx(n) {
  const t = vu(n);
...
const Zx = [
  { parser: gu, result: { alpha: !1, mode: 'rgb', notation: 'hex' } },
  { parser: xu, result: { alpha: !0, mode: 'rgb', notation: 'hex' } },
  { parser: fu, result: { alpha: !1, mode: 'rgb', notation: 'func' } },
  { parser: mu, result: { alpha: !0, mode: 'rgb', notation: 'func' } },
  { parser: _u, result: { alpha: !1, mode: 'hsl', notation: 'func' } },
  { parser: vu, result: { alpha: !0, mode: 'hsl', notation: 'func' } },
  { parser: bu, result: { alpha: !1, mode: 'rgb', notation: 'object' } },
  { parser: Mu, result: { alpha: !0, mode: 'rgb', notation: 'object' } },
];
function Jx(n) {
  return Zx.reduce(
...
function al(n, t = '#') {
  const e = fn(n.getComponents('rgb')).map(wu).join('');
  return `${t}${e}`;
}
function ll(n, t = '#') {
  const e = n.getComponents('rgb'),
    i = [e[0], e[1], e[2], e[3] * 255].map(wu).join('');
  return `${t}${i}`;
}
function Eu(n) {
  const t = Ne(0),
    e = Ae(n, 'int');
  return `rgb(${fn(e.getComponents('rgb'))
    .map((r) => t(r))
    .join(', ')})`;
}
function Cs(n) {
...
function eb(n) {
  const t = [Ne(0), Os, Os],
    e = Ae(n, 'int');
  return `hsl(${fn(e.getComponents('hsl'))
    .map((r, s) => t[s](r))
    .join(', ')})`;
}
function nb(n) {
  const t = [Ne(0), Os, Os, Ne(2)];
  return `hsla(${Ae(n, 'int')
    .getComponents('hsl')
    .map((r, s) => t[s](r))
    .join(', ')})`;
}
function Su(n, t) {
  const e = Ne(t === 'float' ? 2 : 0),
    i = ['r', 'g', 'b'],
    r = Ae(n, t);
  return `{${fn(r.getComponents('rgb'))
    .map((o, a) => `${i[a]}: ${e(o)}`)
    .join(', ')}}`;
}
function ib(n) {
...
function Cu(n) {
  return sb.reduce(
    (t, e) => t || (zx(e.format, n) ? e.stringifier : null),
    null
  );
}
const gr = kt('apl');
class ob {
  constructor(t, e) {
    ...
    const i = t.createElement('div');
    i.classList.add(gr('b')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(gr('c')), i.appendChild(r), (this.colorElem_ = r);
    const s = t.createElement('div');
    s.classList.add(gr('m')),
      this.element.appendChild(s),
      (this.markerElem_ = s);
    const o = t.createElement('div');
    o.classList.add(gr('p')),
  ...
  update_() {
    const t = this.value.rawValue,
      ...
      s = ['to right', Cs(i), Cs(r)];
    (this.colorElem_.style.background = `linear-gradient(${s.join(',')})`),
      (this.previewElem_.style.backgroundColor = Cs(t));
...
class ab {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.ptHandler_ = new Mi(this.view.element)),
...
class cb {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Vi('m')),
      (this.modeElem_ = lb(t)),
      this.modeElem_.classList.add(Vi('ms')),
      i.appendChild(this.modeSelectElement),
      e.viewProps.bindDisabled(this.modeElem_);
    const r = t.createElement('div');
    r.classList.add(Vi('mm')),
      r.appendChild(Gs(t, 'dropdown')),
      i.appendChild(r),
      this.element.appendChild(i);
    const s = t.createElement('div');
    s.classList.add(Vi('w')),
      this.element.appendChild(s),
      (this.inputsElem_ = s),
...
function hb(n) {
  return Ne(n === 'float' ? 2 : 0);
}
function ub(n, t, e) {
  const i = er(n, t)[e];
  return new Nr({ min: 0, max: i });
}
function db(n, t, e) {
  return new zr(n, {
    ...
    parser: t.parser,
    props: It.fromObject({
      formatter: hb(t.colorType),
      keyScale: gi(!1),
      pointerScale: t.colorType === 'float' ? 0.01 : 1,
    }),
    value: ee(0, { constraint: ub(t.colorMode, t.colorType, e) }),
    viewProps: t.viewProps,
  });
}
function pb(n, t) {
  ...
  return [0, 1, 2].map((i) => {
    ...
    return (
      ar({
        ...
        secondary: r.value,
        forward(s) {
          return Ae(s, t.colorType).getComponents(t.colorMode)[i];
        },
        backward(s, o) {
          const a = t.colorMode,
            c = Ae(s, t.colorType).getComponents(a);
          c[i] = o;
          const h = ol(Xs(fn(c), c[3]), a, t.colorType);
          return Ae(h, 'int');
        },
      }),
      r
...
function fb(n, t) {
  const e = new Tr(n, {
    parser: Gr('int'),
    props: It.fromObject({ formatter: al }),
    value: ee(Vt.black()),
    viewProps: t.viewProps,
  });
  return (
    ar({
      primary: t.value,
      secondary: e.value,
      forward: (i) => new Vt(fn(i.getComponents()), i.mode),
      backward: (i, r) =>
        new Vt(Xs(fn(r.getComponents(i.mode)), i.getComponents()[3]), i.mode),
    }),
    [e]
  );
}
...
class _b {
  ...
  createComponentControllers_(t) {
    ...
    return mb(e)
      ...
      : fb(t, { value: this.value, viewProps: this.viewProps });
  }
...
class vb {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      e.viewProps.bindTabIndex(this.element);
    const i = t.createElement('div');
    i.classList.add(Bo('c')), this.element.appendChild(i);
    const r = t.createElement('div');
    r.classList.add(Bo('m')),
      this.element.appendChild(r),
      (this.markerElem_ = r),
      this.update_();
  }
  update_() {
    ...
    this.markerElem_.style.backgroundColor = Eu(new Vt([e, 100, 100], 'hsv'));
...
class gb {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new vb(t, { value: this.value, viewProps: this.viewProps })),
      (this.ptHandler_ = new Mi(this.view.element)),
      this.ptHandler_.emitter.on('down', this.onPointerDown_),
      this.ptHandler_.emitter.on('move', this.onPointerMove_),
      this.ptHandler_.emitter.on('up', this.onPointerUp_),
...
class xb {
  constructor(t, e) {
    ...
    (i.height = Hc),
      (i.width = Hc),
      i.classList.add(ko('c')),
      this.element.appendChild(i),
      (this.canvasElement = i);
    const r = t.createElement('div');
    r.classList.add(ko('m')),
      this.element.appendChild(r),
      (this.markerElem_ = r),
      this.update_();
  }
  update_() {
    const t = g0(this.canvasElement);
    if (!t) return;
...
class bb {
  constructor(t, e) {
    (this.onKeyDown_ = this.onKeyDown_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new xb(t, { value: this.value, viewProps: this.viewProps })),
      (this.ptHandler_ = new Mi(this.view.element)),
      this.ptHandler_.emitter.on('down', this.onPointerDown_),
      this.ptHandler_.emitter.on('move', this.onPointerMove_),
      this.ptHandler_.emitter.on('up', this.onPointerUp_),
...
class Mb {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.hPaletteC_ = new gb(t, {
        value: this.value,
        viewProps: this.viewProps,
      })),
      (this.svPaletteC_ = new bb(t, {
        value: this.value,
        viewProps: this.viewProps,
      })),
      (this.alphaIcs_ = e.supportsAlpha
        ? {
            ...
            text: new zr(t, {
              ...
              value: ee(0, { constraint: new Nr({ min: 0, max: 1 }) }),
              viewProps: this.viewProps,
            }),
          }
        : null),
...
class wb {
  constructor(t, e) {
    (this.onValueChange_ = this.onValueChange_.bind(this)),
      ...
      e.viewProps.bindClassModifiers(this.element);
    const i = t.createElement('div');
    i.classList.add(Vo('sw')),
      this.element.appendChild(i),
      (this.swatchElem_ = i);
    const r = t.createElement('button');
    r.classList.add(Vo('b')),
      e.viewProps.bindDisabled(r),
      this.element.appendChild(r),
      (this.buttonElement = r),
      this.update_();
  ...
  update_() {
    const t = this.value.rawValue;
    this.swatchElem_.style.backgroundColor = ll(t);
  }
  onValueChange_() {
    this.update_();
  }
...
class Eb {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.view = new wb(t, { value: this.value, viewProps: this.viewProps }));
  }
}
class cl {
  constructor(t, e) {
    (this.onButtonBlur_ = this.onButtonBlur_.bind(this)),
      ...
      (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.foldable_ = Fr.create(e.expanded)),
      (this.swatchC_ = new Eb(t, {
        value: this.value,
        viewProps: this.viewProps,
      }));
    ...
    i.addEventListener('blur', this.onButtonBlur_),
      ...
      (this.popC_ =
        e.pickerLayout === 'popup'
          ? new nu(t, { viewProps: this.viewProps })
          : null);
    const r = new Mb(t, {
      colorType: e.colorType,
      supportsAlpha: e.supportsAlpha,
    ...
    r.view.allFocusableElements.forEach((s) => {
      ...
      this.popC_
        ...
        : this.view.pickerElement &&
          ...
          tl(this.foldable_, this.view.pickerElement));
  }
  get textController() {
    return this.textC_;
  }
  ...
  onPopupChildBlur_(t) {
    ...
    const e = this.popC_.view.element,
      i = qh(t);
    (i && e.contains(i)) ||
      (i && i === this.swatchC_.view.buttonElement && !Ya(e.ownerDocument)) ||
...
function Sb(n) {
  return fn(n.getComponents('rgb')).reduce(
...
function Ab(n) {
  return typeof n != 'number' ? Vt.black() : Cb(n);
}
function Pb(n) {
  return typeof n != 'number' ? Vt.black() : Tb(n);
}
function Ts(n, t) {
...
const Bb = Pe({
  ...
  type: 'input',
  accept: (n, t) => {
    if (typeof n != 'number' || !Fb(t)) return null;
    const e = rl(t);
    return e
      ? {
          initialValue: n,
          params: Object.assign(Object.assign({}, e), { supportsAlpha: Nb(t) }),
        }
      : null;
  },
  binding: {
    reader: (n) => (n.params.supportsAlpha ? Pb : Ab),
    equals: hl,
    writer: (n) => Lb(n.params.supportsAlpha),
  },
  controller: (n) => {
    var t, e;
    return new cl(n.document, {
      colorType: 'int',
      expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : !1,
      formatter: Ob(n.params.supportsAlpha),
      parser: Gr('int'),
      pickerLayout:
      ...
      return i
        ? {
            ...
            params: Object.assign(Object.assign({}, i), {
              colorType: (e = du(t)) !== null && e !== void 0 ? e : 'int',
            }),
          }
        : null;
    },
    binding: {
      reader: (n) => zb(n.params.colorType),
      equals: hl,
      writer: (n) => Ub(Vb(n.initialValue), n.params.colorType),
    },
    controller: (n) => {
      var t, e;
      const i = Au(n.initialValue);
      return new cl(n.document, {
        colorType: n.params.colorType,
        expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : !1,
        formatter: Hb(i, n.params.colorType),
        parser: Gr('int'),
        pickerLayout:
          (e = n.params.picker) !== null && e !== void 0 ? e : 'popup',
        supportsAlpha: i,
...
class dl {
  constructor(t, e) {
    (this.value = e.value),
      (this.viewProps = e.viewProps),
      (this.acs_ = e.axes.map((i, r) => jb(t, e, r))),
      ...
      (this.view = new Xb(t, { textViews: this.acs_.map((i) => i.view) }));
  }
  get textControllers() {
    return this.acs_;
  }
...
function Yb(n, t) {
  ...
  const r = zh(n);
  r && e.push(r);
  const s = il(n.options);
  return s && e.push(s), new Br(e);
}
const Kb = Pe({
  id: 'input-number',
  type: 'input',
  accept: (n, t) => {
    ...
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Gh(i)), {
        options: i.optional.custom(Vr),
        readonly: i.optional.constant(!1),
      })
    );
  ...
  binding: {
    reader: (n) => Oh,
    constraint: (n) => Yb(n.params, n.initialValue),
    writer: (n) => Hr,
  },
  controller: (n) => {
    const t = n.value,
    ...
    const r = Hh(n.params, t.rawValue),
      s = e && Ns(e, Nr);
    return s
      ? new Fs(
          n.document,
          Object.assign(
            ...
            { parser: Pn, value: t, viewProps: n.viewProps }
          )
        )
      : new zr(n.document, {
          parser: Pn,
  ...
  api(n) {
    return typeof n.controller.value.rawValue != 'number'
      ? null
      : n.controller.valueController instanceof Fs
      ? new qb(n.controller)
      : n.controller.valueController instanceof $n
      ? new el(n.controller)
      : null;
...
class $b {
  constructor(t, e) {
    (this.element = t.createElement('div')),
      ...
      e.viewProps.bindClassModifiers(this.element),
      Tn(e.expanded, rr(this.element, zi(void 0, 'expanded')));
    const i = t.createElement('div');
    i.classList.add(zi('h')), this.element.appendChild(i);
    const r = t.createElement('button');
    r.classList.add(zi('b')),
      r.appendChild(Gs(t, 'p2dpad')),
      e.viewProps.bindDisabled(r),
      i.appendChild(r),
      (this.buttonElement = r);
    const s = t.createElement('div');
    if (
      (s.classList.add(zi('t')),
      i.appendChild(s),
      (this.textElement = s),
      e.pickerLayout === 'inline')
    ) {
      const o = t.createElement('div');
      o.classList.add(zi('p')),
        this.element.appendChild(o),
        (this.pickerElement = o);
    } else this.pickerElement = null;
  }
...
class Zb {
  constructor(t, e) {
    ...
    i.classList.add(Vn('p')),
      ...
      this.element.appendChild(i),
      (this.padElement = i);
    const r = t.createElementNS(hn, 'svg');
    r.classList.add(Vn('g')),
      this.padElement.appendChild(r),
      (this.svgElem_ = r);
    const s = t.createElementNS(hn, 'line');
    ...
    const o = t.createElementNS(hn, 'line');
    ...
    const a = t.createElementNS(hn, 'line');
...
function Xc(n, t, e) {
  return [De(t[0], Rn(n)), De(t[1], Ar(n)) * (e ? 1 : -1)];
}
class Jb {
  constructor(t, e) {
    (this.onPadKeyDown_ = this.onPadKeyDown_.bind(this)),
      ...
      (this.ptHandler_ = new Mi(this.view.padElement)),
      this.ptHandler_.emitter.on('down', this.onPointerDown_),
      this.ptHandler_.emitter.on('move', this.onPointerMove_),
      this.ptHandler_.emitter.on('up', this.onPointerUp_),
  ...
  handlePointerEvent_(t, e) {
    ...
    this.value.setRawValue(new qn(r, s), e);
  }
  onPointerDown_(t) {
    this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
  }
  ...
  onPadKeyDown_(t) {
    ...
    (e === 0 && i === 0) ||
      this.value.setRawValue(
        new qn(this.value.rawValue.x + e, this.value.rawValue.y + i),
        { forceEmit: !1, last: !1 }
      );
  }
  onPadKeyUp_(t) {
...
class Qb {
  ...
  onPopupChildBlur_(t) {
    ...
    const e = this.popC_.view.element,
      i = qh(t);
    (i && e.contains(i)) ||
      (i && i === this.view.buttonElement && !Ya(e.ownerDocument)) ||
      (this.popC_.shows.rawValue = !1);
  }
  onPopupChildKeydown_(t) {
    this.popC_
...
function tM(n) {
  return qn.isObject(n) ? new qn(n.x, n.y) : new qn();
}
function eM(n, t) {
...
function nM(n, t) {
  return new ul({
    assembly: Ru,
    components: [
      Cn(Object.assign(Object.assign({}, n), n.x), t.x),
      Cn(Object.assign(Object.assign({}, n), n.y), t.y),
    ],
  });
}
function jc(n, t) {
...
function iM(n, t) {
  var e, i;
  const r = jc(_i(n, (e = n.x) !== null && e !== void 0 ? e : {}), t.x),
    s = jc(_i(n, (i = n.y) !== null && i !== void 0 ? i : {}), t.y);
  return Math.max(r, s);
}
function rM(n) {
  if (!('y' in n)) return !1;
...
const sM = Pe({
  ...
  type: 'input',
  accept: (n, t) => {
    if (!qn.isObject(n)) return null;
    const e = ie(t, (i) =>
      Object.assign(Object.assign({}, Pr(i)), {
        expanded: i.optional.boolean,
        picker: i.optional.custom(lu),
        readonly: i.optional.constant(!1),
  ...
  binding: {
    reader: () => tM,
    constraint: (n) => nM(n.params, n.initialValue),
    equals: qn.equals,
    writer: () => eM,
  },
  controller: (n) => {
    ...
    return new Qb(i, {
      axes: r.rawValue.getComponents().map((a, l) => {
        ...
        return qa({
          ...
          initialValue: a,
          params: _i(n.params, (c = o[l]) !== null && c !== void 0 ? c : {}),
        });
      }),
      expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : !1,
      invertsY: rM(n.params),
      max: iM(n.params, r.rawValue),
      parser: Pn,
      pickerLayout:
        (e = n.params.picker) !== null && e !== void 0 ? e : 'popup',
      value: r,
...
function lM(n, t) {
  return new ul({
    ...
    components: [
      Cn(Object.assign(Object.assign({}, n), n.x), t.x),
      Cn(Object.assign(Object.assign({}, n), n.y), t.y),
      Cn(Object.assign(Object.assign({}, n), n.z), t.z),
    ],
  });
}
const cM = Pe({
  ...
  binding: {
    reader: (n) => oM,
    constraint: (n) => lM(n.params, n.initialValue),
    equals: Yi.equals,
    writer: (n) => aM,
  },
  controller: (n) => {
    ...
    return new dl(n.document, {
      ...
      axes: t.rawValue.getComponents().map((r, s) => {
        ...
        return qa({
          ...
          initialValue: r,
          params: _i(n.params, (o = i[s]) !== null && o !== void 0 ? o : {}),
        });
      }),
      parser: Pn,
      value: t,
...
function dM(n, t) {
  return new ul({
    ...
    components: [
      ...
      Cn(Object.assign(Object.assign({}, n), n.y), t.y),
      Cn(Object.assign(Object.assign({}, n), n.z), t.z),
      Cn(Object.assign(Object.assign({}, n), n.w), t.w),
    ],
  });
}
const pM = Pe({
  ...
  binding: {
    reader: (n) => hM,
    constraint: (n) => dM(n.params, n.initialValue),
    equals: Ki.equals,
    writer: (n) => uM,
  },
  controller: (n) => {
...
const mM = Pe({
    ...
    controller: (n) => {
      ...
      return r
        ...
        : new Tr(t, {
            parser: (s) => s,
            props: It.fromObject({ formatter: Ca }),
            value: e,
            viewProps: n.viewProps,
          });
    },
  ...
  Wr = { monitor: { defaultInterval: 200, defaultRows: 3 } },
  qc = kt('mll');
class _M {
  constructor(t, e) {
    ...
    i.classList.add(qc('i')),
      (i.style.height = `calc(var(${au('containerUnitSize')}) * ${e.rows})`),
      (i.readOnly = !0),
      e.viewProps.bindDisabled(i),
      this.element.appendChild(i),
...
class bM {
  constructor(t, e) {
    ...
    const i = t.createElementNS(hn, 'svg');
    i.classList.add(zn('g')),
      (i.style.height = `calc(var(${au('containerUnitSize')}) * ${e.rows})`),
      this.element.appendChild(i),
      (this.svgElem_ = i);
    const r = t.createElementNS(hn, 'polyline');
    this.svgElem_.appendChild(r), (this.lineElem_ = r);
    const s = t.createElement('div');
    s.classList.add(zn('t'), kt('tt')()),
      this.element.appendChild(s),
      (this.tooltipElem_ = s),
      e.value.emitter.on('change', this.onValueUpdate_),
      (this.value = e.value),
  ...
  update_() {
    ...
    (a.style.left = `${c}px`),
      ...
      a.classList.contains(zn('t', 'a')) ||
        (a.classList.add(zn('t', 'a'), zn('t', 'in')),
        Us(a),
...
class Iu {
  constructor(t, e) {
    if (
      ...
      const i = new Mi(this.view.element);
  ...
  exportProps() {
    return We(null, { max: this.props.get('max'), min: this.props.get('min') });
  }
  onGraphMouseLeave_() {
...
function Ta(n) {
  return Jt(n.format) ? Ne(2) : n.format;
}
function MM(n) {
  var t;
  return n.value.rawValue.length === 1
    ? new fl(n.document, {
        formatter: Ta(n.params),
        value: n.value,
        viewProps: n.viewProps,
      })
    : new pl(n.document, {
...
function wM(n) {
  var t, e, i;
  return new Iu(n.document, {
    formatter: Ta(n.params),
    rows:
      (t = n.params.rows) !== null && t !== void 0 ? t : Wr.monitor.defaultRows,
    props: It.fromObject({
...
const EM = Pe({
    ...
    binding: { defaultBufferSize: (n) => (Kc(n) ? 64 : 1), reader: (n) => Oh },
    controller: (n) => (Kc(n.params) ? wM(n) : MM(n)),
    api: (n) =>
      n.controller.valueController instanceof Iu ? new xM(n.controller) : null,
  }),
  SM = Pe({
    id: 'monitor-string',
    type: 'monitor',
...
function TM(n, t) {
  ...
  const r = {
    ...
    l = new CM({ reader: o, target: t.target, writer: n.binding.writer(r) }),
    c = new h0(
...
function PM(n, t) {
  return t === 0 ? new ax() : new lx(n, t ?? Wr.monitor.defaultInterval);
}
function RM(n, t) {
  var e, i, r;
  ...
  const o = {
    ...
    c =
      (i =
        ...
        : 1,
    h = new R0({
      binding: new AM({ reader: l, target: t.target }),
      bufferSize: c,
      ticker: PM(t.document, a == null ? void 0 : a.interval),
    }),
    d = n.controller({
      document: t.document,
      params: s.params,
...
class LM {
  ...
  register(t, e) {
    if (!Mx(e.core)) throw ae.notCompatible(t, e.id);
    e.type === 'blade'
  ...
  createInput_(t, e, i) {
    return this.pluginsMap_.inputs.reduce(
      (r, s) => r ?? TM(s, { document: t, target: e, params: i }),
      null
    );
  }
  createMonitor_(t, e, i) {
    return this.pluginsMap_.monitors.reduce(
      (r, s) => r ?? RM(s, { document: t, params: i, target: e }),
      null
    );
  }
  createBinding(t, e, i) {
  ...
  createBlade(t, e) {
    const i = this.pluginsMap_.blades.reduce(
      (r, s) => r ?? ox(s, { document: t, params: e }),
      null
    );
  ...
  createInputBindingApi_(t) {
    ...
    return this.apiCache_.add(t, e ?? new Cr(t));
  }
  ...
  createBindingApi(t) {
    ...
    if (C0(t)) return this.createInputBindingApi_(t);
    if (I0(t)) return this.createMonitorBindingApi_(t);
    throw ae.shouldNeverHappen();
  }
  createApi(t) {
    if (this.apiCache_.has(t)) return this.apiCache_.get(t);
    if (S0(t)) return this.createBindingApi(t);
...
function IM() {
  const n = new LM(DM);
  return (
    [sM, cM, pM, mM, Kb, Wb, Gb, Bb, yx, gM, SM, EM, B0, Z0, eu].forEach(
      (t) => {
        n.register('core', t);
      }
    ),
  ...
  constructor(t) {
    super(t),
      ...
      this.controller.value.emitter.on('change', (e) => {
        this.emitter_.emit('change', new Or(this, e.rawValue));
      });
  }
  get label() {
    return this.controller.labelController.props.get('label');
...
const BM = (function () {
  return {
    ...
    controller(n) {
      const t = new kr(nl(n.params.options)),
    ...
    api(n) {
      return !(n.controller instanceof vi) ||
        !(n.controller.valueController instanceof $n)
        ? null
        : new UM(n.controller);
    },
...
class zM {
  constructor(t, e) {
    ...
    i.classList.add($c('r')), this.element.appendChild(i);
  }
}
class Zc extends Ws {
  constructor(t, e) {
    super(
      Object.assign(Object.assign({}, e), {
        view: new zM(t, { viewProps: e.viewProps }),
      })
    );
  }
}
const HM = {
    ...
    controller(n) {
      return new Zc(n.document, { blade: n.blade, viewProps: n.viewProps });
    },
    api(n) {
      return n.controller instanceof Zc ? new NM(n.controller) : null;
    },
  },
  GM = {
    id: 'slider',
    ...
    controller(n) {
      ...
      const i = (t = n.params.value) !== null && t !== void 0 ? t : 0,
        r = new Nr({ max: n.params.max, min: n.params.min }),
        s = ee(i, { constraint: r }),
        o = new Fs(
          n.document,
          Object.assign(
            Object.assign(
              ...
              ou({
                formatter:
                  (e = n.params.format) !== null && e !== void 0 ? e : s0,
                keyScale: ee(1),
                max: r.values.value('max'),
                min: r.values.value('min'),
                pointerScale: kh(n.params, i),
              })
            ),
            { parser: Pn, value: s, viewProps: n.viewProps }
          )
        );
      return new vi(n.document, {
        blade: n.blade,
  ...
  WM = (function () {
    return {
      ...
      api(n) {
        return !(n.controller instanceof vi) ||
          !(n.controller.valueController instanceof Tr)
          ? null
          : new FM(n.controller);
      },
    };
...
class qM extends kM {
  constructor(t) {
    var e, i;
    const r = t ?? {},
      s = (e = r.document) !== null && e !== void 0 ? e : v0(),
      o = IM(),
      a = new VM(s, {
        expanded: r.expanded,
        blade: or(),
    ...
    super(a, o),
      (this.pool_ = o),
      (this.containerElem_ =
        (i = r.container) !== null && i !== void 0 ? i : XM(s)),
  ...
  registerPlugin(t) {
    t.css && jM(this.document, `plugin-${t.id}`, t.css),
...
Oe.metalnessMap = JM;
Oe.normalMap = QM;
Oe.displacementMap = ZM;
Oe.displacementScale = 0.1;
Oe.aoMap = KM;
jr.addBinding(Oe, 'metalness', { min: 0, max: 1, step: 0.01 });
jr.addBinding(Oe, 'roughness', { min: 0, max: 1, step: 0.01 });
jr.addBinding(Oe, 'displacementScale', { min: 0, max: 1, step: 0.01 });
jr.addBinding(Oe, 'aoMapIntensity', { min: 0, max: 1, step: 0.01 });
jr.addBinding(Oe, 'emissive', { min: 0, max: 1, step: 0.01 });
const qs = ml.addFolder({ title: 'vines Material', expanded: !0 }),
  Ze = new Va();
Ze.map = Nu;
Ze.roughnessMap = sw;
Ze.metalnessMap = iw;
Ze.normalMap = rw;
Ze.displacementMap = nw;
Ze.displacementScale = 0.1;
Ze.aoMap = ew;
qs.addBinding(Ze, 'metalness', { min: 0, max: 1, step: 0.01 });
qs.addBinding(Ze, 'roughness', { min: 0, max: 1, step: 0.01 });
qs.addBinding(Ze, 'displacementScale', { min: 0, max: 1, step: 0.01 });
qs.addBinding(Ze, 'aoMapIntensity', { min: 0, max: 1, step: 0.01 });
const Ys = ml.addFolder({ title: 'Space Cruiser Material', expanded: !0 }),
  Je = new Va();
Je.map = Ou;
Je.roughnessMap = hw;
Je.metalnessMap = lw;
Je.normalMap = cw;
Je.displacementMap = aw;
Je.displacementScale = 0.1;
Je.aoMap = ow;
Ys.addBinding(Je, 'metalness', { min: 0, max: 1, step: 0.01 });
Ys.addBinding(Je, 'roughness', { min: 0, max: 1, step: 0.01 });
Ys.addBinding(Je, 'displacementScale', { min: 0, max: 1, step: 0.01 });
Ys.addBinding(Je, 'aoMapIntensity', { min: 0, max: 1, step: 0.01 });
const Fu = new br(),
  _l = new Ke();
_l.geometry = Xr;
_l.material = Oe;
...
Fu.add(_l, Ks, $s);
js.add(Fu);
const uw = new cg(16777215, 1);
js.add(uw);
const Bu = new lg(16777215, 200);
Bu.position.set(5, 5, 5);
js.add(Bu);
const nr = new He(35, window.innerWidth / window.innerHeight, 0.1, 1e4);
nr.position.z = 10;
nr.position.y = 5;
const ku = document.querySelector('canvas.threejs'),
  Zs = new tg({ canvas: ku, antialias: !0 });
Zs.setSize(window.innerWidth, window.innerHeight);
Zs.setPixelRatio(Math.min(window.devicePixelRatio, 2));
const Vu = new dg(nr, ku);
Vu.enableDamping = !0;
window.addEventListener('resize', () => {
  (nr.aspect = window.innerWidth / window.innerHeight),
    nr.updateProjectionMatrix(),
    Zs.setSize(window.innerWidth, window.innerHeight);
});
const zu = () => {
  Vu.update(), Zs.render(js, nr), window.requestAnimationFrame(zu);
};
zu();
